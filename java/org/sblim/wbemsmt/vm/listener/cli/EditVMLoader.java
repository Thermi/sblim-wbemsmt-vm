  ...
  * Contributors: 
  * 
  * Description: Class to get the command line arguments to edit a  container instance 
  * 
  */
...
public class EditVMLoader extends VMLoader implements
		CliDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		String containerName = CliUtil.getOption(commandValues,EditVM.KEY_vmid);

...
//**********************************************************************
    ...
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_MemberOfCollection.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_MemberOfCollection.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    */        
    public final static List<CIM_MemberOfCollection> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_MemberOfCollection> resultArrayList = new ArrayList<CIM_MemberOfCollection>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_MemberOfCollection.CIM_CLASS_NAME)) {
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_MemberOfCollection)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_MemberOfCollection getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_MemberOfCollection getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
    ...
    */    
    public final static CIM_MemberOfCollection getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_MemberOfCollection.PROPERTY_COLLECTION_CIM_COLLECTION.NAME,new CIMDataType(CIM_Collection.CIM_CLASS_NAME),setThis,false,false,CIM_MemberOfCollection.CIM_CLASS_NAME); 
                   
                                 setThis = Member != null ? Member.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_MemberOfCollection.PROPERTY_MEMBER_CIM_MANAGEDELEMENT.NAME,new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME),setThis,false,false,CIM_MemberOfCollection.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_MemberOfCollection.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_MemberOfCollection createInstance(WBEMClient client, CIM_MemberOfCollection dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_MemberOfCollection newDataInstance = CIM_MemberOfCollectionHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_MemberOfCollection modifyInstance(WBEMClient client, CIM_MemberOfCollection dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_MemberOfCollection dataInstance2 = CIM_MemberOfCollectionHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_MemberOfCollection dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_MemberOfCollection.getPackages());
    }

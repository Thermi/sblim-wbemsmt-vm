...
public class CIM_AllocationCapabilitiesHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_AllocationCapabilities.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_AllocationCapabilities.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_AllocationCapabilities.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_AllocationCapabilities.");
                        resultArrayList.add(new CIM_AllocationCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_AllocationCapabilities.");
                        resultArrayList.add(new CIM_AllocationCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_AllocationCapabilities.");
                        resultArrayList.add(new CIM_AllocationCapabilities(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_AllocationCapabilities getInstance(WBEMClient client,
    ...
    public final static CIM_AllocationCapabilities getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_AllocationCapabilities.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static CIM_AllocationCapabilities createInstance(WBEMClient client,
            CIM_AllocationCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_AllocationCapabilities newDataInstance = CIM_AllocationCapabilitiesHelper.getInstance(
     ...
     */
    public final static CIM_AllocationCapabilities modifyInstance(WBEMClient client,
            CIM_AllocationCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_AllocationCapabilities dataInstance2 = CIM_AllocationCapabilitiesHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_AllocationCapabilities dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_AllocationCapabilities.getPackages());
    }

...
public class CIM_VirtualSystemManagementCapabilitiesHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                CIM_VirtualSystemManagementCapabilities.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_VirtualSystemManagementCapabilities.CIM_CLASS_NAME
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_VirtualSystemManagementCapabilities.CIM_CLASS_NAME)) {
                        resultArrayList
                                .add(new CIM_VirtualSystemManagementCapabilities(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_VirtualSystemManagementCapabilitiesHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_VirtualSystemManagementCapabilities.");
                        resultArrayList
                                .add(new CIM_VirtualSystemManagementCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_VirtualSystemManagementCapabilities.");
                        resultArrayList
                                .add(new CIM_VirtualSystemManagementCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_VirtualSystemManagementCapabilities.");
                        resultArrayList
                                .add(new CIM_VirtualSystemManagementCapabilities(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_VirtualSystemManagementCapabilities getInstance(WBEMClient client,
    ...
    public final static CIM_VirtualSystemManagementCapabilities getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_VirtualSystemManagementCapabilities.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static CIM_VirtualSystemManagementCapabilities createInstance(WBEMClient client,
            CIM_VirtualSystemManagementCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_VirtualSystemManagementCapabilities newDataInstance = CIM_VirtualSystemManagementCapabilitiesHelper
     ...
     */
    public final static CIM_VirtualSystemManagementCapabilities modifyInstance(WBEMClient client,
            CIM_VirtualSystemManagementCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_VirtualSystemManagementCapabilities dataInstance2 = CIM_VirtualSystemManagementCapabilitiesHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_VirtualSystemManagementCapabilities dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_VirtualSystemManagementCapabilities.getPackages());
    }

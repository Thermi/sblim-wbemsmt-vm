/** 
  * CIM_VirtualSystemManagementCapabilitiesHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_VirtualSystemManagementCapabilities
  *    
  * 
  * generated Class
  * @see CIM_VirtualSystemManagementCapabilities
  */
...
public class CIM_VirtualSystemManagementCapabilitiesHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_VirtualSystemManagementCapabilities or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_VirtualSystemManagementCapabilities.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_VirtualSystemManagementCapabilities.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_VirtualSystemManagementCapabilities or the subclasses if deep == true
    */        
    public final static List<CIM_VirtualSystemManagementCapabilities> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_VirtualSystemManagementCapabilities> resultArrayList = new ArrayList<CIM_VirtualSystemManagementCapabilities>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_VirtualSystemManagementCapabilities.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_VirtualSystemManagementCapabilities(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_VirtualSystemManagementCapabilitiesHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_VirtualSystemManagementCapabilities.");
                        resultArrayList.add(new CIM_VirtualSystemManagementCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_VirtualSystemManagementCapabilities.");
                        resultArrayList.add(new CIM_VirtualSystemManagementCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_VirtualSystemManagementCapabilities)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_VirtualSystemManagementCapabilities.");
                        resultArrayList.add(new CIM_VirtualSystemManagementCapabilities(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_VirtualSystemManagementCapabilities getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_VirtualSystemManagementCapabilities getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_VirtualSystemManagementCapabilities dataInstance = null;
        Class<?> clazz = CIM_VirtualSystemManagementCapabilitiesHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_VirtualSystemManagementCapabilities)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_VirtualSystemManagementCapabilities.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_VirtualSystemManagementCapabilities(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_VirtualSystemManagementCapabilities getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_VirtualSystemManagementCapabilities.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_VirtualSystemManagementCapabilities.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_VirtualSystemManagementCapabilities.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_VirtualSystemManagementCapabilities createInstance(WBEMClient client, CIM_VirtualSystemManagementCapabilities dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_VirtualSystemManagementCapabilities newDataInstance = CIM_VirtualSystemManagementCapabilitiesHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_VirtualSystemManagementCapabilities modifyInstance(WBEMClient client, CIM_VirtualSystemManagementCapabilities dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_VirtualSystemManagementCapabilities dataInstance2 = CIM_VirtualSystemManagementCapabilitiesHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_VirtualSystemManagementCapabilities dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_VirtualSystemManagementCapabilities.getPackages());
    }

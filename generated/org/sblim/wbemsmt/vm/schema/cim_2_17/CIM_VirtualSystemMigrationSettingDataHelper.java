...
public class CIM_VirtualSystemMigrationSettingDataHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                CIM_VirtualSystemMigrationSettingData.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_VirtualSystemMigrationSettingData.CIM_CLASS_NAME
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_VirtualSystemMigrationSettingDataHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_VirtualSystemMigrationSettingData.");
                        resultArrayList.add(new CIM_VirtualSystemMigrationSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_VirtualSystemMigrationSettingData.");
                        resultArrayList.add(new CIM_VirtualSystemMigrationSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_VirtualSystemMigrationSettingData.");
                        resultArrayList.add(new CIM_VirtualSystemMigrationSettingData(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_VirtualSystemMigrationSettingData getInstance(WBEMClient client,
    ...
    public final static CIM_VirtualSystemMigrationSettingData getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_VirtualSystemMigrationSettingData.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static CIM_VirtualSystemMigrationSettingData createInstance(WBEMClient client,
            CIM_VirtualSystemMigrationSettingData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_VirtualSystemMigrationSettingData newDataInstance = CIM_VirtualSystemMigrationSettingDataHelper
     ...
     */
    public final static CIM_VirtualSystemMigrationSettingData modifyInstance(WBEMClient client,
            CIM_VirtualSystemMigrationSettingData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_VirtualSystemMigrationSettingData dataInstance2 = CIM_VirtualSystemMigrationSettingDataHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_VirtualSystemMigrationSettingData dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_VirtualSystemMigrationSettingData.getPackages());
    }

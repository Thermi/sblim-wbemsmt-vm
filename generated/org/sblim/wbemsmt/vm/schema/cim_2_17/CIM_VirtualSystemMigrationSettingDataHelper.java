/** 
  * CIM_VirtualSystemMigrationSettingDataHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_VirtualSystemMigrationSettingData
  *    
  * 
  * generated Class
  * @see CIM_VirtualSystemMigrationSettingData
  */
...
public class CIM_VirtualSystemMigrationSettingDataHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_VirtualSystemMigrationSettingData or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_VirtualSystemMigrationSettingData.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_VirtualSystemMigrationSettingData.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_VirtualSystemMigrationSettingData or the subclasses if deep == true
    */        
    public final static List<CIM_VirtualSystemMigrationSettingData> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_VirtualSystemMigrationSettingData> resultArrayList = new ArrayList<CIM_VirtualSystemMigrationSettingData>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_VirtualSystemMigrationSettingData.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_VirtualSystemMigrationSettingData(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_VirtualSystemMigrationSettingDataHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_VirtualSystemMigrationSettingData.");
                        resultArrayList.add(new CIM_VirtualSystemMigrationSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_VirtualSystemMigrationSettingData.");
                        resultArrayList.add(new CIM_VirtualSystemMigrationSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_VirtualSystemMigrationSettingData)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_VirtualSystemMigrationSettingData.");
                        resultArrayList.add(new CIM_VirtualSystemMigrationSettingData(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_VirtualSystemMigrationSettingData getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_VirtualSystemMigrationSettingData getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_VirtualSystemMigrationSettingData dataInstance = null;
        Class<?> clazz = CIM_VirtualSystemMigrationSettingDataHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_VirtualSystemMigrationSettingData)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_VirtualSystemMigrationSettingData.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_VirtualSystemMigrationSettingData(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_VirtualSystemMigrationSettingData getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_VirtualSystemMigrationSettingData.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_VirtualSystemMigrationSettingData.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_VirtualSystemMigrationSettingData.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_VirtualSystemMigrationSettingData createInstance(WBEMClient client, CIM_VirtualSystemMigrationSettingData dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_VirtualSystemMigrationSettingData newDataInstance = CIM_VirtualSystemMigrationSettingDataHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_VirtualSystemMigrationSettingData modifyInstance(WBEMClient client, CIM_VirtualSystemMigrationSettingData dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_VirtualSystemMigrationSettingData dataInstance2 = CIM_VirtualSystemMigrationSettingDataHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_VirtualSystemMigrationSettingData dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_VirtualSystemMigrationSettingData.getPackages());
    }

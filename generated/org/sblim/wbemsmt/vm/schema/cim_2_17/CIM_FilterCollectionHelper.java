...
public class CIM_FilterCollectionHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_FilterCollection.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_FilterCollection.");
                        resultArrayList.add(new CIM_FilterCollection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_FilterCollection.");
                        resultArrayList.add(new CIM_FilterCollection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_FilterCollection.");
                        resultArrayList.add(new CIM_FilterCollection(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_FilterCollection getInstance(WBEMClient client,
     ...
     */
    public final static CIM_FilterCollection getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_FilterCollection getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_FilterCollection.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_FilterCollection.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_FilterCollection createInstance(WBEMClient client,
            CIM_FilterCollection dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_FilterCollection newDataInstance = CIM_FilterCollectionHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_FilterCollection modifyInstance(WBEMClient client,
            CIM_FilterCollection dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_FilterCollection dataInstance2 = CIM_FilterCollectionHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_FilterCollection dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_FilterCollection.getPackages());
    }

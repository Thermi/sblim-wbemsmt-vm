/** 
  * CIM_FilterCollectionHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_FilterCollection
  *    
  * 
  * generated Class
  * @see CIM_FilterCollection
  */
...
public class CIM_FilterCollectionHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_FilterCollection or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_FilterCollection.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_FilterCollection.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_FilterCollection or the subclasses if deep == true
    */        
    public final static List<CIM_FilterCollection> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_FilterCollection> resultArrayList = new ArrayList<CIM_FilterCollection>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_FilterCollection.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_FilterCollection(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_FilterCollectionHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_FilterCollection.");
                        resultArrayList.add(new CIM_FilterCollection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_FilterCollection.");
                        resultArrayList.add(new CIM_FilterCollection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_FilterCollection)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_FilterCollection.");
                        resultArrayList.add(new CIM_FilterCollection(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_FilterCollection getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_FilterCollection getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_FilterCollection dataInstance = null;
        Class<?> clazz = CIM_FilterCollectionHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_FilterCollection)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_FilterCollection.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_FilterCollection(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_FilterCollection getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_FilterCollection.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_FilterCollection.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_FilterCollection.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_FilterCollection createInstance(WBEMClient client, CIM_FilterCollection dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_FilterCollection newDataInstance = CIM_FilterCollectionHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_FilterCollection modifyInstance(WBEMClient client, CIM_FilterCollection dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_FilterCollection dataInstance2 = CIM_FilterCollectionHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_FilterCollection dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_FilterCollection.getPackages());
    }

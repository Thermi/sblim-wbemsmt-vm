...
public class CIM_Capabilities extends CIM_ManagedElement {
    ...
    public static class METHOD_CREATEGOALSETTINGS {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_0_FOR_VALUE_ENTRY_Success = new javax.cim.UnsignedInteger16(
                "0");
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_Timeout = new javax.cim.UnsignedInteger16(
                "3");
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_Failed = new javax.cim.UnsignedInteger16(
                "4");
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_5_FOR_VALUE_ENTRY_Invalid_Parameter = new javax.cim.UnsignedInteger16(
                "5");
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_6_FOR_VALUE_ENTRY_Alternative_Proposed = new javax.cim.UnsignedInteger16(
                "6");

        /**
         * constant for value entry Alternative Proposed (corresponds to mapEntry 6 )
         */
        public final static String VALUE_ENTRY_Alternative_Proposed = "Alternative Proposed";
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@5c785c78
        ...
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Success,
                ...
                VALUE_ENTRY_Failed, VALUE_ENTRY_Invalid_Parameter,
                VALUE_ENTRY_Alternative_Proposed, VALUE_ENTRY_DMTF_Reserved,
        ...
        public final static String[] VALUE_ENTRIES_FOR_DISPLAY = { VALUE_ENTRY_Success,
                VALUE_ENTRY_Not_Supported, VALUE_ENTRY_Unknown, VALUE_ENTRY_Timeout,
                VALUE_ENTRY_Failed, VALUE_ENTRY_Invalid_Parameter, VALUE_ENTRY_Alternative_Proposed };
    ...
    public java.util.List getAssociated_CIM_SettingData_CIM_SettingsDefineCapabilitiess(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_SettingData_CIM_SettingsDefineCapabilitiess(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SETTINGSDEFINECAPABILITIES,
                CIM_SettingData.CIM_CLASS_NAME, null, null, false, false, null);
    ...
    public java.util.List getAssociated_CIM_SettingData_CIM_SettingsDefineCapabilitiesNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_SettingData_CIM_SettingsDefineCapabilitiesNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SETTINGSDEFINECAPABILITIES,
    ...
    public CreateGoalSettingsResult invoke_CreateGoalSettings(WBEMClient cimClient,
            CIM_SettingData[] TemplateGoalSettings, CIM_SettingData[] SupportedGoalSettings)
            throws WbemsmtException {

        CIMArgument[] inParameter = new CIMArgument[2];
        CIMArgument[] outParameter = new CIMArgument[1];

        inParameter[0] = new CIMArgument("TemplateGoalSettings", CIMDataType.OBJECT_ARRAY_T,
                getCIMInstances(TemplateGoalSettings));
        inParameter[1] = new CIMArgument("SupportedGoalSettings", CIMDataType.OBJECT_ARRAY_T,
                getCIMInstances(SupportedGoalSettings));

        javax.cim.UnsignedInteger16 resultObject = null;

        try {
            Object oResult = cimClient.invokeMethod(this.getCimObjectPath(),
                    METHOD_CREATEGOALSETTINGS.NAME, inParameter, outParameter);
            if (oResult != null) {
        ...
        CIMArgument arg_SupportedGoalSettings = (CIMArgument) mapOutParameter
                .get("SupportedGoalSettings");
        if (arg_SupportedGoalSettings != null) {

            CIMInstance[] instance_SupportedGoalSettings = (CIMInstance[]) arg_SupportedGoalSettings
                    .getValue();
            ...
            for (int i = 0; i < instance_SupportedGoalSettings.length; i++) {
                ...
                if (cimInstance != null) {
                    out_SupportedGoalSettings[i] = CIM_SettingDataHelper.getInstance(cimClient,
                            cimInstance);
                }
            }

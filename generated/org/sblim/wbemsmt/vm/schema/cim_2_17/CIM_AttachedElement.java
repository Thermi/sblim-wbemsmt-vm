/**
 * CIM_AttachedElement.java Â© Copyright IBM Corp.  2009,2005 THIS FILE IS PROVIDED UNDER THE TER MS
 ...
 *            Karnam<prkarnam@in.ibm.com> Description: An association between two LogicalElements
 *            indicating that the SameElement is being attached to the SystemElement. generated
 *            Class
 */
...
public class CIM_AttachedElement extends CIM_LogicalIdentity {

    public final static String CIM_CLASS_NAME = "CIM_AttachedElement";
    ...
    public CIM_AttachedElement(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_AttachedElement(CIMInstance cimInstance) throws WbemsmtException {
    ...
    public static CIMProperty create_SystemElement_CIM_LogicalElement(WBEMClient client,
        ...
        CIM_AttachedElement fco = new CIM_AttachedElement(client, namespace);
    ...
    public String getObjectName() {
        return CIM_AttachedElement.CIM_CLASS_NAME;
    }

...
public class CIM_ListenerDestination extends CIM_ManagedElement {
    ...
    public static class PROPERTY_PERSISTENCETYPE {
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@473e473e
    ...
    public static class PROPERTY_PROTOCOL {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@37c237c2
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
         ...
         */
        public final static javax.cim.UnsignedInteger16[] VALUE_MAP_ENTRIES = {
                VALUE_MAP_ENTRY_1_FOR_VALUE_ENTRY_Other, VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_CIM_XML,
         ...
         * Value Map for the property Protocol   
         */
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Other, VALUE_ENTRY_CIM_XML,
                VALUE_ENTRY_SM_CLP, VALUE_ENTRY_WS_Management, VALUE_ENTRY_WSDM,
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("OtherPersistenceType", new CIMProperty("OtherPersistenceType",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("OtherProtocol", new CIMProperty("OtherProtocol",
                CIMDataType.STRING_T, null));
    ...
    public String get_OtherProtocol() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_OTHERPROTOCOL.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_OtherProtocol(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        CIM_ListenerDestination fco = new CIM_ListenerDestination(client, namespace);
    ...
    private static CIMProperty setPropertyValue_OtherProtocol(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger16 get_Protocol() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_PROTOCOL.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_Protocol(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger16 newValue) throws WbemsmtException {
        CIM_ListenerDestination fco = new CIM_ListenerDestination(client, namespace);
    ...
    private static CIMProperty setPropertyValue_Protocol(CIMProperty currentProperty,
            javax.cim.UnsignedInteger16 newValue) {
        Object setThis = null;
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_AbstractIndicationSubscriptions(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ManagedElement_CIM_AbstractIndicationSubscriptions(cimClient,
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_AbstractIndicationSubscriptions(
        ...
        return getAssociated_CIM_ManagedElement_CIM_AbstractIndicationSubscriptions(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_ABSTRACTINDICATIONSUBSCRIPTION, resultClass, role,
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_AbstractIndicationSubscriptionNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ManagedElement_CIM_AbstractIndicationSubscriptionNames(cimClient,
                true, CIM_ASSOCIATOR_CLASS_NAME_CIM_ABSTRACTINDICATIONSUBSCRIPTION,
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_AbstractIndicationSubscriptionNames(
        ...
        return getAssociated_CIM_ManagedElement_CIM_AbstractIndicationSubscriptionNames(cimClient,
                true, CIM_ASSOCIATOR_CLASS_NAME_CIM_ABSTRACTINDICATIONSUBSCRIPTION, resultClass,
                role, resultRole);
    }
    ...
    public java.util.List getAssociations_CIM_AbstractIndicationSubscription(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_ABSTRACTINDICATIONSUBSCRIPTION, role,
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_AbstractIndicationSubscriptionHelper.findClass(cimClient,
                            cimInstance);
    ...
    public java.util.List getAssociationNames_CIM_AbstractIndicationSubscription(
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_AbstractIndicationSubscription.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    public java.util.List getAssociated_CIM_FilterCollection_CIM_FilterCollectionSubscriptions(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_FilterCollection_CIM_FilterCollectionSubscriptions(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_FILTERCOLLECTIONSUBSCRIPTION,
                CIM_FilterCollection.CIM_CLASS_NAME, null, null, false, false, null);
    ...
    public java.util.List getAssociated_CIM_FilterCollection_CIM_FilterCollectionSubscriptionNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_FilterCollection_CIM_FilterCollectionSubscriptionNames(cimClient,
                true, CIM_ASSOCIATOR_CLASS_NAME_CIM_FILTERCOLLECTIONSUBSCRIPTION,
                CIM_FilterCollection.CIM_CLASS_NAME, null, null);
    }
    ...
    public java.util.List getAssociated_CIM_FilterCollection_CIM_FilterCollectionSubscriptionNames(
        ...
        return getAssociated_CIM_FilterCollection_CIM_FilterCollectionSubscriptionNames(cimClient,
                true, CIM_ASSOCIATOR_CLASS_NAME_CIM_FILTERCOLLECTIONSUBSCRIPTION, resultClass,
                role, resultRole);
    }

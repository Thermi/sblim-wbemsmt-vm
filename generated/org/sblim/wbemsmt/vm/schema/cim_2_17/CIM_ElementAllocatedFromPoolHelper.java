/** 
  * CIM_ElementAllocatedFromPoolHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_ElementAllocatedFromPool
  *    
  * 
  * generated Class
  * @see CIM_ElementAllocatedFromPool
  */
...
public class CIM_ElementAllocatedFromPoolHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ElementAllocatedFromPool or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ElementAllocatedFromPool.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ElementAllocatedFromPool.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ElementAllocatedFromPool or the subclasses if deep == true
    */        
    public final static List<CIM_ElementAllocatedFromPool> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ElementAllocatedFromPool> resultArrayList = new ArrayList<CIM_ElementAllocatedFromPool>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ElementAllocatedFromPool.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ElementAllocatedFromPool(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ElementAllocatedFromPoolHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ElementAllocatedFromPool.");
                        resultArrayList.add(new CIM_ElementAllocatedFromPool(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ElementAllocatedFromPool.");
                        resultArrayList.add(new CIM_ElementAllocatedFromPool(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ElementAllocatedFromPool)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ElementAllocatedFromPool.");
                        resultArrayList.add(new CIM_ElementAllocatedFromPool(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ElementAllocatedFromPool getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ElementAllocatedFromPool getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ElementAllocatedFromPool dataInstance = null;
        Class<?> clazz = CIM_ElementAllocatedFromPoolHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ElementAllocatedFromPool)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ElementAllocatedFromPool.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ElementAllocatedFromPool(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_ElementAllocatedFromPool getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ElementAllocatedFromPool.PROPERTY_ANTECEDENT_CIM_RESOURCEPOOL.NAME,new CIMDataType(CIM_ResourcePool.CIM_CLASS_NAME),setThis,false,false,CIM_ElementAllocatedFromPool.CIM_CLASS_NAME); 
                   
                                 setThis = Dependent != null ? Dependent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_ElementAllocatedFromPool.PROPERTY_DEPENDENT_CIM_LOGICALELEMENT.NAME,new CIMDataType(CIM_LogicalElement.CIM_CLASS_NAME),setThis,false,false,CIM_ElementAllocatedFromPool.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ElementAllocatedFromPool.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ElementAllocatedFromPool createInstance(WBEMClient client, CIM_ElementAllocatedFromPool dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ElementAllocatedFromPool newDataInstance = CIM_ElementAllocatedFromPoolHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ElementAllocatedFromPool modifyInstance(WBEMClient client, CIM_ElementAllocatedFromPool dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ElementAllocatedFromPool dataInstance2 = CIM_ElementAllocatedFromPoolHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ElementAllocatedFromPool dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ElementAllocatedFromPool.getPackages());
    }

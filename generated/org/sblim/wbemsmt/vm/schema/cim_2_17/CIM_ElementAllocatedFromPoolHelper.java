...
public class CIM_ElementAllocatedFromPoolHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ElementAllocatedFromPool.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ElementAllocatedFromPool.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_ElementAllocatedFromPool.");
                        resultArrayList.add(new CIM_ElementAllocatedFromPool(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ElementAllocatedFromPool.");
                        resultArrayList.add(new CIM_ElementAllocatedFromPool(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ElementAllocatedFromPool.");
                        resultArrayList.add(new CIM_ElementAllocatedFromPool(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ElementAllocatedFromPool getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ElementAllocatedFromPool getInstance(WBEMClient client,
            String namespace, CIM_ResourcePool Antecedent, CIM_LogicalElement Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ElementAllocatedFromPool.PROPERTY_ANTECEDENT_CIM_RESOURCEPOOL.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ElementAllocatedFromPool.PROPERTY_DEPENDENT_CIM_LOGICALELEMENT.NAME,
     ...
     *
     */
    public final static CIM_ElementAllocatedFromPool createInstance(WBEMClient client,
            CIM_ElementAllocatedFromPool dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ElementAllocatedFromPool newDataInstance = CIM_ElementAllocatedFromPoolHelper
     ...
     */
    public final static CIM_ElementAllocatedFromPool modifyInstance(WBEMClient client,
            CIM_ElementAllocatedFromPool dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ElementAllocatedFromPool dataInstance2 = CIM_ElementAllocatedFromPoolHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ElementAllocatedFromPool dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ElementAllocatedFromPool.getPackages());
    }

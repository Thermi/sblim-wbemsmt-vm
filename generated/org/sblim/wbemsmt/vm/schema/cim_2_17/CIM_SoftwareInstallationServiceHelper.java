/** 
  * CIM_SoftwareInstallationServiceHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_SoftwareInstallationService
  *    
  * 
  * generated Class
  * @see CIM_SoftwareInstallationService
  */
...
public class CIM_SoftwareInstallationServiceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_SoftwareInstallationService or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_SoftwareInstallationService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_SoftwareInstallationService.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_SoftwareInstallationService or the subclasses if deep == true
    */        
    public final static List<CIM_SoftwareInstallationService> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_SoftwareInstallationService> resultArrayList = new ArrayList<CIM_SoftwareInstallationService>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_SoftwareInstallationService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SoftwareInstallationService(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_SoftwareInstallationServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SoftwareInstallationService.");
                        resultArrayList.add(new CIM_SoftwareInstallationService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SoftwareInstallationService.");
                        resultArrayList.add(new CIM_SoftwareInstallationService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_SoftwareInstallationService)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SoftwareInstallationService.");
                        resultArrayList.add(new CIM_SoftwareInstallationService(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_SoftwareInstallationService getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_SoftwareInstallationService getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_SoftwareInstallationService dataInstance = null;
        Class<?> clazz = CIM_SoftwareInstallationServiceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_SoftwareInstallationService)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SoftwareInstallationService.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_SoftwareInstallationService(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_SoftwareInstallationService getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_SoftwareInstallationService.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_SoftwareInstallationService.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[1]  = new CIMProperty(CIM_SoftwareInstallationService.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_SoftwareInstallationService.CIM_CLASS_NAME); 
                   
                   setThis = SystemCreationClassName;
                
           keyProperties[2]  = new CIMProperty(CIM_SoftwareInstallationService.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_SoftwareInstallationService.CIM_CLASS_NAME); 
                   
                   setThis = SystemName;
                
           keyProperties[3]  = new CIMProperty(CIM_SoftwareInstallationService.PROPERTY_SYSTEMNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_SoftwareInstallationService.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_SoftwareInstallationService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_SoftwareInstallationService createInstance(WBEMClient client, CIM_SoftwareInstallationService dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_SoftwareInstallationService newDataInstance = CIM_SoftwareInstallationServiceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_SoftwareInstallationService modifyInstance(WBEMClient client, CIM_SoftwareInstallationService dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_SoftwareInstallationService dataInstance2 = CIM_SoftwareInstallationServiceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_SoftwareInstallationService dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_SoftwareInstallationService.getPackages());
    }

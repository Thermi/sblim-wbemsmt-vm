...
public class CIM_ResourcePool extends CIM_LogicalElement {
    ...
    public static class PROPERTY_RESOURCETYPE {
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@1bc01bc
    ...
    public javax.cim.UnsignedInteger64 get_Reserved() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_RESERVED.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_Reserved(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger64 newValue) throws WbemsmtException {
        CIM_ResourcePool fco = new CIM_ResourcePool(client, namespace);
    ...
    private static CIMProperty setPropertyValue_Reserved(CIMProperty currentProperty,
            javax.cim.UnsignedInteger64 newValue) {
        Object setThis = null;
    ...
    public java.util.List getAssociated_CIM_LogicalElement_CIM_ElementAllocatedFromPools(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_LogicalElement_CIM_ElementAllocatedFromPools(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTALLOCATEDFROMPOOL,
                CIM_LogicalElement.CIM_CLASS_NAME, null, null, false, false, null);
    ...
    public java.util.List getAssociated_CIM_LogicalElement_CIM_ElementAllocatedFromPoolNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_LogicalElement_CIM_ElementAllocatedFromPoolNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTALLOCATEDFROMPOOL,
    ...
    public java.util.List getAssociated_CIM_System_CIM_HostedResourcePools(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_System_CIM_HostedResourcePools(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDRESOURCEPOOL, CIM_System.CIM_CLASS_NAME, null,
    ...
    public java.util.List getAssociated_CIM_System_CIM_HostedResourcePools(WBEMClient cimClient,
        ...
        return getAssociated_CIM_System_CIM_HostedResourcePools(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDRESOURCEPOOL, resultClass, role, resultRole,
                false, false, null);
    ...
    public java.util.List getAssociated_CIM_System_CIM_HostedResourcePoolNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_System_CIM_HostedResourcePoolNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDRESOURCEPOOL, CIM_System.CIM_CLASS_NAME, null,
                null);
    }
    ...
    public java.util.List getAssociated_CIM_System_CIM_HostedResourcePoolNames(
            WBEMClient cimClient, String resultClass, String role, String resultRole)
            throws WbemsmtException {
    ...
    public java.util.List getAssociated_CIM_System_CIM_HostedResourcePoolNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDRESOURCEPOOL,
    ...
    public java.util.List getAssociations_CIM_HostedResourcePool(WBEMClient cimClient,
            boolean includeQualifiers, boolean includeClassOrigin, String role,
            java.lang.String[] propertyList) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDRESOURCEPOOL, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
            throw new ReferencesException(e, new ReferencesUserObject(this.getCimObjectPath(),
    ...
    public java.util.List getAssociationNames_CIM_HostedResourcePool(WBEMClient cimClient,
            String role, boolean deep) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDRESOURCEPOOL, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDRESOURCEPOOL, role));
        }
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_HostedResourcePool.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    public java.util.List getAssociated_CIM_ResourceAllocationSettingData_CIM_ResourceAllocationFromPools(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ResourceAllocationSettingData_CIM_ResourceAllocationFromPools(
                cimClient, CIM_ASSOCIATOR_CLASS_NAME_CIM_RESOURCEALLOCATIONFROMPOOL,
    ...
    public java.util.List getAssociated_CIM_ResourceAllocationSettingData_CIM_ResourceAllocationFromPools(
        ...
        return getAssociated_CIM_ResourceAllocationSettingData_CIM_ResourceAllocationFromPools(
                cimClient, CIM_ASSOCIATOR_CLASS_NAME_CIM_RESOURCEALLOCATIONFROMPOOL, resultClass,
    ...
    public java.util.List getAssociated_CIM_ResourceAllocationSettingData_CIM_ResourceAllocationFromPoolNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ResourceAllocationSettingData_CIM_ResourceAllocationFromPoolNames(
                cimClient, true, CIM_ASSOCIATOR_CLASS_NAME_CIM_RESOURCEALLOCATIONFROMPOOL,

...
public class CIM_SettingsDefineStateHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SettingsDefineState.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SettingsDefineState.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_SettingsDefineState.");
                        resultArrayList.add(new CIM_SettingsDefineState(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SettingsDefineState.");
                        resultArrayList.add(new CIM_SettingsDefineState(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SettingsDefineState.");
                        resultArrayList.add(new CIM_SettingsDefineState(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SettingsDefineState getInstance(WBEMClient client,
    ...
    public final static CIM_SettingsDefineState getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SettingsDefineState.PROPERTY_MANAGEDELEMENT_CIM_MANAGEDELEMENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SettingsDefineState.PROPERTY_SETTINGDATA_CIM_SETTINGDATA.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_SettingsDefineState createInstance(WBEMClient client,
            CIM_SettingsDefineState dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SettingsDefineState newDataInstance = CIM_SettingsDefineStateHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SettingsDefineState modifyInstance(WBEMClient client,
            CIM_SettingsDefineState dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SettingsDefineState dataInstance2 = CIM_SettingsDefineStateHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SettingsDefineState dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SettingsDefineState.getPackages());
    }

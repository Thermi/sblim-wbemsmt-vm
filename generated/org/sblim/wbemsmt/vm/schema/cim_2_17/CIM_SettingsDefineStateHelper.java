/** 
  * CIM_SettingsDefineStateHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_SettingsDefineState
  *    
  * 
  * generated Class
  * @see CIM_SettingsDefineState
  */
...
public class CIM_SettingsDefineStateHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_SettingsDefineState or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_SettingsDefineState.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_SettingsDefineState.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_SettingsDefineState or the subclasses if deep == true
    */        
    public final static List<CIM_SettingsDefineState> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_SettingsDefineState> resultArrayList = new ArrayList<CIM_SettingsDefineState>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_SettingsDefineState.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SettingsDefineState(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_SettingsDefineStateHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SettingsDefineState.");
                        resultArrayList.add(new CIM_SettingsDefineState(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SettingsDefineState.");
                        resultArrayList.add(new CIM_SettingsDefineState(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_SettingsDefineState)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SettingsDefineState.");
                        resultArrayList.add(new CIM_SettingsDefineState(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_SettingsDefineState getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_SettingsDefineState getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_SettingsDefineState dataInstance = null;
        Class<?> clazz = CIM_SettingsDefineStateHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_SettingsDefineState)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SettingsDefineState.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_SettingsDefineState(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_SettingsDefineState getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_SettingsDefineState.PROPERTY_MANAGEDELEMENT_CIM_MANAGEDELEMENT.NAME,new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME),setThis,false,false,CIM_SettingsDefineState.CIM_CLASS_NAME); 
                   
                                 setThis = SettingData != null ? SettingData.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_SettingsDefineState.PROPERTY_SETTINGDATA_CIM_SETTINGDATA.NAME,new CIMDataType(CIM_SettingData.CIM_CLASS_NAME),setThis,false,false,CIM_SettingsDefineState.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_SettingsDefineState.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_SettingsDefineState createInstance(WBEMClient client, CIM_SettingsDefineState dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_SettingsDefineState newDataInstance = CIM_SettingsDefineStateHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_SettingsDefineState modifyInstance(WBEMClient client, CIM_SettingsDefineState dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_SettingsDefineState dataInstance2 = CIM_SettingsDefineStateHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_SettingsDefineState dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_SettingsDefineState.getPackages());
    }

/** 
  * CIM_VirtualSystemSettingDataHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_VirtualSystemSettingData
  *    
  * 
  * generated Class
  * @see CIM_VirtualSystemSettingData
  */
...
public class CIM_VirtualSystemSettingDataHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_VirtualSystemSettingData or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_VirtualSystemSettingData.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_VirtualSystemSettingData.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_VirtualSystemSettingData or the subclasses if deep == true
    */        
    public final static List<CIM_VirtualSystemSettingData> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_VirtualSystemSettingData> resultArrayList = new ArrayList<CIM_VirtualSystemSettingData>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_VirtualSystemSettingData.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_VirtualSystemSettingData(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_VirtualSystemSettingDataHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_VirtualSystemSettingData.");
                        resultArrayList.add(new CIM_VirtualSystemSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_VirtualSystemSettingData.");
                        resultArrayList.add(new CIM_VirtualSystemSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_VirtualSystemSettingData)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_VirtualSystemSettingData.");
                        resultArrayList.add(new CIM_VirtualSystemSettingData(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_VirtualSystemSettingData getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_VirtualSystemSettingData getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_VirtualSystemSettingData dataInstance = null;
        Class<?> clazz = CIM_VirtualSystemSettingDataHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_VirtualSystemSettingData)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_VirtualSystemSettingData.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_VirtualSystemSettingData(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_VirtualSystemSettingData getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_VirtualSystemSettingData.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_VirtualSystemSettingData.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_VirtualSystemSettingData.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_VirtualSystemSettingData createInstance(WBEMClient client, CIM_VirtualSystemSettingData dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_VirtualSystemSettingData newDataInstance = CIM_VirtualSystemSettingDataHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_VirtualSystemSettingData modifyInstance(WBEMClient client, CIM_VirtualSystemSettingData dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_VirtualSystemSettingData dataInstance2 = CIM_VirtualSystemSettingDataHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_VirtualSystemSettingData dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_VirtualSystemSettingData.getPackages());
    }

...
public class CIM_VirtualSystemSettingDataHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_VirtualSystemSettingData.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_VirtualSystemSettingData.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_VirtualSystemSettingData.");
                        resultArrayList.add(new CIM_VirtualSystemSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_VirtualSystemSettingData.");
                        resultArrayList.add(new CIM_VirtualSystemSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_VirtualSystemSettingData.");
                        resultArrayList.add(new CIM_VirtualSystemSettingData(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_VirtualSystemSettingData getInstance(WBEMClient client,
    ...
    public final static CIM_VirtualSystemSettingData getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(CIM_VirtualSystemSettingData.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static CIM_VirtualSystemSettingData createInstance(WBEMClient client,
            CIM_VirtualSystemSettingData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_VirtualSystemSettingData newDataInstance = CIM_VirtualSystemSettingDataHelper
     ...
     */
    public final static CIM_VirtualSystemSettingData modifyInstance(WBEMClient client,
            CIM_VirtualSystemSettingData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_VirtualSystemSettingData dataInstance2 = CIM_VirtualSystemSettingDataHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_VirtualSystemSettingData dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_VirtualSystemSettingData.getPackages());
    }

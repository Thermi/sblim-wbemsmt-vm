...
//**********************************************************************
    ...
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_LogicalDisk.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
    ...
    */        
    public final static List<CIM_LogicalDisk> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_LogicalDisk> resultArrayList = new ArrayList<CIM_LogicalDisk>();
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_LogicalDisk)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_LogicalDisk getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_LogicalDisk getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
    ...
    */    
    public final static CIM_LogicalDisk getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_LogicalDisk.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_LogicalDisk.CIM_CLASS_NAME); 
                   
                   setThis = DeviceID;
                
           keyProperties[1]  = new CIMProperty(CIM_LogicalDisk.PROPERTY_DEVICEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_LogicalDisk.CIM_CLASS_NAME); 
                   
                   setThis = SystemCreationClassName;
                
           keyProperties[2]  = new CIMProperty(CIM_LogicalDisk.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_LogicalDisk.CIM_CLASS_NAME); 
                   
                   setThis = SystemName;
                
           keyProperties[3]  = new CIMProperty(CIM_LogicalDisk.PROPERTY_SYSTEMNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_LogicalDisk.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_LogicalDisk.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_LogicalDisk createInstance(WBEMClient client, CIM_LogicalDisk dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
...
//**********************************************************************
    ...
    */    
    public final static CIM_LogicalDisk modifyInstance(WBEMClient client, CIM_LogicalDisk dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_LogicalDisk dataInstance2 = CIM_LogicalDiskHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_LogicalDisk dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_LogicalDisk.getPackages());
    }

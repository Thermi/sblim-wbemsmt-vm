...
//**********************************************************************
    ...
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ServiceAffectsElement.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ServiceAffectsElement.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    */        
    public final static List<CIM_ServiceAffectsElement> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ServiceAffectsElement> resultArrayList = new ArrayList<CIM_ServiceAffectsElement>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ServiceAffectsElement.CIM_CLASS_NAME)) {
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ServiceAffectsElement)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ServiceAffectsElement getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ServiceAffectsElement getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ServiceAffectsElement getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ServiceAffectsElement.PROPERTY_AFFECTEDELEMENT_CIM_MANAGEDELEMENT.NAME,new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME),setThis,false,false,CIM_ServiceAffectsElement.CIM_CLASS_NAME); 
                   
                                 setThis = AffectingElement != null ? AffectingElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_ServiceAffectsElement.PROPERTY_AFFECTINGELEMENT_CIM_SERVICE.NAME,new CIMDataType(CIM_Service.CIM_CLASS_NAME),setThis,false,false,CIM_ServiceAffectsElement.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ServiceAffectsElement.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ServiceAffectsElement createInstance(WBEMClient client, CIM_ServiceAffectsElement dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ServiceAffectsElement newDataInstance = CIM_ServiceAffectsElementHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ServiceAffectsElement modifyInstance(WBEMClient client, CIM_ServiceAffectsElement dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ServiceAffectsElement dataInstance2 = CIM_ServiceAffectsElementHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ServiceAffectsElement dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ServiceAffectsElement.getPackages());
    }

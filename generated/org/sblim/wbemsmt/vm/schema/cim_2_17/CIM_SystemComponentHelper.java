...
//**********************************************************************
    ...
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_SystemComponent.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_SystemComponent.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    */        
    public final static List<CIM_SystemComponent> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_SystemComponent> resultArrayList = new ArrayList<CIM_SystemComponent>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_SystemComponent.CIM_CLASS_NAME)) {
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_SystemComponent)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_SystemComponent getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_SystemComponent getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
    ...
    */    
    public final static CIM_SystemComponent getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_SystemComponent.PROPERTY_GROUPCOMPONENT_CIM_SYSTEM.NAME,new CIMDataType(CIM_System.CIM_CLASS_NAME),setThis,false,false,CIM_SystemComponent.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_SystemComponent.PROPERTY_PARTCOMPONENT_CIM_MANAGEDSYSTEMELEMENT.NAME,new CIMDataType(CIM_ManagedSystemElement.CIM_CLASS_NAME),setThis,false,false,CIM_SystemComponent.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_SystemComponent.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_SystemComponent createInstance(WBEMClient client, CIM_SystemComponent dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_SystemComponent newDataInstance = CIM_SystemComponentHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_SystemComponent modifyInstance(WBEMClient client, CIM_SystemComponent dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_SystemComponent dataInstance2 = CIM_SystemComponentHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_SystemComponent dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_SystemComponent.getPackages());
    }

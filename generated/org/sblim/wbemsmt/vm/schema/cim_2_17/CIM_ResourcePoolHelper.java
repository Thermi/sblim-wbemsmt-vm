...
public class CIM_ResourcePoolHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ResourcePool.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_ResourcePool.");
                        resultArrayList.add(new CIM_ResourcePool(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ResourcePool.");
                        resultArrayList.add(new CIM_ResourcePool(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ResourcePool.");
                        resultArrayList.add(new CIM_ResourcePool(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ResourcePool getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_ResourcePool getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_ResourcePool getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_ResourcePool.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ResourcePool.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ResourcePool createInstance(WBEMClient client,
            CIM_ResourcePool dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ResourcePool newDataInstance = CIM_ResourcePoolHelper
     ...
     */
    public final static CIM_ResourcePool modifyInstance(WBEMClient client,
            CIM_ResourcePool dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ResourcePool dataInstance2 = CIM_ResourcePoolHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ResourcePool dataInstance)
            throws WbemsmtException {

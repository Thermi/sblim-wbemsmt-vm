/** 
  * CIM_HostedResourcePoolHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_HostedResourcePool
  *    
  * 
  * generated Class
  * @see CIM_HostedResourcePool
  */
...
public class CIM_HostedResourcePoolHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_HostedResourcePool or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_HostedResourcePool.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_HostedResourcePool.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_HostedResourcePool or the subclasses if deep == true
    */        
    public final static List<CIM_HostedResourcePool> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_HostedResourcePool> resultArrayList = new ArrayList<CIM_HostedResourcePool>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_HostedResourcePool.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_HostedResourcePool(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_HostedResourcePoolHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_HostedResourcePool.");
                        resultArrayList.add(new CIM_HostedResourcePool(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_HostedResourcePool.");
                        resultArrayList.add(new CIM_HostedResourcePool(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_HostedResourcePool)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_HostedResourcePool.");
                        resultArrayList.add(new CIM_HostedResourcePool(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_HostedResourcePool getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_HostedResourcePool getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_HostedResourcePool dataInstance = null;
        Class<?> clazz = CIM_HostedResourcePoolHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_HostedResourcePool)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_HostedResourcePool.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_HostedResourcePool(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_HostedResourcePool getInstance(WBEMClient client, String namespace
                                                       ,CIM_System GroupComponent
                                                       ,CIM_ResourcePool PartComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_HostedResourcePool.PROPERTY_GROUPCOMPONENT_CIM_SYSTEM.NAME,new CIMDataType(CIM_System.CIM_CLASS_NAME),setThis,false,false,CIM_HostedResourcePool.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_HostedResourcePool.PROPERTY_PARTCOMPONENT_CIM_RESOURCEPOOL.NAME,new CIMDataType(CIM_ResourcePool.CIM_CLASS_NAME),setThis,false,false,CIM_HostedResourcePool.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_HostedResourcePool.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_HostedResourcePool createInstance(WBEMClient client, CIM_HostedResourcePool dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_HostedResourcePool newDataInstance = CIM_HostedResourcePoolHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_HostedResourcePool modifyInstance(WBEMClient client, CIM_HostedResourcePool dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_HostedResourcePool dataInstance2 = CIM_HostedResourcePoolHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_HostedResourcePool dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_HostedResourcePool.getPackages());
    }

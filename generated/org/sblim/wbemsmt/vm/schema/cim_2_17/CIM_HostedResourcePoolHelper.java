...
public class CIM_HostedResourcePoolHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_HostedResourcePool.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_HostedResourcePool.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_HostedResourcePool.");
                        resultArrayList.add(new CIM_HostedResourcePool(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_HostedResourcePool.");
                        resultArrayList.add(new CIM_HostedResourcePool(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_HostedResourcePool.");
                        resultArrayList.add(new CIM_HostedResourcePool(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_HostedResourcePool getInstance(WBEMClient client,
    ...
    public final static CIM_HostedResourcePool getInstance(WBEMClient client, String namespace,
            CIM_System GroupComponent, CIM_ResourcePool PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_HostedResourcePool.PROPERTY_GROUPCOMPONENT_CIM_SYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_HostedResourcePool.PROPERTY_PARTCOMPONENT_CIM_RESOURCEPOOL.NAME,
     ...
     *
     */
    public final static CIM_HostedResourcePool createInstance(WBEMClient client,
            CIM_HostedResourcePool dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_HostedResourcePool newDataInstance = CIM_HostedResourcePoolHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_HostedResourcePool modifyInstance(WBEMClient client,
            CIM_HostedResourcePool dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_HostedResourcePool dataInstance2 = CIM_HostedResourcePoolHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_HostedResourcePool dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_HostedResourcePool.getPackages());
    }

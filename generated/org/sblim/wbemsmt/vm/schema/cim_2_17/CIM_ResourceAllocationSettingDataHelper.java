...
public class CIM_ResourceAllocationSettingDataHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ResourceAllocationSettingData.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ResourceAllocationSettingData.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_ResourceAllocationSettingDataHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ResourceAllocationSettingData.");
                        resultArrayList.add(new CIM_ResourceAllocationSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ResourceAllocationSettingData.");
                        resultArrayList.add(new CIM_ResourceAllocationSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ResourceAllocationSettingData.");
                        resultArrayList.add(new CIM_ResourceAllocationSettingData(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ResourceAllocationSettingData getInstance(WBEMClient client,
    ...
    public final static CIM_ResourceAllocationSettingData getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ResourceAllocationSettingData.PROPERTY_INSTANCEID.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_ResourceAllocationSettingData.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ResourceAllocationSettingData createInstance(WBEMClient client,
            CIM_ResourceAllocationSettingData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ResourceAllocationSettingData newDataInstance = CIM_ResourceAllocationSettingDataHelper
     ...
     */
    public final static CIM_ResourceAllocationSettingData modifyInstance(WBEMClient client,
            CIM_ResourceAllocationSettingData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ResourceAllocationSettingData dataInstance2 = CIM_ResourceAllocationSettingDataHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ResourceAllocationSettingData dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ResourceAllocationSettingData.getPackages());
    }

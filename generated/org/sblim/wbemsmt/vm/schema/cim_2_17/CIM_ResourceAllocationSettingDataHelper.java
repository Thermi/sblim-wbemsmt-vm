/** 
  * CIM_ResourceAllocationSettingDataHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_ResourceAllocationSettingData
  *    
  * 
  * generated Class
  * @see CIM_ResourceAllocationSettingData
  */
...
public class CIM_ResourceAllocationSettingDataHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ResourceAllocationSettingData or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ResourceAllocationSettingData.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ResourceAllocationSettingData.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ResourceAllocationSettingData or the subclasses if deep == true
    */        
    public final static List<CIM_ResourceAllocationSettingData> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ResourceAllocationSettingData> resultArrayList = new ArrayList<CIM_ResourceAllocationSettingData>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ResourceAllocationSettingData.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ResourceAllocationSettingData(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ResourceAllocationSettingDataHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ResourceAllocationSettingData.");
                        resultArrayList.add(new CIM_ResourceAllocationSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ResourceAllocationSettingData.");
                        resultArrayList.add(new CIM_ResourceAllocationSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ResourceAllocationSettingData)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ResourceAllocationSettingData.");
                        resultArrayList.add(new CIM_ResourceAllocationSettingData(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ResourceAllocationSettingData getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ResourceAllocationSettingData getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ResourceAllocationSettingData dataInstance = null;
        Class<?> clazz = CIM_ResourceAllocationSettingDataHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ResourceAllocationSettingData)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ResourceAllocationSettingData.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ResourceAllocationSettingData(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_ResourceAllocationSettingData getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ResourceAllocationSettingData.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_ResourceAllocationSettingData.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ResourceAllocationSettingData.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ResourceAllocationSettingData createInstance(WBEMClient client, CIM_ResourceAllocationSettingData dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ResourceAllocationSettingData newDataInstance = CIM_ResourceAllocationSettingDataHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ResourceAllocationSettingData modifyInstance(WBEMClient client, CIM_ResourceAllocationSettingData dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ResourceAllocationSettingData dataInstance2 = CIM_ResourceAllocationSettingDataHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ResourceAllocationSettingData dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ResourceAllocationSettingData.getPackages());
    }

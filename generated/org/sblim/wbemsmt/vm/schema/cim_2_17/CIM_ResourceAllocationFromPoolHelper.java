/** 
  * CIM_ResourceAllocationFromPoolHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_ResourceAllocationFromPool
  *    
  * 
  * generated Class
  * @see CIM_ResourceAllocationFromPool
  */
...
public class CIM_ResourceAllocationFromPoolHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ResourceAllocationFromPool or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ResourceAllocationFromPool.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ResourceAllocationFromPool.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ResourceAllocationFromPool or the subclasses if deep == true
    */        
    public final static List<CIM_ResourceAllocationFromPool> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ResourceAllocationFromPool> resultArrayList = new ArrayList<CIM_ResourceAllocationFromPool>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ResourceAllocationFromPool.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ResourceAllocationFromPool(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ResourceAllocationFromPoolHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ResourceAllocationFromPool.");
                        resultArrayList.add(new CIM_ResourceAllocationFromPool(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ResourceAllocationFromPool.");
                        resultArrayList.add(new CIM_ResourceAllocationFromPool(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ResourceAllocationFromPool)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ResourceAllocationFromPool.");
                        resultArrayList.add(new CIM_ResourceAllocationFromPool(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ResourceAllocationFromPool getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ResourceAllocationFromPool getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ResourceAllocationFromPool dataInstance = null;
        Class<?> clazz = CIM_ResourceAllocationFromPoolHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ResourceAllocationFromPool)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ResourceAllocationFromPool.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ResourceAllocationFromPool(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_ResourceAllocationFromPool getInstance(WBEMClient client, String namespace
                                                       ,CIM_ResourcePool Antecedent
                                                       ,CIM_ResourceAllocationSettingData Dependent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ResourceAllocationFromPool.PROPERTY_ANTECEDENT_CIM_RESOURCEPOOL.NAME,new CIMDataType(CIM_ResourcePool.CIM_CLASS_NAME),setThis,false,false,CIM_ResourceAllocationFromPool.CIM_CLASS_NAME); 
                   
                                 setThis = Dependent != null ? Dependent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_ResourceAllocationFromPool.PROPERTY_DEPENDENT_CIM_RESOURCEALLOCATIONSETTINGDATA.NAME,new CIMDataType(CIM_ResourceAllocationSettingData.CIM_CLASS_NAME),setThis,false,false,CIM_ResourceAllocationFromPool.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ResourceAllocationFromPool.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ResourceAllocationFromPool createInstance(WBEMClient client, CIM_ResourceAllocationFromPool dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ResourceAllocationFromPool newDataInstance = CIM_ResourceAllocationFromPoolHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ResourceAllocationFromPool modifyInstance(WBEMClient client, CIM_ResourceAllocationFromPool dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ResourceAllocationFromPool dataInstance2 = CIM_ResourceAllocationFromPoolHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ResourceAllocationFromPool dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ResourceAllocationFromPool.getPackages());
    }

...
public class CIM_ResourceAllocationFromPoolHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ResourceAllocationFromPool.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ResourceAllocationFromPool.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_ResourceAllocationFromPoolHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ResourceAllocationFromPool.");
                        resultArrayList.add(new CIM_ResourceAllocationFromPool(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ResourceAllocationFromPool.");
                        resultArrayList.add(new CIM_ResourceAllocationFromPool(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ResourceAllocationFromPool.");
                        resultArrayList.add(new CIM_ResourceAllocationFromPool(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ResourceAllocationFromPool getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ResourceAllocationFromPool getInstance(WBEMClient client,
            String namespace, CIM_ResourcePool Antecedent,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ResourceAllocationFromPool.PROPERTY_ANTECEDENT_CIM_RESOURCEPOOL.NAME,
                new CIMDataType(CIM_ResourcePool.CIM_CLASS_NAME), setThis, false, false,
                CIM_ResourceAllocationFromPool.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_ResourceAllocationFromPool.PROPERTY_DEPENDENT_CIM_RESOURCEALLOCATIONSETTINGDATA.NAME,
                new CIMDataType(CIM_ResourceAllocationSettingData.CIM_CLASS_NAME), setThis, false,
                false, CIM_ResourceAllocationFromPool.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ResourceAllocationFromPool createInstance(WBEMClient client,
            CIM_ResourceAllocationFromPool dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ResourceAllocationFromPool newDataInstance = CIM_ResourceAllocationFromPoolHelper
     ...
     */
    public final static CIM_ResourceAllocationFromPool modifyInstance(WBEMClient client,
            CIM_ResourceAllocationFromPool dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ResourceAllocationFromPool dataInstance2 = CIM_ResourceAllocationFromPoolHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ResourceAllocationFromPool dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ResourceAllocationFromPool.getPackages());
    }

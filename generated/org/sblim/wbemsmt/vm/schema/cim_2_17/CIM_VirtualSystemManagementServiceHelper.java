/** 
  * CIM_VirtualSystemManagementServiceHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_VirtualSystemManagementService
  *    
  * 
  * generated Class
  * @see CIM_VirtualSystemManagementService
  */
...
public class CIM_VirtualSystemManagementServiceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_VirtualSystemManagementService or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_VirtualSystemManagementService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_VirtualSystemManagementService.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_VirtualSystemManagementService or the subclasses if deep == true
    */        
    public final static List<CIM_VirtualSystemManagementService> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_VirtualSystemManagementService> resultArrayList = new ArrayList<CIM_VirtualSystemManagementService>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_VirtualSystemManagementService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_VirtualSystemManagementService(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_VirtualSystemManagementServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_VirtualSystemManagementService.");
                        resultArrayList.add(new CIM_VirtualSystemManagementService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_VirtualSystemManagementService.");
                        resultArrayList.add(new CIM_VirtualSystemManagementService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_VirtualSystemManagementService)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_VirtualSystemManagementService.");
                        resultArrayList.add(new CIM_VirtualSystemManagementService(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_VirtualSystemManagementService getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_VirtualSystemManagementService getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_VirtualSystemManagementService dataInstance = null;
        Class<?> clazz = CIM_VirtualSystemManagementServiceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_VirtualSystemManagementService)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_VirtualSystemManagementService.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_VirtualSystemManagementService(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_VirtualSystemManagementService getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_VirtualSystemManagementService.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_VirtualSystemManagementService.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[1]  = new CIMProperty(CIM_VirtualSystemManagementService.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_VirtualSystemManagementService.CIM_CLASS_NAME); 
                   
                   setThis = SystemCreationClassName;
                
           keyProperties[2]  = new CIMProperty(CIM_VirtualSystemManagementService.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_VirtualSystemManagementService.CIM_CLASS_NAME); 
                   
                   setThis = SystemName;
                
           keyProperties[3]  = new CIMProperty(CIM_VirtualSystemManagementService.PROPERTY_SYSTEMNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_VirtualSystemManagementService.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_VirtualSystemManagementService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_VirtualSystemManagementService createInstance(WBEMClient client, CIM_VirtualSystemManagementService dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_VirtualSystemManagementService newDataInstance = CIM_VirtualSystemManagementServiceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_VirtualSystemManagementService modifyInstance(WBEMClient client, CIM_VirtualSystemManagementService dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_VirtualSystemManagementService dataInstance2 = CIM_VirtualSystemManagementServiceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_VirtualSystemManagementService dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_VirtualSystemManagementService.getPackages());
    }

...
public class CIM_IndicationFilter extends CIM_ManagedElement {
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("IndividualSubscriptionSupported", new CIMProperty(
                "IndividualSubscriptionSupported", CIMDataType.BOOLEAN_T, null));
        ...
        propertiesToCheck.put("SourceNamespace", new CIMProperty("SourceNamespace",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("SourceNamespaces", new CIMProperty("SourceNamespaces",
        ...
        propertiesToCheck.put("SystemName", new CIMProperty("SystemName", CIMDataType.STRING_T,
                null));
        propertiesToCheck.put("TemplateVariable", new CIMProperty("TemplateVariable",
                CIMDataType.STRING_ARRAY_T, null));
    ...
    public Boolean get_IndividualSubscriptionSupported() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_INDIVIDUALSUBSCRIPTIONSUPPORTED.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_IndividualSubscriptionSupported(WBEMClient client,
    ...
    private static CIMProperty setPropertyValue_IndividualSubscriptionSupported(
    ...
    public String[] get_SourceNamespaces() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SOURCENAMESPACES.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_SourceNamespaces(WBEMClient client, String namespace,
            String[] newValue) throws WbemsmtException {
        CIM_IndicationFilter fco = new CIM_IndicationFilter(client, namespace);
    ...
    private static CIMProperty setPropertyValue_SourceNamespaces(CIMProperty currentProperty,
            String[] newValue) {
        Object setThis = null;
    ...
    public String[] get_TemplateVariable() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_TEMPLATEVARIABLE.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_TemplateVariable(WBEMClient client, String namespace,
            String[] newValue) throws WbemsmtException {
        CIM_IndicationFilter fco = new CIM_IndicationFilter(client, namespace);
    ...
    private static CIMProperty setPropertyValue_TemplateVariable(CIMProperty currentProperty,
            String[] newValue) {
        Object setThis = null;

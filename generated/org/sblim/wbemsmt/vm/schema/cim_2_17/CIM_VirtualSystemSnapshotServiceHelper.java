...
public class CIM_VirtualSystemSnapshotServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_VirtualSystemSnapshotService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_VirtualSystemSnapshotService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_VirtualSystemSnapshotService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_VirtualSystemSnapshotService(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_VirtualSystemSnapshotServiceHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_VirtualSystemSnapshotService.");
                        resultArrayList.add(new CIM_VirtualSystemSnapshotService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_VirtualSystemSnapshotService.");
                        resultArrayList.add(new CIM_VirtualSystemSnapshotService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_VirtualSystemSnapshotService.");
                        resultArrayList.add(new CIM_VirtualSystemSnapshotService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_VirtualSystemSnapshotService getInstance(WBEMClient client,
    ...
    public final static CIM_VirtualSystemSnapshotService getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_VirtualSystemSnapshotService.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_VirtualSystemSnapshotService.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_VirtualSystemSnapshotService.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_VirtualSystemSnapshotService.CIM_CLASS_NAME);
        ...
        keyProperties[2] = new CIMProperty(
                CIM_VirtualSystemSnapshotService.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_VirtualSystemSnapshotService.CIM_CLASS_NAME);
        ...
        keyProperties[3] = new CIMProperty(
                CIM_VirtualSystemSnapshotService.PROPERTY_SYSTEMNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_VirtualSystemSnapshotService.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_VirtualSystemSnapshotService createInstance(WBEMClient client,
            CIM_VirtualSystemSnapshotService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_VirtualSystemSnapshotService newDataInstance = CIM_VirtualSystemSnapshotServiceHelper
     ...
     */
    public final static CIM_VirtualSystemSnapshotService modifyInstance(WBEMClient client,
            CIM_VirtualSystemSnapshotService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_VirtualSystemSnapshotService dataInstance2 = CIM_VirtualSystemSnapshotServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_VirtualSystemSnapshotService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_VirtualSystemSnapshotService.getPackages());
    }

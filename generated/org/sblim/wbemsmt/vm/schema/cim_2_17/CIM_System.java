...
public class CIM_System extends CIM_EnabledLogicalElement {
    ...
    public java.util.List getAssociated_CIM_ResourcePool_CIM_HostedResourcePools(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ResourcePool_CIM_HostedResourcePools(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDRESOURCEPOOL, CIM_ResourcePool.CIM_CLASS_NAME,
    ...
    public java.util.List getAssociated_CIM_ResourcePool_CIM_HostedResourcePoolNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ResourcePool_CIM_HostedResourcePoolNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDRESOURCEPOOL, CIM_ResourcePool.CIM_CLASS_NAME,
                null, null);
    }

/**
 * CIM_MostCurrentSnapshotInBranch.java Â© Copyright IBM Corp.  2009,2005 THIS FILE IS PROVIDED UNDER
...
public class CIM_MostCurrentSnapshotInBranch extends CIM_Dependency {

    public final static String CIM_CLASS_NAME = "CIM_MostCurrentSnapshotInBranch";
    ...
    public CIM_MostCurrentSnapshotInBranch(WBEMClient client, String namespace)
    ...
    public CIM_MostCurrentSnapshotInBranch(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_MostCurrentSnapshotInBranch() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_ComputerSystem(WBEMClient client,
        ...
        CIM_MostCurrentSnapshotInBranch fco = new CIM_MostCurrentSnapshotInBranch(client, namespace);
    ...
    public String getObjectName() {
        return CIM_MostCurrentSnapshotInBranch.CIM_CLASS_NAME;
    }

...
public class CIM_VirtualSystemSettingData extends CIM_SettingData {
    ...
    public static class PROPERTY_AUTOMATICRECOVERYACTION {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_Restart = new javax.cim.UnsignedInteger16(
                "3");
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_Revert_to_snapshot = new javax.cim.UnsignedInteger16(
                "4");

        /**
         * constant for value entry Revert to snapshot (corresponds to mapEntry 4 )
         */
        public final static String VALUE_ENTRY_Revert_to_snapshot = "Revert to snapshot";
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@3a103a10
        ...
        public final static javax.cim.UnsignedInteger16[] VALUE_MAP_ENTRIES = {
                VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_None, VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_Restart,
         ...
         * Value Map for the property AutomaticRecoveryAction   
         */
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_None, VALUE_ENTRY_Restart,
                VALUE_ENTRY_Revert_to_snapshot, VALUE_ENTRY_DMTF_Reserved };
        ...
        public final static String[] VALUE_ENTRIES_FOR_DISPLAY = { VALUE_ENTRY_None,
                VALUE_ENTRY_Restart, VALUE_ENTRY_Revert_to_snapshot };
    ...
    public static class PROPERTY_AUTOMATICSHUTDOWNACTION {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_Turn_Off = new javax.cim.UnsignedInteger16(
                "2");

        /**
         * constant for value entry Turn Off (corresponds to mapEntry 2 )
         */
        public final static String VALUE_ENTRY_Turn_Off = "Turn Off";

        /**
         * constant for value map entry 3
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_Save_state = new javax.cim.UnsignedInteger16(
                "3");

        /**
         * constant for value entry Save state (corresponds to mapEntry 3 )
         */
        public final static String VALUE_ENTRY_Save_state = "Save state";

        /**
         * constant for value map entry 4
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_Shutdown = new javax.cim.UnsignedInteger16(
                "4");

        /**
         * constant for value entry Shutdown (corresponds to mapEntry 4 )
         */
        public final static String VALUE_ENTRY_Shutdown = "Shutdown";
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@6e566e56
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
         ...
         * Value Map for the property AutomaticShutdownAction   
         */
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Turn_Off,
                VALUE_ENTRY_Save_state, VALUE_ENTRY_Shutdown, VALUE_ENTRY_DMTF_Reserved };
         ...
         * Value Map for the property AutomaticShutdownAction   
         */
        public final static String[] VALUE_ENTRIES_FOR_DISPLAY = { VALUE_ENTRY_Turn_Off,
                VALUE_ENTRY_Save_state, VALUE_ENTRY_Shutdown };
    ...
    public static class PROPERTY_AUTOMATICSTARTUPACTION {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_Restart_if_previously_active = new javax.cim.UnsignedInteger16(
                "3");

        /**
         * constant for value entry Restart if previously active (corresponds to mapEntry 3 )
         */
        public final static String VALUE_ENTRY_Restart_if_previously_active = "Restart if previously active";

        /**
         * constant for value map entry 4
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_Always_startup = new javax.cim.UnsignedInteger16(
                "4");

        /**
         * constant for value entry Always startup (corresponds to mapEntry 4 )
         */
        public final static String VALUE_ENTRY_Always_startup = "Always startup";
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@69246924
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
         ...
         * Value Map for the property AutomaticStartupAction   
         */
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_None,
                VALUE_ENTRY_Restart_if_previously_active, VALUE_ENTRY_Always_startup,
    ...
    public CIM_VirtualSystemSettingData(WBEMClient client, String namespace)
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("AutomaticRecoveryAction", new CIMProperty("AutomaticRecoveryAction",
                CIMDataType.UINT16_T, null));
        propertiesToCheck.put("AutomaticShutdownAction", new CIMProperty("AutomaticShutdownAction",
                CIMDataType.UINT16_T, null));
        propertiesToCheck.put("AutomaticStartupAction", new CIMProperty("AutomaticStartupAction",
                CIMDataType.UINT16_T, null));
        propertiesToCheck.put("AutomaticStartupActionDelay", new CIMProperty(
                "AutomaticStartupActionDelay", CIMDataType.DATETIME_T, null));
        propertiesToCheck.put("AutomaticStartupActionSequenceNumber", new CIMProperty(
                "AutomaticStartupActionSequenceNumber", CIMDataType.UINT16_T, null));
        propertiesToCheck.put("ConfigurationDataRoot", new CIMProperty("ConfigurationDataRoot",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("ConfigurationFile", new CIMProperty("ConfigurationFile",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("ConfigurationID", new CIMProperty("ConfigurationID",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("CreationTime", new CIMProperty("CreationTime",
                CIMDataType.DATETIME_T, null));
        propertiesToCheck.put("LogDataRoot", new CIMProperty("LogDataRoot", CIMDataType.STRING_T,
                null));
        propertiesToCheck.put("Notes", new CIMProperty("Notes", CIMDataType.STRING_ARRAY_T, null));
        propertiesToCheck.put("RecoveryFile", new CIMProperty("RecoveryFile", CIMDataType.STRING_T,
                null));
        propertiesToCheck.put("SnapshotDataRoot", new CIMProperty("SnapshotDataRoot",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("SuspendDataRoot", new CIMProperty("SuspendDataRoot",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("SwapFileDataRoot", new CIMProperty("SwapFileDataRoot",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("VirtualSystemIdentifier", new CIMProperty("VirtualSystemIdentifier",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("VirtualSystemType", new CIMProperty("VirtualSystemType",
                CIMDataType.STRING_T, null));
    ...
    public javax.cim.UnsignedInteger16 get_AutomaticRecoveryAction() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_AUTOMATICRECOVERYACTION.NAME
    ...
    public static CIMProperty create_AutomaticRecoveryAction(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_AutomaticRecoveryAction(
    ...
    public javax.cim.UnsignedInteger16 get_AutomaticShutdownAction() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_AUTOMATICSHUTDOWNACTION.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_AutomaticShutdownAction(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger16 newValue) throws WbemsmtException {
        CIM_VirtualSystemSettingData fco = new CIM_VirtualSystemSettingData(client, namespace);
    ...
    private static CIMProperty setPropertyValue_AutomaticShutdownAction(
            CIMProperty currentProperty, javax.cim.UnsignedInteger16 newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger16 get_AutomaticStartupAction() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_AUTOMATICSTARTUPACTION.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_AutomaticStartupAction(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger16 newValue) throws WbemsmtException {
        CIM_VirtualSystemSettingData fco = new CIM_VirtualSystemSettingData(client, namespace);
    ...
    private static CIMProperty setPropertyValue_AutomaticStartupAction(CIMProperty currentProperty,
    ...
    public javax.cim.CIMDateTime get_AutomaticStartupActionDelay() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_AUTOMATICSTARTUPACTIONDELAY.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_AutomaticStartupActionDelay(WBEMClient client,
    ...
    private static CIMProperty setPropertyValue_AutomaticStartupActionDelay(
    ...
    public javax.cim.UnsignedInteger16 get_AutomaticStartupActionSequenceNumber() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_AUTOMATICSTARTUPACTIONSEQUENCENUMBER.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_AutomaticStartupActionSequenceNumber(javax.cim.UnsignedInteger16 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_AUTOMATICSTARTUPACTIONSEQUENCENUMBER.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_AutomaticStartupActionSequenceNumber(currentProperty,
                    newValue));
            return true;
        }
        else {
    ...
    public static CIMProperty create_AutomaticStartupActionSequenceNumber(WBEMClient client,
    ...
    private static CIMProperty setPropertyValue_AutomaticStartupActionSequenceNumber(
            CIMProperty currentProperty, javax.cim.UnsignedInteger16 newValue) {
        Object setThis = null;
    ...
    public String get_ConfigurationDataRoot() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_CONFIGURATIONDATAROOT.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_ConfigurationDataRoot(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_ConfigurationDataRoot(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_ConfigurationID() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_CONFIGURATIONID.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_ConfigurationID(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        CIM_VirtualSystemSettingData fco = new CIM_VirtualSystemSettingData(client, namespace);
    ...
    private static CIMProperty setPropertyValue_ConfigurationID(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public javax.cim.CIMDateTime get_CreationTime() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_CREATIONTIME.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_CreationTime(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_CreationTime(CIMProperty currentProperty,
    ...
    public String get_LogDataRoot() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_LOGDATAROOT.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_LogDataRoot(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        CIM_VirtualSystemSettingData fco = new CIM_VirtualSystemSettingData(client, namespace);
    ...
    private static CIMProperty setPropertyValue_LogDataRoot(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String[] get_Notes() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_NOTES.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_Notes(WBEMClient client, String namespace, String[] newValue)
            throws WbemsmtException {
        CIM_VirtualSystemSettingData fco = new CIM_VirtualSystemSettingData(client, namespace);
    ...
    public String get_RecoveryFile() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_RECOVERYFILE.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_RecoveryFile(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        CIM_VirtualSystemSettingData fco = new CIM_VirtualSystemSettingData(client, namespace);
    ...
    private static CIMProperty setPropertyValue_RecoveryFile(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_SnapshotDataRoot() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SNAPSHOTDATAROOT.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_SnapshotDataRoot(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        CIM_VirtualSystemSettingData fco = new CIM_VirtualSystemSettingData(client, namespace);
    ...
    private static CIMProperty setPropertyValue_SnapshotDataRoot(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_SuspendDataRoot() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SUSPENDDATAROOT.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_SuspendDataRoot(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        CIM_VirtualSystemSettingData fco = new CIM_VirtualSystemSettingData(client, namespace);
    ...
    private static CIMProperty setPropertyValue_SuspendDataRoot(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_SwapFileDataRoot() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SWAPFILEDATAROOT.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_SwapFileDataRoot(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        CIM_VirtualSystemSettingData fco = new CIM_VirtualSystemSettingData(client, namespace);
    ...
    private static CIMProperty setPropertyValue_SwapFileDataRoot(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_VirtualSystemIdentifier() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_VIRTUALSYSTEMIDENTIFIER.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_VirtualSystemIdentifier(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        CIM_VirtualSystemSettingData fco = new CIM_VirtualSystemSettingData(client, namespace);
    ...
    private static CIMProperty setPropertyValue_VirtualSystemIdentifier(
    ...
    public String get_VirtualSystemType() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_VIRTUALSYSTEMTYPE.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_VirtualSystemType(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        CIM_VirtualSystemSettingData fco = new CIM_VirtualSystemSettingData(client, namespace);
    ...
    private static CIMProperty setPropertyValue_VirtualSystemType(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public java.util.List getAssociated_CIM_ResourceAllocationSettingData_CIM_VirtualSystemSettingDataComponents(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ResourceAllocationSettingData_CIM_VirtualSystemSettingDataComponents(
                cimClient, CIM_ASSOCIATOR_CLASS_NAME_CIM_VIRTUALSYSTEMSETTINGDATACOMPONENT,
                CIM_ResourceAllocationSettingData.CIM_CLASS_NAME, null, null, false, false, null);
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_VirtualSystemSettingDataHelper.findClass(cimClient,
                            cimInstance);
    ...
    public java.util.List getAssociated_CIM_ResourceAllocationSettingData_CIM_VirtualSystemSettingDataComponentNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ResourceAllocationSettingData_CIM_VirtualSystemSettingDataComponentNames(
                cimClient, true, CIM_ASSOCIATOR_CLASS_NAME_CIM_VIRTUALSYSTEMSETTINGDATACOMPONENT,
                CIM_ResourceAllocationSettingData.CIM_CLASS_NAME, null, null);
    }
    ...
    public java.util.List getAssociations_CIM_VirtualSystemSettingDataComponent(
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_VIRTUALSYSTEMSETTINGDATACOMPONENT, role,
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_VirtualSystemSettingDataComponentHelper.findClass(cimClient,
                            cimInstance);
    ...
    public java.util.List getAssociationNames_CIM_VirtualSystemSettingDataComponent(
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_VirtualSystemSettingDataComponent.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_LastAppliedSnapshots(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ComputerSystem_CIM_LastAppliedSnapshots(cimClient,
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_LastAppliedSnapshotNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ComputerSystem_CIM_LastAppliedSnapshotNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_LASTAPPLIEDSNAPSHOT,
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_MostCurrentSnapshotInBranchs(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ComputerSystem_CIM_MostCurrentSnapshotInBranchs(cimClient,
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_MostCurrentSnapshotInBranchs(
        ...
        return getAssociated_CIM_ComputerSystem_CIM_MostCurrentSnapshotInBranchs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_MOSTCURRENTSNAPSHOTINBRANCH, resultClass, role,
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_MostCurrentSnapshotInBranchNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ComputerSystem_CIM_MostCurrentSnapshotInBranchNames(cimClient,
                true, CIM_ASSOCIATOR_CLASS_NAME_CIM_MOSTCURRENTSNAPSHOTINBRANCH,
                CIM_ComputerSystem.CIM_CLASS_NAME, null, null);
    }
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_MostCurrentSnapshotInBranchNames(
        ...
        return getAssociated_CIM_ComputerSystem_CIM_MostCurrentSnapshotInBranchNames(cimClient,
                true, CIM_ASSOCIATOR_CLASS_NAME_CIM_MOSTCURRENTSNAPSHOTINBRANCH, resultClass, role,
                resultRole);
    }
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_SnapshotOfVirtualSystems(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ComputerSystem_CIM_SnapshotOfVirtualSystems(cimClient,
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_SnapshotOfVirtualSystemNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ComputerSystem_CIM_SnapshotOfVirtualSystemNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SNAPSHOTOFVIRTUALSYSTEM,
                CIM_ComputerSystem.CIM_CLASS_NAME, null, null);
    }

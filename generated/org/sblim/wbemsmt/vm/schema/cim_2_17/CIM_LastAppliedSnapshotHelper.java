...
public class CIM_LastAppliedSnapshotHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_LastAppliedSnapshot.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_LastAppliedSnapshot.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_LastAppliedSnapshot.");
                        resultArrayList.add(new CIM_LastAppliedSnapshot(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_LastAppliedSnapshot.");
                        resultArrayList.add(new CIM_LastAppliedSnapshot(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_LastAppliedSnapshot.");
                        resultArrayList.add(new CIM_LastAppliedSnapshot(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_LastAppliedSnapshot getInstance(WBEMClient client,
    ...
    public final static CIM_LastAppliedSnapshot getInstance(WBEMClient client, String namespace,
            CIM_VirtualSystemSettingData Antecedent, CIM_ComputerSystem Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_LastAppliedSnapshot.PROPERTY_ANTECEDENT_CIM_VIRTUALSYSTEMSETTINGDATA.NAME,
                new CIMDataType(CIM_VirtualSystemSettingData.CIM_CLASS_NAME), setThis, false,
                false, CIM_LastAppliedSnapshot.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_LastAppliedSnapshot.PROPERTY_DEPENDENT_CIM_COMPUTERSYSTEM.NAME,
     ...
     *
     */
    public final static CIM_LastAppliedSnapshot createInstance(WBEMClient client,
            CIM_LastAppliedSnapshot dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_LastAppliedSnapshot newDataInstance = CIM_LastAppliedSnapshotHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_LastAppliedSnapshot modifyInstance(WBEMClient client,
            CIM_LastAppliedSnapshot dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_LastAppliedSnapshot dataInstance2 = CIM_LastAppliedSnapshotHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_LastAppliedSnapshot dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_LastAppliedSnapshot.getPackages());
    }

/** 
  * CIM_AttachedElementHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_AttachedElement
  *    
  * 
  * generated Class
  * @see CIM_AttachedElement
  */
...
public class CIM_AttachedElementHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_AttachedElement or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_AttachedElement.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_AttachedElement.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_AttachedElement or the subclasses if deep == true
    */        
    public final static List<CIM_AttachedElement> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_AttachedElement> resultArrayList = new ArrayList<CIM_AttachedElement>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_AttachedElement.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_AttachedElement(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_AttachedElementHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_AttachedElement.");
                        resultArrayList.add(new CIM_AttachedElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_AttachedElement.");
                        resultArrayList.add(new CIM_AttachedElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_AttachedElement)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_AttachedElement.");
                        resultArrayList.add(new CIM_AttachedElement(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_AttachedElement getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_AttachedElement getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_AttachedElement dataInstance = null;
        Class<?> clazz = CIM_AttachedElementHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_AttachedElement)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_AttachedElement.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_AttachedElement(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_AttachedElement getInstance(WBEMClient client, String namespace
                                                       ,CIM_LogicalElement SystemElement
                                                       ,CIM_LogicalElement SameElement
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_AttachedElement.PROPERTY_SYSTEMELEMENT_CIM_LOGICALELEMENT.NAME,new CIMDataType(CIM_LogicalElement.CIM_CLASS_NAME),setThis,false,false,CIM_AttachedElement.CIM_CLASS_NAME); 
                   
                                 setThis = SameElement != null ? SameElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_AttachedElement.PROPERTY_SAMEELEMENT_CIM_LOGICALELEMENT.NAME,new CIMDataType(CIM_LogicalElement.CIM_CLASS_NAME),setThis,false,false,CIM_AttachedElement.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_AttachedElement.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_AttachedElement createInstance(WBEMClient client, CIM_AttachedElement dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_AttachedElement newDataInstance = CIM_AttachedElementHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_AttachedElement modifyInstance(WBEMClient client, CIM_AttachedElement dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_AttachedElement dataInstance2 = CIM_AttachedElementHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_AttachedElement dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_AttachedElement.getPackages());
    }

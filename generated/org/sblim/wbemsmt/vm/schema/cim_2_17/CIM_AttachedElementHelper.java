...
public class CIM_AttachedElementHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_AttachedElement.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_AttachedElement.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_AttachedElement.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_AttachedElement.");
                        resultArrayList.add(new CIM_AttachedElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_AttachedElement.");
                        resultArrayList.add(new CIM_AttachedElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_AttachedElement.");
                        resultArrayList.add(new CIM_AttachedElement(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_AttachedElement getInstance(WBEMClient client,
     ...
     */
    public final static CIM_AttachedElement getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_AttachedElement getInstance(WBEMClient client, String namespace,
            CIM_LogicalElement SystemElement, CIM_LogicalElement SameElement
        ...
        keyProperties[0] = new CIMProperty(
                CIM_AttachedElement.PROPERTY_SYSTEMELEMENT_CIM_LOGICALELEMENT.NAME,
                new CIMDataType(CIM_LogicalElement.CIM_CLASS_NAME), setThis, false, false,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_AttachedElement.PROPERTY_SAMEELEMENT_CIM_LOGICALELEMENT.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_AttachedElement createInstance(WBEMClient client,
            CIM_AttachedElement dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_AttachedElement newDataInstance = CIM_AttachedElementHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_AttachedElement modifyInstance(WBEMClient client,
            CIM_AttachedElement dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_AttachedElement dataInstance2 = CIM_AttachedElementHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_AttachedElement dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_AttachedElement.getPackages());
    }

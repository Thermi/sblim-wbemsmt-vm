...
public class CIM_ResourcePoolConfigurationServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ResourcePoolConfigurationService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ResourcePoolConfigurationService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_ResourcePoolConfigurationService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ResourcePoolConfigurationService(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ResourcePoolConfigurationServiceHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ResourcePoolConfigurationService.");
                        resultArrayList.add(new CIM_ResourcePoolConfigurationService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ResourcePoolConfigurationService.");
                        resultArrayList.add(new CIM_ResourcePoolConfigurationService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ResourcePoolConfigurationService.");
                        resultArrayList.add(new CIM_ResourcePoolConfigurationService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ResourcePoolConfigurationService getInstance(WBEMClient client,
    ...
    public final static CIM_ResourcePoolConfigurationService getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ResourcePoolConfigurationService.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_ResourcePoolConfigurationService.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_ResourcePoolConfigurationService.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_ResourcePoolConfigurationService.CIM_CLASS_NAME);
        ...
        keyProperties[2] = new CIMProperty(
                CIM_ResourcePoolConfigurationService.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_ResourcePoolConfigurationService.CIM_CLASS_NAME);
        ...
        keyProperties[3] = new CIMProperty(
                CIM_ResourcePoolConfigurationService.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_ResourcePoolConfigurationService.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ResourcePoolConfigurationService createInstance(WBEMClient client,
            CIM_ResourcePoolConfigurationService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ResourcePoolConfigurationService newDataInstance = CIM_ResourcePoolConfigurationServiceHelper
     ...
     */
    public final static CIM_ResourcePoolConfigurationService modifyInstance(WBEMClient client,
            CIM_ResourcePoolConfigurationService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ResourcePoolConfigurationService dataInstance2 = CIM_ResourcePoolConfigurationServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ResourcePoolConfigurationService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ResourcePoolConfigurationService.getPackages());
    }

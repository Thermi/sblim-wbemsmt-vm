...
public class CIM_ResourcePoolConfigurationCapabilitiesHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                CIM_ResourcePoolConfigurationCapabilities.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ResourcePoolConfigurationCapabilities.CIM_CLASS_NAME
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_ResourcePoolConfigurationCapabilities.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ResourcePoolConfigurationCapabilities(
                                cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ResourcePoolConfigurationCapabilitiesHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ResourcePoolConfigurationCapabilities.");
                        resultArrayList.add(new CIM_ResourcePoolConfigurationCapabilities(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ResourcePoolConfigurationCapabilities.");
                        resultArrayList.add(new CIM_ResourcePoolConfigurationCapabilities(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ResourcePoolConfigurationCapabilities.");
                        resultArrayList.add(new CIM_ResourcePoolConfigurationCapabilities(
                                cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ResourcePoolConfigurationCapabilities getInstance(WBEMClient client,
    ...
    public final static CIM_ResourcePoolConfigurationCapabilities getInstance(WBEMClient client,
        ...
        Class clazz = CIM_ResourcePoolConfigurationCapabilitiesHelper
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ResourcePoolConfigurationCapabilities) cons
                        .newInstance(actargs);
            }
            catch (Exception e) {
                System.err
    ...
    public final static CIM_ResourcePoolConfigurationCapabilities getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ResourcePoolConfigurationCapabilities.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static CIM_ResourcePoolConfigurationCapabilities createInstance(WBEMClient client,
            CIM_ResourcePoolConfigurationCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ResourcePoolConfigurationCapabilities newDataInstance = CIM_ResourcePoolConfigurationCapabilitiesHelper
     ...
     */
    public final static CIM_ResourcePoolConfigurationCapabilities modifyInstance(WBEMClient client,
            CIM_ResourcePoolConfigurationCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ResourcePoolConfigurationCapabilities dataInstance2 = CIM_ResourcePoolConfigurationCapabilitiesHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ResourcePoolConfigurationCapabilities dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ResourcePoolConfigurationCapabilities.getPackages());
    }

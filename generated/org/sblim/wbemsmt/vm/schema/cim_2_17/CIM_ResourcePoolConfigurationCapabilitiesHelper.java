/** 
  * CIM_ResourcePoolConfigurationCapabilitiesHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_ResourcePoolConfigurationCapabilities
  *    
  * 
  * generated Class
  * @see CIM_ResourcePoolConfigurationCapabilities
  */
...
public class CIM_ResourcePoolConfigurationCapabilitiesHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ResourcePoolConfigurationCapabilities or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ResourcePoolConfigurationCapabilities.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ResourcePoolConfigurationCapabilities.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ResourcePoolConfigurationCapabilities or the subclasses if deep == true
    */        
    public final static List<CIM_ResourcePoolConfigurationCapabilities> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ResourcePoolConfigurationCapabilities> resultArrayList = new ArrayList<CIM_ResourcePoolConfigurationCapabilities>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ResourcePoolConfigurationCapabilities.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ResourcePoolConfigurationCapabilities(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ResourcePoolConfigurationCapabilitiesHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ResourcePoolConfigurationCapabilities.");
                        resultArrayList.add(new CIM_ResourcePoolConfigurationCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ResourcePoolConfigurationCapabilities.");
                        resultArrayList.add(new CIM_ResourcePoolConfigurationCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ResourcePoolConfigurationCapabilities)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ResourcePoolConfigurationCapabilities.");
                        resultArrayList.add(new CIM_ResourcePoolConfigurationCapabilities(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ResourcePoolConfigurationCapabilities getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ResourcePoolConfigurationCapabilities getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ResourcePoolConfigurationCapabilities dataInstance = null;
        Class<?> clazz = CIM_ResourcePoolConfigurationCapabilitiesHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ResourcePoolConfigurationCapabilities)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ResourcePoolConfigurationCapabilities.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ResourcePoolConfigurationCapabilities(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_ResourcePoolConfigurationCapabilities getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ResourcePoolConfigurationCapabilities.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_ResourcePoolConfigurationCapabilities.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ResourcePoolConfigurationCapabilities.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ResourcePoolConfigurationCapabilities createInstance(WBEMClient client, CIM_ResourcePoolConfigurationCapabilities dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ResourcePoolConfigurationCapabilities newDataInstance = CIM_ResourcePoolConfigurationCapabilitiesHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ResourcePoolConfigurationCapabilities modifyInstance(WBEMClient client, CIM_ResourcePoolConfigurationCapabilities dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ResourcePoolConfigurationCapabilities dataInstance2 = CIM_ResourcePoolConfigurationCapabilitiesHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ResourcePoolConfigurationCapabilities dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ResourcePoolConfigurationCapabilities.getPackages());
    }

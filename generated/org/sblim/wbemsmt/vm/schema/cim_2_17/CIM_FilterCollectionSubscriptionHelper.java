...
public class CIM_FilterCollectionSubscriptionHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_FilterCollectionSubscription.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_FilterCollectionSubscription.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_FilterCollectionSubscriptionHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_FilterCollectionSubscription.");
                        resultArrayList.add(new CIM_FilterCollectionSubscription(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_FilterCollectionSubscription.");
                        resultArrayList.add(new CIM_FilterCollectionSubscription(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_FilterCollectionSubscription.");
                        resultArrayList.add(new CIM_FilterCollectionSubscription(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_FilterCollectionSubscription getInstance(WBEMClient client,
     ...
     */
    public final static CIM_FilterCollectionSubscription getInstance(WBEMClient client,
            String namespace, CIM_FilterCollection Filter, CIM_ListenerDestination Handler
        ...
        keyProperties[0] = new CIMProperty(
                CIM_FilterCollectionSubscription.PROPERTY_FILTER_CIM_FILTERCOLLECTION.NAME,
                new CIMDataType(CIM_FilterCollection.CIM_CLASS_NAME), setThis, false, false,
                CIM_FilterCollectionSubscription.CIM_CLASS_NAME);

        setThis = Handler != null ? Handler.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_FilterCollectionSubscription.PROPERTY_HANDLER_CIM_LISTENERDESTINATION.NAME,
     ...
     *
     */
    public final static CIM_FilterCollectionSubscription createInstance(WBEMClient client,
            CIM_FilterCollectionSubscription dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_FilterCollectionSubscription newDataInstance = CIM_FilterCollectionSubscriptionHelper
     ...
     */
    public final static CIM_FilterCollectionSubscription modifyInstance(WBEMClient client,
            CIM_FilterCollectionSubscription dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_FilterCollectionSubscription dataInstance2 = CIM_FilterCollectionSubscriptionHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_FilterCollectionSubscription dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_FilterCollectionSubscription.getPackages());
    }

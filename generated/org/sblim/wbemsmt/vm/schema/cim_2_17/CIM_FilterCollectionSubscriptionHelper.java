/** 
  * CIM_FilterCollectionSubscriptionHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_FilterCollectionSubscription
  *    
  * 
  * generated Class
  * @see CIM_FilterCollectionSubscription
  */
...
public class CIM_FilterCollectionSubscriptionHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_FilterCollectionSubscription or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_FilterCollectionSubscription.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_FilterCollectionSubscription.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_FilterCollectionSubscription or the subclasses if deep == true
    */        
    public final static List<CIM_FilterCollectionSubscription> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_FilterCollectionSubscription> resultArrayList = new ArrayList<CIM_FilterCollectionSubscription>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_FilterCollectionSubscription.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_FilterCollectionSubscription(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_FilterCollectionSubscriptionHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_FilterCollectionSubscription.");
                        resultArrayList.add(new CIM_FilterCollectionSubscription(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_FilterCollectionSubscription.");
                        resultArrayList.add(new CIM_FilterCollectionSubscription(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_FilterCollectionSubscription)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_FilterCollectionSubscription.");
                        resultArrayList.add(new CIM_FilterCollectionSubscription(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_FilterCollectionSubscription getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_FilterCollectionSubscription getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_FilterCollectionSubscription dataInstance = null;
        Class<?> clazz = CIM_FilterCollectionSubscriptionHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_FilterCollectionSubscription)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_FilterCollectionSubscription.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_FilterCollectionSubscription(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_FilterCollectionSubscription getInstance(WBEMClient client, String namespace
                                                       ,CIM_FilterCollection Filter
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_FilterCollectionSubscription.PROPERTY_FILTER_CIM_FILTERCOLLECTION.NAME,new CIMDataType(CIM_FilterCollection.CIM_CLASS_NAME),setThis,false,false,CIM_FilterCollectionSubscription.CIM_CLASS_NAME); 
                   
                                 setThis = Handler != null ? Handler.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_FilterCollectionSubscription.PROPERTY_HANDLER_CIM_LISTENERDESTINATION.NAME,new CIMDataType(CIM_ListenerDestination.CIM_CLASS_NAME),setThis,false,false,CIM_FilterCollectionSubscription.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_FilterCollectionSubscription.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_FilterCollectionSubscription createInstance(WBEMClient client, CIM_FilterCollectionSubscription dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_FilterCollectionSubscription newDataInstance = CIM_FilterCollectionSubscriptionHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_FilterCollectionSubscription modifyInstance(WBEMClient client, CIM_FilterCollectionSubscription dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_FilterCollectionSubscription dataInstance2 = CIM_FilterCollectionSubscriptionHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_FilterCollectionSubscription dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_FilterCollectionSubscription.getPackages());
    }

...
public class CIM_ImportedShareHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ImportedShare.CIM_CLASS_NAME,
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_ImportedShare.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_ImportedShare.");
                        resultArrayList.add(new CIM_ImportedShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ImportedShare.");
                        resultArrayList.add(new CIM_ImportedShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ImportedShare.");
                        resultArrayList.add(new CIM_ImportedShare(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ImportedShare getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_ImportedShare getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_ImportedShare getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ImportedShare.PROPERTY_SYSTEMELEMENT_CIM_LOGICALELEMENT.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ImportedShare.PROPERTY_SAMEELEMENT_CIM_LOGICALELEMENT.NAME, new CIMDataType(
                        CIM_LogicalElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_ImportedShare.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ImportedShare createInstance(WBEMClient client,
            CIM_ImportedShare dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ImportedShare newDataInstance = CIM_ImportedShareHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ImportedShare modifyInstance(WBEMClient client,
            CIM_ImportedShare dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ImportedShare dataInstance2 = CIM_ImportedShareHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ImportedShare dataInstance)
            throws WbemsmtException {

/** 
  ...
  * 
  * Description: Helper class for CIM_ImportedShare
  *    
  * 
  * generated Class
  * @see CIM_ImportedShare
  */
...
public class CIM_ImportedShareHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ImportedShare or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ImportedShare.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ImportedShare.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ImportedShare or the subclasses if deep == true
    */        
    public final static List<CIM_ImportedShare> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ImportedShare> resultArrayList = new ArrayList<CIM_ImportedShare>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ImportedShare.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ImportedShare(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ImportedShareHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ImportedShare.");
                        resultArrayList.add(new CIM_ImportedShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ImportedShare.");
                        resultArrayList.add(new CIM_ImportedShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ImportedShare)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ImportedShare.");
                        resultArrayList.add(new CIM_ImportedShare(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ImportedShare getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ImportedShare getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ImportedShare dataInstance = null;
        Class<?> clazz = CIM_ImportedShareHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ImportedShare)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ImportedShare.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ImportedShare(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_ImportedShare getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ImportedShare.PROPERTY_SYSTEMELEMENT_CIM_LOGICALELEMENT.NAME,new CIMDataType(CIM_LogicalElement.CIM_CLASS_NAME),setThis,false,false,CIM_ImportedShare.CIM_CLASS_NAME); 
                   
                                 setThis = SameElement != null ? SameElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_ImportedShare.PROPERTY_SAMEELEMENT_CIM_LOGICALELEMENT.NAME,new CIMDataType(CIM_LogicalElement.CIM_CLASS_NAME),setThis,false,false,CIM_ImportedShare.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ImportedShare.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ImportedShare createInstance(WBEMClient client, CIM_ImportedShare dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ImportedShare newDataInstance = CIM_ImportedShareHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ImportedShare modifyInstance(WBEMClient client, CIM_ImportedShare dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ImportedShare dataInstance2 = CIM_ImportedShareHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ImportedShare dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ImportedShare.getPackages());
    }

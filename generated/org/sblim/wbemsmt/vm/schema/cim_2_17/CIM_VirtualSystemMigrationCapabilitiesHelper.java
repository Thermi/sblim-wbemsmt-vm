...
public class CIM_VirtualSystemMigrationCapabilitiesHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                CIM_VirtualSystemMigrationCapabilities.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_VirtualSystemMigrationCapabilities.CIM_CLASS_NAME
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_VirtualSystemMigrationCapabilities.CIM_CLASS_NAME)) {
                        resultArrayList
                                .add(new CIM_VirtualSystemMigrationCapabilities(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_VirtualSystemMigrationCapabilitiesHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_VirtualSystemMigrationCapabilities.");
                        resultArrayList
                                .add(new CIM_VirtualSystemMigrationCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_VirtualSystemMigrationCapabilities.");
                        resultArrayList
                                .add(new CIM_VirtualSystemMigrationCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_VirtualSystemMigrationCapabilities.");
                        resultArrayList
                                .add(new CIM_VirtualSystemMigrationCapabilities(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_VirtualSystemMigrationCapabilities getInstance(WBEMClient client,
    ...
    public final static CIM_VirtualSystemMigrationCapabilities getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_VirtualSystemMigrationCapabilities.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static CIM_VirtualSystemMigrationCapabilities createInstance(WBEMClient client,
            CIM_VirtualSystemMigrationCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_VirtualSystemMigrationCapabilities newDataInstance = CIM_VirtualSystemMigrationCapabilitiesHelper
     ...
     */
    public final static CIM_VirtualSystemMigrationCapabilities modifyInstance(WBEMClient client,
            CIM_VirtualSystemMigrationCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_VirtualSystemMigrationCapabilities dataInstance2 = CIM_VirtualSystemMigrationCapabilitiesHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_VirtualSystemMigrationCapabilities dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_VirtualSystemMigrationCapabilities.getPackages());
    }

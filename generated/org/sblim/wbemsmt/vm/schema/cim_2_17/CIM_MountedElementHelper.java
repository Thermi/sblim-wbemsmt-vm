...
public class CIM_MountedElementHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_MountedElement.CIM_CLASS_NAME,
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_MountedElement.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_MountedElement.");
                        resultArrayList.add(new CIM_MountedElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_MountedElement.");
                        resultArrayList.add(new CIM_MountedElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_MountedElement.");
                        resultArrayList.add(new CIM_MountedElement(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_MountedElement getInstance(WBEMClient client,
     ...
     */
    public final static CIM_MountedElement getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_MountedElement getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_MountedElement.PROPERTY_SYSTEMELEMENT_CIM_LOGICALELEMENT.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_MountedElement.PROPERTY_SAMEELEMENT_CIM_LOGICALELEMENT.NAME, new CIMDataType(
                        CIM_LogicalElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_MountedElement.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_MountedElement createInstance(WBEMClient client,
            CIM_MountedElement dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_MountedElement newDataInstance = CIM_MountedElementHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_MountedElement modifyInstance(WBEMClient client,
            CIM_MountedElement dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_MountedElement dataInstance2 = CIM_MountedElementHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_MountedElement dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_MountedElement.getPackages());
    }

/** 
  ...
  * 
  * Description: Helper class for CIM_MountedElement
  *    
  * 
  * generated Class
  * @see CIM_MountedElement
  */
...
public class CIM_MountedElementHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_MountedElement or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_MountedElement.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_MountedElement.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_MountedElement or the subclasses if deep == true
    */        
    public final static List<CIM_MountedElement> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_MountedElement> resultArrayList = new ArrayList<CIM_MountedElement>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_MountedElement.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_MountedElement(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_MountedElementHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_MountedElement.");
                        resultArrayList.add(new CIM_MountedElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_MountedElement.");
                        resultArrayList.add(new CIM_MountedElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_MountedElement)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_MountedElement.");
                        resultArrayList.add(new CIM_MountedElement(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_MountedElement getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_MountedElement getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_MountedElement dataInstance = null;
        Class<?> clazz = CIM_MountedElementHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_MountedElement)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_MountedElement.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_MountedElement(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_MountedElement getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_MountedElement.PROPERTY_SYSTEMELEMENT_CIM_LOGICALELEMENT.NAME,new CIMDataType(CIM_LogicalElement.CIM_CLASS_NAME),setThis,false,false,CIM_MountedElement.CIM_CLASS_NAME); 
                   
                                 setThis = SameElement != null ? SameElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_MountedElement.PROPERTY_SAMEELEMENT_CIM_LOGICALELEMENT.NAME,new CIMDataType(CIM_LogicalElement.CIM_CLASS_NAME),setThis,false,false,CIM_MountedElement.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_MountedElement.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_MountedElement createInstance(WBEMClient client, CIM_MountedElement dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_MountedElement newDataInstance = CIM_MountedElementHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_MountedElement modifyInstance(WBEMClient client, CIM_MountedElement dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_MountedElement dataInstance2 = CIM_MountedElementHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_MountedElement dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_MountedElement.getPackages());
    }

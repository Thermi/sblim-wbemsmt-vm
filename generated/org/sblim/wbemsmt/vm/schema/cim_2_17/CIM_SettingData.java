   ...
   public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;
    ...
    public static class PROPERTY_CHANGEABLETYPE
    {
       ...
       public final static String NAME = "ChangeableType";                  
          ...
          public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_0_FOR_VALUE_ENTRY_Not_Changeable___Persistent 
                              = new javax.cim.UnsignedInteger16("0");
	          	
                       /**
              * constant for value entry Not Changeable - Persistent (corresponds to mapEntry 0 )
              */
             public final static String VALUE_ENTRY_Not_Changeable___Persistent 
          ...
          public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_1_FOR_VALUE_ENTRY_Changeable___Transient 
                              = new javax.cim.UnsignedInteger16("1");
	          	
                       /**
              * constant for value entry Changeable - Transient (corresponds to mapEntry 1 )
              */
             public final static String VALUE_ENTRY_Changeable___Transient 
          ...
          public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_Changeable___Persistent 
                              = new javax.cim.UnsignedInteger16("2");
	          	
                       /**
              * constant for value entry Changeable - Persistent (corresponds to mapEntry 2 )
              */
             public final static String VALUE_ENTRY_Changeable___Persistent 
          ...
          public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_Not_Changeable___Transient 
                              = new javax.cim.UnsignedInteger16("3");
	          	
                       /**
              * constant for value entry Not Changeable - Transient (corresponds to mapEntry 3 )
              */
             public final static String VALUE_ENTRY_Not_Changeable___Transient 
      ...
      public final static javax.cim.UnsignedInteger16[] VALUE_MAP_ENTRIES = { 
       ...
       public final static String[] VALUE_ENTRIES = { 
                                                   VALUE_ENTRY_Not_Changeable___Persistent
                                                                 ,  VALUE_ENTRY_Changeable___Transient
                                                                 ,  VALUE_ENTRY_Changeable___Persistent
...
//**********************************************************************
   ...
   {
              propertiesToCheck.put("ChangeableType",new CIMProperty("ChangeableType",CIMDataType.UINT16_T,null));
              propertiesToCheck.put("ConfigurationName",new CIMProperty("ConfigurationName",CIMDataType.STRING_T,null));
...
//**********************************************************************
   ...
   public javax.cim.UnsignedInteger16 get_ChangeableType()    {
       ...
       if (currentProperty == null || currentProperty.getValue() == null) {
           logger.warning("Property " + PROPERTY_CHANGEABLETYPE.NAME + " was not found in instance " + getCimObjectPath());
           return null;
       }
   ...
   public boolean set_ChangeableType(javax.cim.UnsignedInteger16 newValue)
   {
    ...
    public static CIMProperty create_ChangeableType(WBEMClient client, String namespace, javax.cim.UnsignedInteger16 newValue) throws WbemsmtException {
        ...
        if (property != null)
        {
       	 ...
       	 {
       	 		   logger.warning("Property " + PROPERTY_CHANGEABLETYPE.NAME + " was not found in instance " + fco.getCimObjectPath());
       	 }
        return property;
    }
   ...
   private static CIMProperty setPropertyValue_ChangeableType(CIMProperty currentProperty, javax.cim.UnsignedInteger16 newValue)
   {
        Object setThis = null;        
   ...
   public String get_ConfigurationName()    {
       ...
       if (currentProperty == null || currentProperty.getValue() == null) {
           logger.warning("Property " + PROPERTY_CONFIGURATIONNAME.NAME + " was not found in instance " + getCimObjectPath());
           return null;
       }
   ...
   public boolean set_ConfigurationName(String newValue)
   {
    ...
    public static CIMProperty create_ConfigurationName(WBEMClient client, String namespace, String newValue) throws WbemsmtException {
        CIM_SettingData fco = new CIM_SettingData(client,namespace);
        ...
        if (property != null)
        {
       	 ...
       	 {
       	 		   logger.warning("Property " + PROPERTY_CONFIGURATIONNAME.NAME + " was not found in instance " + fco.getCimObjectPath());
       	 }
        return property;
    }
   ...
   private static CIMProperty setPropertyValue_ConfigurationName(CIMProperty currentProperty, String newValue)
   {
        Object setThis = null;        
...
//**********************************************************************
     ...
     **/
     ...
     public java.util.List<CIM_ManagedElement> getAssociated_CIM_ManagedElement_CIM_SettingsDefineStates(WBEMClient cimClient) throws WbemsmtException {
     
     	   return getAssociated_CIM_ManagedElement_CIM_SettingsDefineStates(
     	                cimClient,
     ...
     **/
     ...
     public java.util.List<CIM_ManagedElement> getAssociated_CIM_ManagedElement_CIM_SettingsDefineStates(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
     ...
     **/
     ...
     public java.util.List<CIM_ManagedElement> getAssociated_CIM_ManagedElement_CIM_SettingsDefineStates(WBEMClient cimClient, String associationClass, String resultClass, String role, String resultRole, boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_ManagedElement_CIM_SettingsDefineStateNames(WBEMClient cimClient) throws WbemsmtException {
    
    	    return getAssociated_CIM_ManagedElement_CIM_SettingsDefineStateNames (
    	                             cimClient,
    	                             true,
    	                             CIM_ASSOCIATOR_CLASS_NAME_CIM_SETTINGSDEFINESTATE,
    	                             CIM_ManagedElement.CIM_CLASS_NAME,
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_ManagedElement_CIM_SettingsDefineStateNames(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_ManagedElement_CIM_SettingsDefineStateNames(WBEMClient cimClient,boolean deep,String associationClass, String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
     ...
     **/
     ...
     public java.util.List<CIM_Capabilities> getAssociated_CIM_Capabilities_CIM_SettingsDefineCapabilitiess(WBEMClient cimClient) throws WbemsmtException {
     
     	   return getAssociated_CIM_Capabilities_CIM_SettingsDefineCapabilitiess(
     	                cimClient,
     ...
     **/
     ...
     public java.util.List<CIM_Capabilities> getAssociated_CIM_Capabilities_CIM_SettingsDefineCapabilitiess(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_Capabilities_CIM_SettingsDefineCapabilitiesNames(WBEMClient cimClient) throws WbemsmtException {
    
    	    return getAssociated_CIM_Capabilities_CIM_SettingsDefineCapabilitiesNames (
    	                             cimClient,
    	                             true,
    	                             CIM_ASSOCIATOR_CLASS_NAME_CIM_SETTINGSDEFINECAPABILITIES,
    	                             CIM_Capabilities.CIM_CLASS_NAME,
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_Capabilities_CIM_SettingsDefineCapabilitiesNames(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_Capabilities_CIM_SettingsDefineCapabilitiesNames(WBEMClient cimClient,boolean deep,String associationClass, String resultClass, String role, String resultRole) throws WbemsmtException {

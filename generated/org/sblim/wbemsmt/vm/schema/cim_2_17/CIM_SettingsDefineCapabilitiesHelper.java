/** 
  * CIM_SettingsDefineCapabilitiesHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_SettingsDefineCapabilities
  *    
  * 
  * generated Class
  * @see CIM_SettingsDefineCapabilities
  */
...
public class CIM_SettingsDefineCapabilitiesHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_SettingsDefineCapabilities or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_SettingsDefineCapabilities.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_SettingsDefineCapabilities.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_SettingsDefineCapabilities or the subclasses if deep == true
    */        
    public final static List<CIM_SettingsDefineCapabilities> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_SettingsDefineCapabilities> resultArrayList = new ArrayList<CIM_SettingsDefineCapabilities>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_SettingsDefineCapabilities.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SettingsDefineCapabilities(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_SettingsDefineCapabilitiesHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SettingsDefineCapabilities.");
                        resultArrayList.add(new CIM_SettingsDefineCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SettingsDefineCapabilities.");
                        resultArrayList.add(new CIM_SettingsDefineCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_SettingsDefineCapabilities)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SettingsDefineCapabilities.");
                        resultArrayList.add(new CIM_SettingsDefineCapabilities(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_SettingsDefineCapabilities getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_SettingsDefineCapabilities getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_SettingsDefineCapabilities dataInstance = null;
        Class<?> clazz = CIM_SettingsDefineCapabilitiesHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_SettingsDefineCapabilities)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SettingsDefineCapabilities.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_SettingsDefineCapabilities(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_SettingsDefineCapabilities getInstance(WBEMClient client, String namespace
                                                       ,CIM_Capabilities GroupComponent
                                                       ,CIM_SettingData PartComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_SettingsDefineCapabilities.PROPERTY_GROUPCOMPONENT_CIM_CAPABILITIES.NAME,new CIMDataType(CIM_Capabilities.CIM_CLASS_NAME),setThis,false,false,CIM_SettingsDefineCapabilities.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_SettingsDefineCapabilities.PROPERTY_PARTCOMPONENT_CIM_SETTINGDATA.NAME,new CIMDataType(CIM_SettingData.CIM_CLASS_NAME),setThis,false,false,CIM_SettingsDefineCapabilities.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_SettingsDefineCapabilities.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_SettingsDefineCapabilities createInstance(WBEMClient client, CIM_SettingsDefineCapabilities dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_SettingsDefineCapabilities newDataInstance = CIM_SettingsDefineCapabilitiesHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_SettingsDefineCapabilities modifyInstance(WBEMClient client, CIM_SettingsDefineCapabilities dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_SettingsDefineCapabilities dataInstance2 = CIM_SettingsDefineCapabilitiesHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_SettingsDefineCapabilities dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_SettingsDefineCapabilities.getPackages());
    }

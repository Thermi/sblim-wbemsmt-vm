...
public class CIM_SettingsDefineCapabilitiesHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SettingsDefineCapabilities.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SettingsDefineCapabilities.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_SettingsDefineCapabilitiesHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SettingsDefineCapabilities.");
                        resultArrayList.add(new CIM_SettingsDefineCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SettingsDefineCapabilities.");
                        resultArrayList.add(new CIM_SettingsDefineCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SettingsDefineCapabilities.");
                        resultArrayList.add(new CIM_SettingsDefineCapabilities(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SettingsDefineCapabilities getInstance(WBEMClient client,
     ...
     */
    public final static CIM_SettingsDefineCapabilities getInstance(WBEMClient client,
            String namespace, CIM_Capabilities GroupComponent, CIM_SettingData PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SettingsDefineCapabilities.PROPERTY_GROUPCOMPONENT_CIM_CAPABILITIES.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SettingsDefineCapabilities.PROPERTY_PARTCOMPONENT_CIM_SETTINGDATA.NAME,
                new CIMDataType(CIM_SettingData.CIM_CLASS_NAME), setThis, false, false,
                CIM_SettingsDefineCapabilities.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SettingsDefineCapabilities createInstance(WBEMClient client,
            CIM_SettingsDefineCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SettingsDefineCapabilities newDataInstance = CIM_SettingsDefineCapabilitiesHelper
     ...
     */
    public final static CIM_SettingsDefineCapabilities modifyInstance(WBEMClient client,
            CIM_SettingsDefineCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SettingsDefineCapabilities dataInstance2 = CIM_SettingsDefineCapabilitiesHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_SettingsDefineCapabilities dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SettingsDefineCapabilities.getPackages());
    }

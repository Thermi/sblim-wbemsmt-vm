/** 
  ...
  * 
  * Description: Helper class for CIM_BaseMetricValue
  *    
  * 
  * generated Class
  * @see CIM_BaseMetricValue
  */
...
public class CIM_BaseMetricValueHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_BaseMetricValue or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_BaseMetricValue.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_BaseMetricValue.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_BaseMetricValue or the subclasses if deep == true
    */        
    public final static List<CIM_BaseMetricValue> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_BaseMetricValue> resultArrayList = new ArrayList<CIM_BaseMetricValue>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_BaseMetricValue.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_BaseMetricValue(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_BaseMetricValueHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_BaseMetricValue)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_BaseMetricValue getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_BaseMetricValue getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_BaseMetricValue)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_BaseMetricValue.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_BaseMetricValue(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_BaseMetricValue getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_BaseMetricValue.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_BaseMetricValue.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_BaseMetricValue.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_BaseMetricValue createInstance(WBEMClient client, CIM_BaseMetricValue dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_BaseMetricValue newDataInstance = CIM_BaseMetricValueHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_BaseMetricValue modifyInstance(WBEMClient client, CIM_BaseMetricValue dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_BaseMetricValue dataInstance2 = CIM_BaseMetricValueHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_BaseMetricValue dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_BaseMetricValue.getPackages());
    }

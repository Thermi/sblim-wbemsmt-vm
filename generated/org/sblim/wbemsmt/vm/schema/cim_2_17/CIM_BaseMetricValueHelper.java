...
public class CIM_BaseMetricValueHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_BaseMetricValue.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_BaseMetricValue.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_BaseMetricValue.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_BaseMetricValue.");
                        resultArrayList.add(new CIM_BaseMetricValue(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_BaseMetricValue.");
                        resultArrayList.add(new CIM_BaseMetricValue(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_BaseMetricValue.");
                        resultArrayList.add(new CIM_BaseMetricValue(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_BaseMetricValue getInstance(WBEMClient client,
     ...
     */
    public final static CIM_BaseMetricValue getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_BaseMetricValue getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_BaseMetricValue.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_BaseMetricValue.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_BaseMetricValue createInstance(WBEMClient client,
            CIM_BaseMetricValue dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_BaseMetricValue newDataInstance = CIM_BaseMetricValueHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_BaseMetricValue modifyInstance(WBEMClient client,
            CIM_BaseMetricValue dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_BaseMetricValue dataInstance2 = CIM_BaseMetricValueHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_BaseMetricValue dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_BaseMetricValue.getPackages());
    }

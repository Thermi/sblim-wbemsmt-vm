...
public class CIM_ListenerDestinationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     */
    public final static CIM_ListenerDestination createInstance(WBEMClient client,
            CIM_ListenerDestination dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ListenerDestination newDataInstance = CIM_ListenerDestinationHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ListenerDestination modifyInstance(WBEMClient client,
            CIM_ListenerDestination dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ListenerDestination dataInstance2 = CIM_ListenerDestinationHelper.getInstance(

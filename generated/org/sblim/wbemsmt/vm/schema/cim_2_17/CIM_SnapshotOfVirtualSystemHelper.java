/** 
  * CIM_SnapshotOfVirtualSystemHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_SnapshotOfVirtualSystem
  *    
  * 
  * generated Class
  * @see CIM_SnapshotOfVirtualSystem
  */
...
public class CIM_SnapshotOfVirtualSystemHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_SnapshotOfVirtualSystem or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_SnapshotOfVirtualSystem.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_SnapshotOfVirtualSystem.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_SnapshotOfVirtualSystem or the subclasses if deep == true
    */        
    public final static List<CIM_SnapshotOfVirtualSystem> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_SnapshotOfVirtualSystem> resultArrayList = new ArrayList<CIM_SnapshotOfVirtualSystem>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_SnapshotOfVirtualSystem.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SnapshotOfVirtualSystem(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_SnapshotOfVirtualSystemHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SnapshotOfVirtualSystem.");
                        resultArrayList.add(new CIM_SnapshotOfVirtualSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SnapshotOfVirtualSystem.");
                        resultArrayList.add(new CIM_SnapshotOfVirtualSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_SnapshotOfVirtualSystem)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SnapshotOfVirtualSystem.");
                        resultArrayList.add(new CIM_SnapshotOfVirtualSystem(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_SnapshotOfVirtualSystem getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_SnapshotOfVirtualSystem getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_SnapshotOfVirtualSystem dataInstance = null;
        Class<?> clazz = CIM_SnapshotOfVirtualSystemHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_SnapshotOfVirtualSystem)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SnapshotOfVirtualSystem.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_SnapshotOfVirtualSystem(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_SnapshotOfVirtualSystem getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_SnapshotOfVirtualSystem.PROPERTY_ANTECEDENT_CIM_COMPUTERSYSTEM.NAME,new CIMDataType(CIM_ComputerSystem.CIM_CLASS_NAME),setThis,false,false,CIM_SnapshotOfVirtualSystem.CIM_CLASS_NAME); 
                   
                                 setThis = Dependent != null ? Dependent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_SnapshotOfVirtualSystem.PROPERTY_DEPENDENT_CIM_VIRTUALSYSTEMSETTINGDATA.NAME,new CIMDataType(CIM_VirtualSystemSettingData.CIM_CLASS_NAME),setThis,false,false,CIM_SnapshotOfVirtualSystem.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_SnapshotOfVirtualSystem.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_SnapshotOfVirtualSystem createInstance(WBEMClient client, CIM_SnapshotOfVirtualSystem dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_SnapshotOfVirtualSystem newDataInstance = CIM_SnapshotOfVirtualSystemHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_SnapshotOfVirtualSystem modifyInstance(WBEMClient client, CIM_SnapshotOfVirtualSystem dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_SnapshotOfVirtualSystem dataInstance2 = CIM_SnapshotOfVirtualSystemHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_SnapshotOfVirtualSystem dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_SnapshotOfVirtualSystem.getPackages());
    }

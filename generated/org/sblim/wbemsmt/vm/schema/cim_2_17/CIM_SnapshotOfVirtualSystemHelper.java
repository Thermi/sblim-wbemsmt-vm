...
public class CIM_SnapshotOfVirtualSystemHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SnapshotOfVirtualSystem.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SnapshotOfVirtualSystem.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_SnapshotOfVirtualSystem.");
                        resultArrayList.add(new CIM_SnapshotOfVirtualSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SnapshotOfVirtualSystem.");
                        resultArrayList.add(new CIM_SnapshotOfVirtualSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SnapshotOfVirtualSystem.");
                        resultArrayList.add(new CIM_SnapshotOfVirtualSystem(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SnapshotOfVirtualSystem getInstance(WBEMClient client,
    ...
    public final static CIM_SnapshotOfVirtualSystem getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SnapshotOfVirtualSystem.PROPERTY_ANTECEDENT_CIM_COMPUTERSYSTEM.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SnapshotOfVirtualSystem.PROPERTY_DEPENDENT_CIM_VIRTUALSYSTEMSETTINGDATA.NAME,
                new CIMDataType(CIM_VirtualSystemSettingData.CIM_CLASS_NAME), setThis, false,
                false, CIM_SnapshotOfVirtualSystem.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SnapshotOfVirtualSystem createInstance(WBEMClient client,
            CIM_SnapshotOfVirtualSystem dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SnapshotOfVirtualSystem newDataInstance = CIM_SnapshotOfVirtualSystemHelper
     ...
     */
    public final static CIM_SnapshotOfVirtualSystem modifyInstance(WBEMClient client,
            CIM_SnapshotOfVirtualSystem dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SnapshotOfVirtualSystem dataInstance2 = CIM_SnapshotOfVirtualSystemHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_SnapshotOfVirtualSystem dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SnapshotOfVirtualSystem.getPackages());
    }

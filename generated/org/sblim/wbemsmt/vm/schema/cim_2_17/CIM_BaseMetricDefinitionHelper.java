...
public class CIM_BaseMetricDefinitionHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_BaseMetricDefinition.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_BaseMetricDefinition.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_BaseMetricDefinition.");
                        resultArrayList.add(new CIM_BaseMetricDefinition(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_BaseMetricDefinition.");
                        resultArrayList.add(new CIM_BaseMetricDefinition(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_BaseMetricDefinition.");
                        resultArrayList.add(new CIM_BaseMetricDefinition(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_BaseMetricDefinition getInstance(WBEMClient client,
    ...
    public final static CIM_BaseMetricDefinition getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_BaseMetricDefinition.PROPERTY_ID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_BaseMetricDefinition.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_BaseMetricDefinition createInstance(WBEMClient client,
            CIM_BaseMetricDefinition dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_BaseMetricDefinition newDataInstance = CIM_BaseMetricDefinitionHelper.getInstance(
     ...
     */
    public final static CIM_BaseMetricDefinition modifyInstance(WBEMClient client,
            CIM_BaseMetricDefinition dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_BaseMetricDefinition dataInstance2 = CIM_BaseMetricDefinitionHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_BaseMetricDefinition dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_BaseMetricDefinition.getPackages());
    }

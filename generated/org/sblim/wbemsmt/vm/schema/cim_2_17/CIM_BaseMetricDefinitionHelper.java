/** 
  ...
  * 
  * Description: Helper class for CIM_BaseMetricDefinition
  *    
  * 
  * generated Class
  * @see CIM_BaseMetricDefinition
  */
...
public class CIM_BaseMetricDefinitionHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_BaseMetricDefinition or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_BaseMetricDefinition.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_BaseMetricDefinition.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_BaseMetricDefinition or the subclasses if deep == true
    */        
    public final static List<CIM_BaseMetricDefinition> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_BaseMetricDefinition> resultArrayList = new ArrayList<CIM_BaseMetricDefinition>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_BaseMetricDefinition.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_BaseMetricDefinition(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_BaseMetricDefinitionHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_BaseMetricDefinition)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_BaseMetricDefinition getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_BaseMetricDefinition getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_BaseMetricDefinition)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_BaseMetricDefinition.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_BaseMetricDefinition(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_BaseMetricDefinition getInstance(WBEMClient client, String namespace
                                                       ,String Id
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_BaseMetricDefinition.PROPERTY_ID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_BaseMetricDefinition.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_BaseMetricDefinition.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_BaseMetricDefinition createInstance(WBEMClient client, CIM_BaseMetricDefinition dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_BaseMetricDefinition newDataInstance = CIM_BaseMetricDefinitionHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_BaseMetricDefinition modifyInstance(WBEMClient client, CIM_BaseMetricDefinition dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_BaseMetricDefinition dataInstance2 = CIM_BaseMetricDefinitionHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_BaseMetricDefinition dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_BaseMetricDefinition.getPackages());
    }

...
public class CIM_AbstractIndicationSubscriptionHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_AbstractIndicationSubscription.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_AbstractIndicationSubscription.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_AbstractIndicationSubscriptionHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_AbstractIndicationSubscription.");
                        resultArrayList.add(new CIM_AbstractIndicationSubscription(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_AbstractIndicationSubscription.");
                        resultArrayList.add(new CIM_AbstractIndicationSubscription(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_AbstractIndicationSubscription.");
                        resultArrayList.add(new CIM_AbstractIndicationSubscription(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_AbstractIndicationSubscription getInstance(WBEMClient client,
     ...
     */
    public final static CIM_AbstractIndicationSubscription getInstance(WBEMClient client,
            String namespace, CIM_ManagedElement Filter, CIM_ListenerDestination Handler
        ...
        keyProperties[0] = new CIMProperty(
                CIM_AbstractIndicationSubscription.PROPERTY_FILTER_CIM_MANAGEDELEMENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_AbstractIndicationSubscription.PROPERTY_HANDLER_CIM_LISTENERDESTINATION.NAME,
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_AbstractIndicationSubscription dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_AbstractIndicationSubscription.getPackages());
    }

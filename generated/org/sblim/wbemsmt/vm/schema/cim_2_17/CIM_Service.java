   ...
   public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;
    ...
    public static class METHOD_CHANGEAFFECTEDELEMENTSASSIGNEDSEQUENCE
    {
       ...
       public final static String NAME = "ChangeAffectedElementsAssignedSequence";
          ...
          public final static javax.cim.UnsignedInteger32 VALUE_MAP_ENTRY_0_FOR_VALUE_ENTRY_Completed_with_No_Error 
                              = new javax.cim.UnsignedInteger32("0");
	          	
                       /**
              * constant for value entry Completed with No Error (corresponds to mapEntry 0 )
              */
             public final static String VALUE_ENTRY_Completed_with_No_Error 
          ...
          public final static javax.cim.UnsignedInteger32 VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_Error_Occured 
                              = new javax.cim.UnsignedInteger32("2");
	          	
                       /**
              * constant for value entry Error Occured (corresponds to mapEntry 2 )
              */
             public final static String VALUE_ENTRY_Error_Occured 
                              = "Error Occured";
          ...
          public final static javax.cim.UnsignedInteger32 VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_Busy 
                              = new javax.cim.UnsignedInteger32("3");
	          	
                       /**
              * constant for value entry Busy (corresponds to mapEntry 3 )
              */
             public final static String VALUE_ENTRY_Busy 
                              = "Busy";
          ...
          public final static javax.cim.UnsignedInteger32 VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_Invalid_Reference 
                              = new javax.cim.UnsignedInteger32("4");
	          	
                       /**
              * constant for value entry Invalid Reference (corresponds to mapEntry 4 )
              */
             public final static String VALUE_ENTRY_Invalid_Reference 
                              = "Invalid Reference";
          ...
          public final static javax.cim.UnsignedInteger32 VALUE_MAP_ENTRY_5_FOR_VALUE_ENTRY_Invalid_Parameter 
           ...
           */ 
              ...
              */
             public final static String VALUE_ENTRY_Vendor_Specified 
                              = "Vendor Specified";
      ...
      public final static javax.cim.UnsignedInteger32[] VALUE_MAP_ENTRIES = { 
       ...
       public final static String[] VALUE_ENTRIES = { 
                                                   VALUE_ENTRY_Completed_with_No_Error
                                                                 ,  VALUE_ENTRY_Not_Supported
                                                                 ,  VALUE_ENTRY_Error_Occured
                                                                 ,  VALUE_ENTRY_Busy
                                                                 ,  VALUE_ENTRY_Invalid_Reference
                                                                 ,  VALUE_ENTRY_Invalid_Parameter
                                                                 ,  VALUE_ENTRY_Access_Denied
                                                                 ,  VALUE_ENTRY_DMTF_Reserved
                                                                 ,  VALUE_ENTRY_Vendor_Specified
                                    };
...
//**********************************************************************
     ...
     **/
     ...
     public java.util.List<CIM_ManagedElement> getAssociated_CIM_ManagedElement_CIM_ServiceAffectsElements(WBEMClient cimClient) throws WbemsmtException {
     
     	   return getAssociated_CIM_ManagedElement_CIM_ServiceAffectsElements(
     	                cimClient,
     ...
     **/
     ...
     public java.util.List<CIM_ManagedElement> getAssociated_CIM_ManagedElement_CIM_ServiceAffectsElements(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_ManagedElement_CIM_ServiceAffectsElementNames(WBEMClient cimClient) throws WbemsmtException {
    
    	    return getAssociated_CIM_ManagedElement_CIM_ServiceAffectsElementNames (
    	                             cimClient,
    	                             true,
    	                             CIM_ASSOCIATOR_CLASS_NAME_CIM_SERVICEAFFECTSELEMENT,
    	                             CIM_ManagedElement.CIM_CLASS_NAME,
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_ManagedElement_CIM_ServiceAffectsElementNames(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_ManagedElement_CIM_ServiceAffectsElementNames(WBEMClient cimClient,boolean deep,String associationClass, String resultClass, String role, String resultRole) throws WbemsmtException {
...
//**********************************************************************                         
    ...
    public ChangeAffectedElementsAssignedSequenceResult invoke_ChangeAffectedElementsAssignedSequence(WBEMClient cimClient
                                 ,CIM_ManagedElement[] ManagedElements
                      ,javax.cim.UnsignedInteger16[] AssignedSequence
                      ) throws WbemsmtException {
         
       CIMArgument[] inParameter = new CIMArgument[2];
       CIMArgument[] outParameter = new CIMArgument[1];
    
                    inParameter[0] = ( ManagedElements == null ? null : new CIMArgument("ManagedElements", new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME,0), getCIMObjectPathes(ManagedElements)) );
       
                    inParameter[1] = ( AssignedSequence == null ? null : new CIMArgument("AssignedSequence", CIMDataType.UINT16_ARRAY_T, AssignedSequence) );
       ...
       try {
           Object oResult =  cimClient.invokeMethod(           	                                            this.getCimObjectPath()
           	                                         , 
                                                    METHOD_CHANGEAFFECTEDELEMENTSASSIGNEDSEQUENCE.NAME,
                                                    inParameter,
                                                    outParameter);
           if (oResult != null)
           {

/** 
  * CIM_OwningCollectionElementHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_OwningCollectionElement
  *    
  * 
  * generated Class
  * @see CIM_OwningCollectionElement
  */
...
public class CIM_OwningCollectionElementHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_OwningCollectionElement or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_OwningCollectionElement.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_OwningCollectionElement.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_OwningCollectionElement or the subclasses if deep == true
    */        
    public final static List<CIM_OwningCollectionElement> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_OwningCollectionElement> resultArrayList = new ArrayList<CIM_OwningCollectionElement>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_OwningCollectionElement.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_OwningCollectionElement(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_OwningCollectionElementHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_OwningCollectionElement.");
                        resultArrayList.add(new CIM_OwningCollectionElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_OwningCollectionElement.");
                        resultArrayList.add(new CIM_OwningCollectionElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_OwningCollectionElement)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_OwningCollectionElement.");
                        resultArrayList.add(new CIM_OwningCollectionElement(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_OwningCollectionElement getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_OwningCollectionElement getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_OwningCollectionElement dataInstance = null;
        Class<?> clazz = CIM_OwningCollectionElementHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_OwningCollectionElement)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_OwningCollectionElement.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_OwningCollectionElement(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_OwningCollectionElement getInstance(WBEMClient client, String namespace
                                                       ,CIM_ManagedElement OwningElement
                                                       ,CIM_Collection OwnedElement
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_OwningCollectionElement.PROPERTY_OWNINGELEMENT_CIM_MANAGEDELEMENT.NAME,new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME),setThis,false,false,CIM_OwningCollectionElement.CIM_CLASS_NAME); 
                   
                                 setThis = OwnedElement != null ? OwnedElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_OwningCollectionElement.PROPERTY_OWNEDELEMENT_CIM_COLLECTION.NAME,new CIMDataType(CIM_Collection.CIM_CLASS_NAME),setThis,false,false,CIM_OwningCollectionElement.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_OwningCollectionElement.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_OwningCollectionElement createInstance(WBEMClient client, CIM_OwningCollectionElement dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_OwningCollectionElement newDataInstance = CIM_OwningCollectionElementHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_OwningCollectionElement modifyInstance(WBEMClient client, CIM_OwningCollectionElement dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_OwningCollectionElement dataInstance2 = CIM_OwningCollectionElementHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_OwningCollectionElement dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_OwningCollectionElement.getPackages());
    }

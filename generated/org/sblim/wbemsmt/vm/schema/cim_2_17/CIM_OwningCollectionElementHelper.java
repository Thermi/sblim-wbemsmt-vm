...
public class CIM_OwningCollectionElementHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_OwningCollectionElement.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_OwningCollectionElement.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_OwningCollectionElement.");
                        resultArrayList.add(new CIM_OwningCollectionElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_OwningCollectionElement.");
                        resultArrayList.add(new CIM_OwningCollectionElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_OwningCollectionElement.");
                        resultArrayList.add(new CIM_OwningCollectionElement(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_OwningCollectionElement getInstance(WBEMClient client,
     ...
     */
    public final static CIM_OwningCollectionElement getInstance(WBEMClient client,
            String namespace, CIM_ManagedElement OwningElement, CIM_Collection OwnedElement
        ...
        keyProperties[0] = new CIMProperty(
                CIM_OwningCollectionElement.PROPERTY_OWNINGELEMENT_CIM_MANAGEDELEMENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_OwningCollectionElement.PROPERTY_OWNEDELEMENT_CIM_COLLECTION.NAME,
                new CIMDataType(CIM_Collection.CIM_CLASS_NAME), setThis, false, false,
                CIM_OwningCollectionElement.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_OwningCollectionElement createInstance(WBEMClient client,
            CIM_OwningCollectionElement dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_OwningCollectionElement newDataInstance = CIM_OwningCollectionElementHelper
     ...
     */
    public final static CIM_OwningCollectionElement modifyInstance(WBEMClient client,
            CIM_OwningCollectionElement dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_OwningCollectionElement dataInstance2 = CIM_OwningCollectionElementHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_OwningCollectionElement dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_OwningCollectionElement.getPackages());
    }

...
public class CIM_MostCurrentSnapshotInBranchHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_MostCurrentSnapshotInBranch.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_MostCurrentSnapshotInBranch.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_MostCurrentSnapshotInBranchHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_MostCurrentSnapshotInBranch.");
                        resultArrayList.add(new CIM_MostCurrentSnapshotInBranch(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_MostCurrentSnapshotInBranch.");
                        resultArrayList.add(new CIM_MostCurrentSnapshotInBranch(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_MostCurrentSnapshotInBranch.");
                        resultArrayList.add(new CIM_MostCurrentSnapshotInBranch(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_MostCurrentSnapshotInBranch getInstance(WBEMClient client,
     ...
     */
    public final static CIM_MostCurrentSnapshotInBranch getInstance(WBEMClient client,
            String namespace, CIM_ComputerSystem Antecedent, CIM_VirtualSystemSettingData Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_MostCurrentSnapshotInBranch.PROPERTY_ANTECEDENT_CIM_COMPUTERSYSTEM.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_MostCurrentSnapshotInBranch.PROPERTY_DEPENDENT_CIM_VIRTUALSYSTEMSETTINGDATA.NAME,
                new CIMDataType(CIM_VirtualSystemSettingData.CIM_CLASS_NAME), setThis, false,
                false, CIM_MostCurrentSnapshotInBranch.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_MostCurrentSnapshotInBranch createInstance(WBEMClient client,
            CIM_MostCurrentSnapshotInBranch dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_MostCurrentSnapshotInBranch newDataInstance = CIM_MostCurrentSnapshotInBranchHelper
     ...
     */
    public final static CIM_MostCurrentSnapshotInBranch modifyInstance(WBEMClient client,
            CIM_MostCurrentSnapshotInBranch dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_MostCurrentSnapshotInBranch dataInstance2 = CIM_MostCurrentSnapshotInBranchHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_MostCurrentSnapshotInBranch dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_MostCurrentSnapshotInBranch.getPackages());
    }

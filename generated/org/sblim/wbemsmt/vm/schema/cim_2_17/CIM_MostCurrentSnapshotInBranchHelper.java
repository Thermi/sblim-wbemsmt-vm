/** 
  * CIM_MostCurrentSnapshotInBranchHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_MostCurrentSnapshotInBranch
  *    
  * 
  * generated Class
  * @see CIM_MostCurrentSnapshotInBranch
  */
...
public class CIM_MostCurrentSnapshotInBranchHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_MostCurrentSnapshotInBranch or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_MostCurrentSnapshotInBranch.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_MostCurrentSnapshotInBranch.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_MostCurrentSnapshotInBranch or the subclasses if deep == true
    */        
    public final static List<CIM_MostCurrentSnapshotInBranch> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_MostCurrentSnapshotInBranch> resultArrayList = new ArrayList<CIM_MostCurrentSnapshotInBranch>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_MostCurrentSnapshotInBranch.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_MostCurrentSnapshotInBranch(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_MostCurrentSnapshotInBranchHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_MostCurrentSnapshotInBranch.");
                        resultArrayList.add(new CIM_MostCurrentSnapshotInBranch(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_MostCurrentSnapshotInBranch.");
                        resultArrayList.add(new CIM_MostCurrentSnapshotInBranch(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_MostCurrentSnapshotInBranch)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_MostCurrentSnapshotInBranch.");
                        resultArrayList.add(new CIM_MostCurrentSnapshotInBranch(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_MostCurrentSnapshotInBranch getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_MostCurrentSnapshotInBranch getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_MostCurrentSnapshotInBranch dataInstance = null;
        Class<?> clazz = CIM_MostCurrentSnapshotInBranchHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_MostCurrentSnapshotInBranch)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_MostCurrentSnapshotInBranch.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_MostCurrentSnapshotInBranch(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_MostCurrentSnapshotInBranch getInstance(WBEMClient client, String namespace
                                                       ,CIM_ComputerSystem Antecedent
                                                       ,CIM_VirtualSystemSettingData Dependent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_MostCurrentSnapshotInBranch.PROPERTY_ANTECEDENT_CIM_COMPUTERSYSTEM.NAME,new CIMDataType(CIM_ComputerSystem.CIM_CLASS_NAME),setThis,false,false,CIM_MostCurrentSnapshotInBranch.CIM_CLASS_NAME); 
                   
                                 setThis = Dependent != null ? Dependent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_MostCurrentSnapshotInBranch.PROPERTY_DEPENDENT_CIM_VIRTUALSYSTEMSETTINGDATA.NAME,new CIMDataType(CIM_VirtualSystemSettingData.CIM_CLASS_NAME),setThis,false,false,CIM_MostCurrentSnapshotInBranch.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_MostCurrentSnapshotInBranch.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_MostCurrentSnapshotInBranch createInstance(WBEMClient client, CIM_MostCurrentSnapshotInBranch dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_MostCurrentSnapshotInBranch newDataInstance = CIM_MostCurrentSnapshotInBranchHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_MostCurrentSnapshotInBranch modifyInstance(WBEMClient client, CIM_MostCurrentSnapshotInBranch dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_MostCurrentSnapshotInBranch dataInstance2 = CIM_MostCurrentSnapshotInBranchHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_MostCurrentSnapshotInBranch dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_MostCurrentSnapshotInBranch.getPackages());
    }

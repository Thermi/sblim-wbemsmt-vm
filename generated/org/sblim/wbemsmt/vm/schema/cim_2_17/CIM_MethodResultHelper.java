/** 
  ...
  * 
  * Description: Helper class for CIM_MethodResult
  *    
  * 
  * generated Class
  * @see CIM_MethodResult
  */
...
public class CIM_MethodResultHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_MethodResult or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_MethodResult.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_MethodResult.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_MethodResult or the subclasses if deep == true
    */        
    public final static List<CIM_MethodResult> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_MethodResult> resultArrayList = new ArrayList<CIM_MethodResult>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_MethodResult.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_MethodResult(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_MethodResultHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_MethodResult.");
                        resultArrayList.add(new CIM_MethodResult(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_MethodResult.");
                        resultArrayList.add(new CIM_MethodResult(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_MethodResult)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_MethodResult.");
                        resultArrayList.add(new CIM_MethodResult(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_MethodResult getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_MethodResult getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_MethodResult dataInstance = null;
        Class<?> clazz = CIM_MethodResultHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_MethodResult)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_MethodResult.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_MethodResult(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_MethodResult getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_MethodResult.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_MethodResult.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_MethodResult.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_MethodResult createInstance(WBEMClient client, CIM_MethodResult dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_MethodResult newDataInstance = CIM_MethodResultHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_MethodResult modifyInstance(WBEMClient client, CIM_MethodResult dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_MethodResult dataInstance2 = CIM_MethodResultHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_MethodResult dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_MethodResult.getPackages());
    }

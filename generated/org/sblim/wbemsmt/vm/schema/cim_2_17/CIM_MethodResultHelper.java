...
public class CIM_MethodResultHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_MethodResult.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_MethodResult.");
                        resultArrayList.add(new CIM_MethodResult(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_MethodResult.");
                        resultArrayList.add(new CIM_MethodResult(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_MethodResult.");
                        resultArrayList.add(new CIM_MethodResult(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_MethodResult getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_MethodResult getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_MethodResult getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_MethodResult.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_MethodResult.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_MethodResult createInstance(WBEMClient client,
            CIM_MethodResult dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_MethodResult newDataInstance = CIM_MethodResultHelper
     ...
     */
    public final static CIM_MethodResult modifyInstance(WBEMClient client,
            CIM_MethodResult dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_MethodResult dataInstance2 = CIM_MethodResultHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_MethodResult dataInstance)
            throws WbemsmtException {

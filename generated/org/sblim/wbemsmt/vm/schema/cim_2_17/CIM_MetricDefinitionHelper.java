...
public class CIM_MetricDefinitionHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_MetricDefinition.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_MetricDefinition.");
                        resultArrayList.add(new CIM_MetricDefinition(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_MetricDefinition.");
                        resultArrayList.add(new CIM_MetricDefinition(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_MetricDefinition.");
                        resultArrayList.add(new CIM_MetricDefinition(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_MetricDefinition getInstance(WBEMClient client,
     ...
     */
    public final static CIM_MetricDefinition getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     *
     */
    public final static CIM_MetricDefinition createInstance(WBEMClient client,
            CIM_MetricDefinition dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_MetricDefinition newDataInstance = CIM_MetricDefinitionHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_MetricDefinition modifyInstance(WBEMClient client,
            CIM_MetricDefinition dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_MetricDefinition dataInstance2 = CIM_MetricDefinitionHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_MetricDefinition dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_MetricDefinition.getPackages());
    }

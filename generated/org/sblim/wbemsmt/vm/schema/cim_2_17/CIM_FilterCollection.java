...
//**********************************************************************
   ...
   {
              propertiesToCheck.put("CollectionName",new CIMProperty("CollectionName",CIMDataType.STRING_T,null));
...
//**********************************************************************
   ...
   public String get_CollectionName()    {
       ...
       if (currentProperty == null || currentProperty.getValue() == null) {
           logger.warning("Property " + PROPERTY_COLLECTIONNAME.NAME + " was not found in instance " + getCimObjectPath());
           return null;
       }
   ...
   public boolean set_CollectionName(String newValue)
   {
    ...
    public static CIMProperty create_CollectionName(WBEMClient client, String namespace, String newValue) throws WbemsmtException {
        ...
        if (property != null)
        {
       	 ...
       	 {
       	 		   logger.warning("Property " + PROPERTY_COLLECTIONNAME.NAME + " was not found in instance " + fco.getCimObjectPath());
       	 }
        return property;
    }
   ...
   private static CIMProperty setPropertyValue_CollectionName(CIMProperty currentProperty, String newValue)
   {
        Object setThis = null;        
...
//**********************************************************************
     ...
     **/
     ...
     public java.util.List<CIM_ListenerDestination> getAssociated_CIM_ListenerDestination_CIM_FilterCollectionSubscriptions(WBEMClient cimClient) throws WbemsmtException {
     
     	   return getAssociated_CIM_ListenerDestination_CIM_FilterCollectionSubscriptions(
     	                cimClient,
     ...
     **/
     ...
     public java.util.List<CIM_ListenerDestination> getAssociated_CIM_ListenerDestination_CIM_FilterCollectionSubscriptions(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_ListenerDestination_CIM_FilterCollectionSubscriptionNames(WBEMClient cimClient) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_ListenerDestination_CIM_FilterCollectionSubscriptionNames(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_ListenerDestination_CIM_FilterCollectionSubscriptionNames(WBEMClient cimClient,boolean deep,String associationClass, String resultClass, String role, String resultRole) throws WbemsmtException {

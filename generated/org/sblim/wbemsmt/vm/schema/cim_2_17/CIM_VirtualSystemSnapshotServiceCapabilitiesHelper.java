/** 
  * CIM_VirtualSystemSnapshotServiceCapabilitiesHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_VirtualSystemSnapshotServiceCapabilities
  *    
  * 
  * generated Class
  * @see CIM_VirtualSystemSnapshotServiceCapabilities
  */
...
public class CIM_VirtualSystemSnapshotServiceCapabilitiesHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_VirtualSystemSnapshotServiceCapabilities or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_VirtualSystemSnapshotServiceCapabilities.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_VirtualSystemSnapshotServiceCapabilities.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_VirtualSystemSnapshotServiceCapabilities or the subclasses if deep == true
    */        
    public final static List<CIM_VirtualSystemSnapshotServiceCapabilities> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_VirtualSystemSnapshotServiceCapabilities> resultArrayList = new ArrayList<CIM_VirtualSystemSnapshotServiceCapabilities>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_VirtualSystemSnapshotServiceCapabilities.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_VirtualSystemSnapshotServiceCapabilities(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_VirtualSystemSnapshotServiceCapabilitiesHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_VirtualSystemSnapshotServiceCapabilities.");
                        resultArrayList.add(new CIM_VirtualSystemSnapshotServiceCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_VirtualSystemSnapshotServiceCapabilities.");
                        resultArrayList.add(new CIM_VirtualSystemSnapshotServiceCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_VirtualSystemSnapshotServiceCapabilities)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_VirtualSystemSnapshotServiceCapabilities.");
                        resultArrayList.add(new CIM_VirtualSystemSnapshotServiceCapabilities(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_VirtualSystemSnapshotServiceCapabilities getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_VirtualSystemSnapshotServiceCapabilities getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_VirtualSystemSnapshotServiceCapabilities dataInstance = null;
        Class<?> clazz = CIM_VirtualSystemSnapshotServiceCapabilitiesHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_VirtualSystemSnapshotServiceCapabilities)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_VirtualSystemSnapshotServiceCapabilities.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_VirtualSystemSnapshotServiceCapabilities(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_VirtualSystemSnapshotServiceCapabilities getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_VirtualSystemSnapshotServiceCapabilities.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_VirtualSystemSnapshotServiceCapabilities.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_VirtualSystemSnapshotServiceCapabilities.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_VirtualSystemSnapshotServiceCapabilities createInstance(WBEMClient client, CIM_VirtualSystemSnapshotServiceCapabilities dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_VirtualSystemSnapshotServiceCapabilities newDataInstance = CIM_VirtualSystemSnapshotServiceCapabilitiesHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_VirtualSystemSnapshotServiceCapabilities modifyInstance(WBEMClient client, CIM_VirtualSystemSnapshotServiceCapabilities dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_VirtualSystemSnapshotServiceCapabilities dataInstance2 = CIM_VirtualSystemSnapshotServiceCapabilitiesHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_VirtualSystemSnapshotServiceCapabilities dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_VirtualSystemSnapshotServiceCapabilities.getPackages());
    }

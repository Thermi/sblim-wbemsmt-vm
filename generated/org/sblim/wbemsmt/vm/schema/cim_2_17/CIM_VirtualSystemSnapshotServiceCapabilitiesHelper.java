...
public class CIM_VirtualSystemSnapshotServiceCapabilitiesHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                CIM_VirtualSystemSnapshotServiceCapabilities.CIM_CLASS_NAME,
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_VirtualSystemSnapshotServiceCapabilities.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_VirtualSystemSnapshotServiceCapabilities(
                                cimInstance));
                        continue;
                    }
                    Class clazz = CIM_VirtualSystemSnapshotServiceCapabilitiesHelper.findClass(
                            client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_VirtualSystemSnapshotServiceCapabilities.");
                        resultArrayList.add(new CIM_VirtualSystemSnapshotServiceCapabilities(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_VirtualSystemSnapshotServiceCapabilities.");
                        resultArrayList.add(new CIM_VirtualSystemSnapshotServiceCapabilities(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_VirtualSystemSnapshotServiceCapabilities.");
                        resultArrayList.add(new CIM_VirtualSystemSnapshotServiceCapabilities(
                                cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_VirtualSystemSnapshotServiceCapabilities getInstance(WBEMClient client,
    ...
    public final static CIM_VirtualSystemSnapshotServiceCapabilities getInstance(WBEMClient client,
        ...
        Class clazz = CIM_VirtualSystemSnapshotServiceCapabilitiesHelper.findClass(client,
                cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_VirtualSystemSnapshotServiceCapabilities) cons
                        .newInstance(actargs);
            }
            catch (Exception e) {
                System.err
    ...
    public final static CIM_VirtualSystemSnapshotServiceCapabilities getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_VirtualSystemSnapshotServiceCapabilities.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static CIM_VirtualSystemSnapshotServiceCapabilities createInstance(
            WBEMClient client, CIM_VirtualSystemSnapshotServiceCapabilities dataInstance,
        ...
        CIM_VirtualSystemSnapshotServiceCapabilities newDataInstance = CIM_VirtualSystemSnapshotServiceCapabilitiesHelper
     ...
     */
    public final static CIM_VirtualSystemSnapshotServiceCapabilities modifyInstance(
            WBEMClient client, CIM_VirtualSystemSnapshotServiceCapabilities dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_VirtualSystemSnapshotServiceCapabilities dataInstance2 = CIM_VirtualSystemSnapshotServiceCapabilitiesHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_VirtualSystemSnapshotServiceCapabilities dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_VirtualSystemSnapshotServiceCapabilities.getPackages());
    }

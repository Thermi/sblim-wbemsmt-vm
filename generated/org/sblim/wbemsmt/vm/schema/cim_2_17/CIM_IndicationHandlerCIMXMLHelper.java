...
//**********************************************************************
    ...
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_IndicationHandlerCIMXML.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_IndicationHandlerCIMXML.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    */        
    public final static List<CIM_IndicationHandlerCIMXML> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_IndicationHandlerCIMXML> resultArrayList = new ArrayList<CIM_IndicationHandlerCIMXML>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_IndicationHandlerCIMXML.CIM_CLASS_NAME)) {
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_IndicationHandlerCIMXML)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_IndicationHandlerCIMXML getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_IndicationHandlerCIMXML getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
    ...
    */    
    public final static CIM_IndicationHandlerCIMXML getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_IndicationHandlerCIMXML.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_IndicationHandlerCIMXML.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[1]  = new CIMProperty(CIM_IndicationHandlerCIMXML.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_IndicationHandlerCIMXML.CIM_CLASS_NAME); 
                   
                   setThis = SystemCreationClassName;
                
           keyProperties[2]  = new CIMProperty(CIM_IndicationHandlerCIMXML.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_IndicationHandlerCIMXML.CIM_CLASS_NAME); 
                   
                   setThis = SystemName;
                
           keyProperties[3]  = new CIMProperty(CIM_IndicationHandlerCIMXML.PROPERTY_SYSTEMNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_IndicationHandlerCIMXML.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_IndicationHandlerCIMXML.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_IndicationHandlerCIMXML createInstance(WBEMClient client, CIM_IndicationHandlerCIMXML dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_IndicationHandlerCIMXML newDataInstance = CIM_IndicationHandlerCIMXMLHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_IndicationHandlerCIMXML modifyInstance(WBEMClient client, CIM_IndicationHandlerCIMXML dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_IndicationHandlerCIMXML dataInstance2 = CIM_IndicationHandlerCIMXMLHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_IndicationHandlerCIMXML dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_IndicationHandlerCIMXML.getPackages());
    }

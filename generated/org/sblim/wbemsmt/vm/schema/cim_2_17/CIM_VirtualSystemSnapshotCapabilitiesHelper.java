...
public class CIM_VirtualSystemSnapshotCapabilitiesHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                CIM_VirtualSystemSnapshotCapabilities.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_VirtualSystemSnapshotCapabilities.CIM_CLASS_NAME
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_VirtualSystemSnapshotCapabilitiesHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_VirtualSystemSnapshotCapabilities.");
                        resultArrayList.add(new CIM_VirtualSystemSnapshotCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_VirtualSystemSnapshotCapabilities.");
                        resultArrayList.add(new CIM_VirtualSystemSnapshotCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_VirtualSystemSnapshotCapabilities.");
                        resultArrayList.add(new CIM_VirtualSystemSnapshotCapabilities(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_VirtualSystemSnapshotCapabilities getInstance(WBEMClient client,
    ...
    public final static CIM_VirtualSystemSnapshotCapabilities getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_VirtualSystemSnapshotCapabilities.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static CIM_VirtualSystemSnapshotCapabilities createInstance(WBEMClient client,
            CIM_VirtualSystemSnapshotCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_VirtualSystemSnapshotCapabilities newDataInstance = CIM_VirtualSystemSnapshotCapabilitiesHelper
     ...
     */
    public final static CIM_VirtualSystemSnapshotCapabilities modifyInstance(WBEMClient client,
            CIM_VirtualSystemSnapshotCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_VirtualSystemSnapshotCapabilities dataInstance2 = CIM_VirtualSystemSnapshotCapabilitiesHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_VirtualSystemSnapshotCapabilities dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_VirtualSystemSnapshotCapabilities.getPackages());
    }

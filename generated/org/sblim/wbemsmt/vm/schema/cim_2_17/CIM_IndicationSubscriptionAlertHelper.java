/** 
  * CIM_IndicationSubscriptionAlertHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_IndicationSubscriptionAlert
  *    
  * 
  * generated Class
  * @see CIM_IndicationSubscriptionAlert
  */
...
public class CIM_IndicationSubscriptionAlertHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_IndicationSubscriptionAlert or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_IndicationSubscriptionAlert.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_IndicationSubscriptionAlert.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_IndicationSubscriptionAlert or the subclasses if deep == true
    */        
    public final static List<CIM_IndicationSubscriptionAlert> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_IndicationSubscriptionAlert> resultArrayList = new ArrayList<CIM_IndicationSubscriptionAlert>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_IndicationSubscriptionAlert.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_IndicationSubscriptionAlert(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_IndicationSubscriptionAlertHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_IndicationSubscriptionAlert.");
                        resultArrayList.add(new CIM_IndicationSubscriptionAlert(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_IndicationSubscriptionAlert.");
                        resultArrayList.add(new CIM_IndicationSubscriptionAlert(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_IndicationSubscriptionAlert)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_IndicationSubscriptionAlert.");
                        resultArrayList.add(new CIM_IndicationSubscriptionAlert(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_IndicationSubscriptionAlert getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_IndicationSubscriptionAlert getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_IndicationSubscriptionAlert dataInstance = null;
        Class<?> clazz = CIM_IndicationSubscriptionAlertHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_IndicationSubscriptionAlert)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_IndicationSubscriptionAlert.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_IndicationSubscriptionAlert(cimInstance);
            }
        } catch (Exception e) {
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_IndicationSubscriptionAlert createInstance(WBEMClient client, CIM_IndicationSubscriptionAlert dataInstance, boolean notifyDifferencies)
    ...
    { 
        ...
        CIM_IndicationSubscriptionAlert newDataInstance = CIM_IndicationSubscriptionAlertHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_IndicationSubscriptionAlert modifyInstance(WBEMClient client, CIM_IndicationSubscriptionAlert dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_IndicationSubscriptionAlert dataInstance2 = CIM_IndicationSubscriptionAlertHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_IndicationSubscriptionAlert dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_IndicationSubscriptionAlert.getPackages());
    }

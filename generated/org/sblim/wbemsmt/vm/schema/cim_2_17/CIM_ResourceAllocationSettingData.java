...
public class CIM_ResourceAllocationSettingData extends CIM_SettingData {
    ...
    public static class PROPERTY_CONSUMERVISIBILITY {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_Passed_Through = new javax.cim.UnsignedInteger16(
                "2");

        /**
         * constant for value entry Passed-Through (corresponds to mapEntry 2 )
         */
        public final static String VALUE_ENTRY_Passed_Through = "Passed-Through";

        /**
         * constant for value map entry 3
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_Virtualized = new javax.cim.UnsignedInteger16(
                "3");

        /**
         * constant for value entry Virtualized (corresponds to mapEntry 3 )
         */
        public final static String VALUE_ENTRY_Virtualized = "Virtualized";

        /**
         * constant for value map entry 4
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_Not_represented = new javax.cim.UnsignedInteger16(
                "4");

        /**
         * constant for value entry Not represented (corresponds to mapEntry 4 )
         */
        public final static String VALUE_ENTRY_Not_represented = "Not represented";
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@4f184f18
        ...
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Unknown,
                VALUE_ENTRY_Passed_Through, VALUE_ENTRY_Virtualized, VALUE_ENTRY_Not_represented,
    ...
    public static class PROPERTY_MAPPINGBEHAVIOR {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_Not_Supported = new javax.cim.UnsignedInteger16(
                "2");
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_Dedicated = new javax.cim.UnsignedInteger16(
                "3");
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_Soft_Affinity = new javax.cim.UnsignedInteger16(
                "4");

        /**
         * constant for value entry Soft Affinity (corresponds to mapEntry 4 )
         */
        public final static String VALUE_ENTRY_Soft_Affinity = "Soft Affinity";

        /**
         * constant for value map entry 5
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_5_FOR_VALUE_ENTRY_Hard_Affinity = new javax.cim.UnsignedInteger16(
                "5");

        /**
         * constant for value entry Hard Affinity (corresponds to mapEntry 5 )
         */
        public final static String VALUE_ENTRY_Hard_Affinity = "Hard Affinity";
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@1fe61fe6
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
         ...
         */
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Unknown,
                VALUE_ENTRY_Not_Supported, VALUE_ENTRY_Dedicated, VALUE_ENTRY_Soft_Affinity,
                VALUE_ENTRY_Hard_Affinity, VALUE_ENTRY_DMTF_Reserved, VALUE_ENTRY_Vendor_Reserved };
    ...
    public static class PROPERTY_RESOURCETYPE {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_17_FOR_VALUE_ENTRY_Disk_Drive = new javax.cim.UnsignedInteger16(
                "17");

        /**
         * constant for value entry Disk Drive (corresponds to mapEntry 17 )
         */
        public final static String VALUE_ENTRY_Disk_Drive = "Disk Drive";

        /**
         * constant for value map entry 18
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_18_FOR_VALUE_ENTRY_Tape_Drive = new javax.cim.UnsignedInteger16(
                "18");

        /**
         * constant for value entry Tape Drive (corresponds to mapEntry 18 )
         */
        public final static String VALUE_ENTRY_Tape_Drive = "Tape Drive";

        /**
         * constant for value map entry 19
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_19_FOR_VALUE_ENTRY_Storage_Extent = new javax.cim.UnsignedInteger16(
                "19");
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_20_FOR_VALUE_ENTRY_Other_storage_device = new javax.cim.UnsignedInteger16(
                "20");
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_21_FOR_VALUE_ENTRY_Serial_port = new javax.cim.UnsignedInteger16(
                "21");
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_22_FOR_VALUE_ENTRY_Parallel_port = new javax.cim.UnsignedInteger16(
                "22");
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_23_FOR_VALUE_ENTRY_USB_Controller = new javax.cim.UnsignedInteger16(
                "23");
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_24_FOR_VALUE_ENTRY_Graphics_controller = new javax.cim.UnsignedInteger16(
                "24");
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@71547154
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
        ...
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Other,
                ...
                VALUE_ENTRY_Disk_Drive, VALUE_ENTRY_Tape_Drive, VALUE_ENTRY_Storage_Extent,
                VALUE_ENTRY_Other_storage_device, VALUE_ENTRY_Serial_port,
                VALUE_ENTRY_Parallel_port, VALUE_ENTRY_USB_Controller,
                VALUE_ENTRY_Graphics_controller, VALUE_ENTRY_IEEE_1394_Controller,
                VALUE_ENTRY_Partitionable_Unit, VALUE_ENTRY_Base_Partitionable_Unit,
                VALUE_ENTRY_Power, VALUE_ENTRY_Cooling_Capacity, VALUE_ENTRY_Ethernet_Switch_Port,
                VALUE_ENTRY_DMTF_reserved, VALUE_ENTRY_Vendor_Reserved };
    ...
    public CIM_ResourceAllocationSettingData(WBEMClient client, String namespace)
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("AllocationUnits", new CIMProperty("AllocationUnits",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("AutomaticAllocation", new CIMProperty("AutomaticAllocation",
                CIMDataType.BOOLEAN_T, null));
        propertiesToCheck.put("AutomaticDeallocation", new CIMProperty("AutomaticDeallocation",
                CIMDataType.BOOLEAN_T, null));
        propertiesToCheck.put("Connection", new CIMProperty("Connection",
                CIMDataType.STRING_ARRAY_T, null));
        propertiesToCheck.put("ConsumerVisibility", new CIMProperty("ConsumerVisibility",
                CIMDataType.UINT16_T, null));
        propertiesToCheck.put("HostResource", new CIMProperty("HostResource",
                CIMDataType.OBJECT_ARRAY_T, null));
        propertiesToCheck.put("Limit", new CIMProperty("Limit", CIMDataType.UINT64_T, null));
        propertiesToCheck.put("MappingBehavior", new CIMProperty("MappingBehavior",
                CIMDataType.UINT16_T, null));
        ...
        propertiesToCheck.put("Reservation", new CIMProperty("Reservation", CIMDataType.UINT64_T,
                null));
        ...
        propertiesToCheck.put("ResourceType", new CIMProperty("ResourceType", CIMDataType.UINT16_T,
                null));
        propertiesToCheck.put("VirtualQuantity", new CIMProperty("VirtualQuantity",
    ...
    public static CIMProperty create_Address(WBEMClient client, String namespace, String newValue)
            throws WbemsmtException {
        CIM_ResourceAllocationSettingData fco = new CIM_ResourceAllocationSettingData(client,
                namespace);
    ...
    public String get_AllocationUnits() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_ALLOCATIONUNITS.NAME
    ...
    public static CIMProperty create_AllocationUnits(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_AllocationUnits(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public Boolean get_AutomaticAllocation() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_AUTOMATICALLOCATION.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_AutomaticAllocation(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_AutomaticAllocation(CIMProperty currentProperty,
            Boolean newValue) {
        Object setThis = null;
    ...
    public Boolean get_AutomaticDeallocation() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_AUTOMATICDEALLOCATION.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_AutomaticDeallocation(WBEMClient client, String namespace,
            Boolean newValue) throws WbemsmtException {
        CIM_ResourceAllocationSettingData fco = new CIM_ResourceAllocationSettingData(client,
                namespace);
    ...
    private static CIMProperty setPropertyValue_AutomaticDeallocation(CIMProperty currentProperty,
            Boolean newValue) {
        Object setThis = null;
    ...
    public String[] get_Connection() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_CONNECTION.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_Connection(WBEMClient client, String namespace,
            String[] newValue) throws WbemsmtException {
        CIM_ResourceAllocationSettingData fco = new CIM_ResourceAllocationSettingData(client,
                namespace);
    ...
    private static CIMProperty setPropertyValue_Connection(CIMProperty currentProperty,
            String[] newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger16 get_ConsumerVisibility() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_CONSUMERVISIBILITY.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_ConsumerVisibility(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_ConsumerVisibility(CIMProperty currentProperty,
    ...
    public CIM_LogicalDevice[] get_HostResource(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_HOSTRESOURCE.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_HOSTRESOURCE.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
        ...
        for (int i = 0; i < instances.length; i++) {
            result[i] = instances[i] != null ? CIM_LogicalDeviceHelper.getInstance(client,
                    instances[i].getObjectPath()) : null;
        }
        return result;
    ...
    public static CIMProperty create_HostResource(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_HostResource(CIMProperty currentProperty,
            CIM_LogicalDevice[] newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger64 get_Limit() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_LIMIT.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_Limit(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_Limit(CIMProperty currentProperty,
    ...
    public javax.cim.UnsignedInteger16 get_MappingBehavior() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_MAPPINGBEHAVIOR.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_MappingBehavior(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger16 newValue) throws WbemsmtException {
        CIM_ResourceAllocationSettingData fco = new CIM_ResourceAllocationSettingData(client,
                namespace);
    ...
    private static CIMProperty setPropertyValue_MappingBehavior(CIMProperty currentProperty,
            javax.cim.UnsignedInteger16 newValue) {
        Object setThis = null;
    ...
    public String get_Parent() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_PARENT.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_Parent(WBEMClient client, String namespace, String newValue)
            throws WbemsmtException {
        CIM_ResourceAllocationSettingData fco = new CIM_ResourceAllocationSettingData(client,
                namespace);
    ...
    public String get_PoolID() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_POOLID.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_PoolID(WBEMClient client, String namespace, String newValue)
            throws WbemsmtException {
        CIM_ResourceAllocationSettingData fco = new CIM_ResourceAllocationSettingData(client,
                namespace);
    ...
    public javax.cim.UnsignedInteger64 get_Reservation() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_RESERVATION.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_Reservation(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger64 newValue) throws WbemsmtException {
        CIM_ResourceAllocationSettingData fco = new CIM_ResourceAllocationSettingData(client,
                namespace);
    ...
    private static CIMProperty setPropertyValue_Reservation(CIMProperty currentProperty,
            javax.cim.UnsignedInteger64 newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger64 get_VirtualQuantity() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_VIRTUALQUANTITY.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_VirtualQuantity(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger64 newValue) throws WbemsmtException {
        CIM_ResourceAllocationSettingData fco = new CIM_ResourceAllocationSettingData(client,
                namespace);
    ...
    private static CIMProperty setPropertyValue_VirtualQuantity(CIMProperty currentProperty,
            javax.cim.UnsignedInteger64 newValue) {
        Object setThis = null;
    ...
    public static CIMProperty create_Weight(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_Weight(CIMProperty currentProperty,
    ...
    public java.util.List getAssociated_CIM_VirtualSystemSettingData_CIM_VirtualSystemSettingDataComponents(
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_ResourceAllocationSettingDataHelper.findClass(cimClient,
                            cimInstance);
    ...
    public java.util.List getAssociated_CIM_VirtualSystemSettingData_CIM_VirtualSystemSettingDataComponentNames(
            WBEMClient cimClient) throws WbemsmtException {
    ...
    public java.util.List getAssociated_CIM_ResourcePool_CIM_ResourceAllocationFromPools(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ResourcePool_CIM_ResourceAllocationFromPools(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_RESOURCEALLOCATIONFROMPOOL,
                CIM_ResourcePool.CIM_CLASS_NAME, null, null, false, false, null);
    ...
    public java.util.List getAssociated_CIM_ResourcePool_CIM_ResourceAllocationFromPools(
        ...
        return getAssociated_CIM_ResourcePool_CIM_ResourceAllocationFromPools(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_RESOURCEALLOCATIONFROMPOOL, resultClass, role,
    ...
    public java.util.List getAssociated_CIM_ResourcePool_CIM_ResourceAllocationFromPoolNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ResourcePool_CIM_ResourceAllocationFromPoolNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_RESOURCEALLOCATIONFROMPOOL,
                CIM_ResourcePool.CIM_CLASS_NAME, null, null);
    }
    ...
    public java.util.List getAssociated_CIM_ResourcePool_CIM_ResourceAllocationFromPoolNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_RESOURCEALLOCATIONFROMPOOL,
                    CIM_ResourcePool.CIM_CLASS_NAME, null, null));
        }
    ...
    public java.util.List getAssociations_CIM_ResourceAllocationFromPool(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_RESOURCEALLOCATIONFROMPOOL, role,
                    includeQualifiers, includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
            throw new ReferencesException(e, new ReferencesUserObject(this.getCimObjectPath(),
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_ResourceAllocationFromPoolHelper.findClass(cimClient,
                            cimInstance);
    ...
    public java.util.List getAssociationNames_CIM_ResourceAllocationFromPool(WBEMClient cimClient,
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_ResourceAllocationFromPool.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }

...
public class CIM_VirtualSystemSettingDataComponentHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                CIM_VirtualSystemSettingDataComponent.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_VirtualSystemSettingDataComponentHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_VirtualSystemSettingDataComponent.");
                        resultArrayList.add(new CIM_VirtualSystemSettingDataComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_VirtualSystemSettingDataComponent.");
                        resultArrayList.add(new CIM_VirtualSystemSettingDataComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_VirtualSystemSettingDataComponent.");
                        resultArrayList.add(new CIM_VirtualSystemSettingDataComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_VirtualSystemSettingDataComponent getInstance(WBEMClient client,
     ...
     */
    public final static CIM_VirtualSystemSettingDataComponent getInstance(WBEMClient client,
            String namespace, CIM_VirtualSystemSettingData GroupComponent,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_VirtualSystemSettingDataComponent.PROPERTY_GROUPCOMPONENT_CIM_VIRTUALSYSTEMSETTINGDATA.NAME,
                new CIMDataType(CIM_VirtualSystemSettingData.CIM_CLASS_NAME), setThis, false,
                false, CIM_VirtualSystemSettingDataComponent.CIM_CLASS_NAME);

        setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_VirtualSystemSettingDataComponent.PROPERTY_PARTCOMPONENT_CIM_RESOURCEALLOCATIONSETTINGDATA.NAME,
     ...
     *
     */
    public final static CIM_VirtualSystemSettingDataComponent createInstance(WBEMClient client,
            CIM_VirtualSystemSettingDataComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_VirtualSystemSettingDataComponent newDataInstance = CIM_VirtualSystemSettingDataComponentHelper
     ...
     */
    public final static CIM_VirtualSystemSettingDataComponent modifyInstance(WBEMClient client,
            CIM_VirtualSystemSettingDataComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_VirtualSystemSettingDataComponent dataInstance2 = CIM_VirtualSystemSettingDataComponentHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_VirtualSystemSettingDataComponent dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_VirtualSystemSettingDataComponent.getPackages());
    }

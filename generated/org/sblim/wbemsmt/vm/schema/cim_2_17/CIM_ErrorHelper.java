...
public class CIM_ErrorHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Error.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Error.");
                        resultArrayList.add(new CIM_Error(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class "
                                ...
                                + " could not be found. Constructing instance of class CIM_Error.");
                        resultArrayList.add(new CIM_Error(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Error.");
                        resultArrayList.add(new CIM_Error(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Error getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Error getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     *
     */
    public final static CIM_Error createInstance(WBEMClient client, CIM_Error dataInstance,
     ...
     */
    public final static CIM_Error modifyInstance(WBEMClient client, CIM_Error dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Error dataInstance2 = CIM_ErrorHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Error dataInstance)
            throws WbemsmtException {

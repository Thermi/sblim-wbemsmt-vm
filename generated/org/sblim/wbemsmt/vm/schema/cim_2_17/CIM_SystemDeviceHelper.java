...
//**********************************************************************
    ...
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_SystemDevice.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
    ...
    */        
    public final static List<CIM_SystemDevice> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_SystemDevice> resultArrayList = new ArrayList<CIM_SystemDevice>();
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_SystemDevice)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_SystemDevice getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_SystemDevice getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
    ...
    */    
    public final static CIM_SystemDevice getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_SystemDevice.PROPERTY_GROUPCOMPONENT_CIM_SYSTEM.NAME,new CIMDataType(CIM_System.CIM_CLASS_NAME),setThis,false,false,CIM_SystemDevice.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_SystemDevice.PROPERTY_PARTCOMPONENT_CIM_LOGICALDEVICE.NAME,new CIMDataType(CIM_LogicalDevice.CIM_CLASS_NAME),setThis,false,false,CIM_SystemDevice.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_SystemDevice.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_SystemDevice createInstance(WBEMClient client, CIM_SystemDevice dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_SystemDevice newDataInstance = CIM_SystemDeviceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_SystemDevice modifyInstance(WBEMClient client, CIM_SystemDevice dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_SystemDevice dataInstance2 = CIM_SystemDeviceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_SystemDevice dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_SystemDevice.getPackages());
    }

/** 
 * EditVMListenerEditBeanTabGeneral.java
 *
 * 
 * 
...
public class EditVMListenerEditBeanTabGeneral extends EditBean {
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        bindingPrefix = "objectActionController.editBeans['tabGeneral'].containers[0].";
        ...
        bindingPrefix = "objectActionController.editBeans['tabGeneral'].containers[1].";

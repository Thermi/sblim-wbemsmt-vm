    ...
    public void create(String expressionPrefix, WBEMClient cimClient) throws WbemsmtException
   	{
   	   try
   	   {
   	       org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter = 
	         					   (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter)CimAdapterFactory.getInstance()
            					.getAdapter(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter.class,FacesContext.getCurrentInstance(),cimClient);
   	       //create container
          			org.sblim.wbemsmt.vm.container.edit.jsf.WelcomeDataContainerImpl container = new org.sblim.wbemsmt.vm.container.edit.jsf.WelcomeDataContainerImpl(adapter,expressionPrefix);
				...
				//add the childs with occurence list
					...
					childPanel.setId(LabeledJSFInputComponent.asJsfId(container.getClass().getName() + "_Child_items"));
				...
				UIComponentBase panelToAdd = null;
									java.util.List<org.sblim.wbemsmt.ajax.panel.AjaxPanelGroup> ajaxPanels = new java.util.ArrayList<org.sblim.wbemsmt.ajax.panel.AjaxPanelGroup>();
            		org.sblim.wbemsmt.ajax.panel.AjaxPanelGroup ajaxPanelGroup = 
						(org.sblim.wbemsmt.ajax.panel.AjaxPanelGroup)FacesContext.getCurrentInstance().getApplication().createComponent(org.sblim.wbemsmt.ajax.panel.AjaxPanelGroup.COMPONENT_TYPE);
            		...
            		ajaxPanelGroup.setValueExpression("periodicalUpdate", BeanNameConstants.OBJECT_ACTION_CONTROLLER.asValueExpression(FacesContext.getCurrentInstance(), "#'{'{0}.updateInterval[''" + key + "'']'}'"));
            		ajaxPanelGroup.getChildren().add(containerPanel);	
					ajaxPanelGroup.setId(org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputComponent.asJsfId(container.getClass().getName()));
          ...
          throw new WbemsmtException(WbemsmtException.ERR_FAILED,"Cannot process Event with listener " + getClass().getName(),e);
      		} 
   }

...
public class ChangeVMSettingsListener extends TaskLauncherContextMenuEventListenerImpl {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("VM", "ChangeVMSettingsListener");
        ...
        selector.select(treeNode, adapter, "ChangeVMSettings");

        if (selector.execute()) {
            adapter = (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter) selector.getAdapter();

            org.sblim.wbemsmt.vm.wizard.jsf.ChangeVMSettingsWizard wizard = new org.sblim.wbemsmt.vm.wizard.jsf.ChangeVMSettingsWizard(
                    adapter);

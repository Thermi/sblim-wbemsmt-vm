/**
 * CreateMigrationListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class CreateMigrationListener extends TaskLauncherContextMenuEventListenerImpl {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("VM", "CreateMigrationListener");
        ...
        selector.select(treeNode, adapter, "CreateMigration");

        if (selector.execute()) {
            adapter = (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter) selector.getAdapter();

            org.sblim.wbemsmt.vm.wizard.jsf.MigrationWizard wizard = new org.sblim.wbemsmt.vm.wizard.jsf.MigrationWizard(
                    adapter);

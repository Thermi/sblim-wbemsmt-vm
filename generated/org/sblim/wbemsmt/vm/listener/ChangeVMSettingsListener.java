/**
 * ChangeVMSettingsListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class ChangeVMSettingsListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.CreateListener {

    String jsfListener = "org.sblim.wbemsmt.vm.listener.jsf.ChangeVMSettingsListener";
    String swingListener = "org.sblim.wbemsmt.vm.listener.jswing.ChangeVMSettingsListener";

    //String cmdListener = "org.sblim.wbemsmt.vm.listener.cli.ChangeVMSettingsListener";

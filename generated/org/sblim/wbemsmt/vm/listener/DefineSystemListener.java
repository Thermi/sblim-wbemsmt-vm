/**
 * DefineSystemListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
...
public class DefineSystemListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.CreateListener {

    String jsfListener = "org.sblim.wbemsmt.vm.listener.jsf.DefineSystemListener";
    String swingListener = "org.sblim.wbemsmt.vm.listener.jswing.DefineSystemListener";

    //String cmdListener = "org.sblim.wbemsmt.vm.listener.cli.DefineSystemListener";

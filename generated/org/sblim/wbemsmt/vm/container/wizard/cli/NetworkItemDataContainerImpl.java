...
public class NetworkItemDataContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.vm.container.wizard.NetworkItemDataContainer {
    ...
    public NetworkItemDataContainerImpl(AbstractBaseCimAdapter adapter) throws WbemsmtException {
        super();
        setAdapter(adapter);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_Field1() {
        if (ic_usr_Field1 == null) {
            ...
            ic_usr_Field1 = new org.sblim.wbemsmt.tools.input.test.LabeledTestGenericDataComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_Field2() {
        if (ic_usr_Field2 == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.cli.GenericFieldDataConverter();
            ic_usr_Field2 = new org.sblim.wbemsmt.tools.input.test.LabeledTestGenericDataComponent(
                    this, label, null, converter);
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_Field3() {
        if (ic_usr_Field3 == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.cli.GenericFieldDataConverter();
            ic_usr_Field3 = new org.sblim.wbemsmt.tools.input.test.LabeledTestGenericDataComponent(
                    this, label, null, converter);
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_Field4() {
        if (ic_usr_Field4 == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.cli.GenericFieldDataConverter();
            ic_usr_Field4 = new org.sblim.wbemsmt.tools.input.test.LabeledTestGenericDataComponent(
                    this, label, null, converter);
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Remove() {
        if (ic_usr_Remove == null) {
            ...
            ic_usr_Remove = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "NetworkItemDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            ...
            if (get_usr_Remove().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_Remove())
                        .getValue();

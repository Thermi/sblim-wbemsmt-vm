...
public class DefineSystemCLISummaryConfigItemDataContainerImpl extends BaseDataContainer implements
    ...
    public DefineSystemCLISummaryConfigItemDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Userdefined() {
        if (ic_usr_Userdefined == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_Userdefined = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
                    this, label, null, converter);
        }
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DefineSystemCLISummaryConfigItemDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            ...
            if (get_usr_Userdefined().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_Userdefined())
                        .getValue();

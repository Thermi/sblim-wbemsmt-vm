...
public class CreateMigrationContainerPage2aImpl extends BaseDataContainer implements
    ...
    public CreateMigrationContainerPage2aImpl(AbstractBaseCimAdapter adapter)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_CimClientPreset() {
        if (ic_usr_CimClientPreset == null) {
            String label = getAdapter().getBundle().getString(
                    "CreateMigrationContainerPage2a.cimClientPreset");
            org.sblim.wbemsmt.tools.converter.StringArrayConverter converter = new org.sblim.wbemsmt.tools.converter.UnsignedInt16StringArrayConverter();
            ic_usr_CimClientPreset = new org.sblim.wbemsmt.tools.input.test.LabeledTestStringArrayComponent(
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "CreateMigrationContainerPage2a.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            if (get_usr_CimClientPreset().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_CimClientPreset())
                        .getValue();
                printStream.println(get_usr_CimClientPreset().getLabelText() + ": " + value);
            }
        }

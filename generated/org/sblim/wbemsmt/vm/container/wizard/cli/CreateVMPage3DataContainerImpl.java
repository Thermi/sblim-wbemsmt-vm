...
public class CreateVMPage3DataContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.vm.container.wizard.CreateVMPage3DataContainer
	{
	...
	public CreateVMPage3DataContainerImpl(AbstractBaseCimAdapter adapter) throws  WbemsmtException {
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_StartContainer() {
    		...
    		{
				String label = getAdapter().getBundle().getString("CreateVMPage3DataContainer.startContainer");
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("CreateVMPage3DataContainer.caption"));
		}

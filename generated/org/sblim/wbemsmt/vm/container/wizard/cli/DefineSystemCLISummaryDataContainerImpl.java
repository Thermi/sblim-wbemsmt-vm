...
public class DefineSystemCLISummaryDataContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.vm.container.wizard.DefineSystemCLISummaryDataContainer
	...
	public DefineSystemCLISummaryDataContainerImpl(AbstractBaseCimAdapter adapter) throws  WbemsmtException {
		super();
		setAdapter(adapter);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Memory() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DefineSystemCLISummaryDataContainer.memory");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Processor() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DefineSystemCLISummaryDataContainer.processor");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_StartAfterCreation() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DefineSystemCLISummaryDataContainer.startAfterCreation");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getConfigValuesHeader_usr_Name() {
    		if (icConfigValuesHeader_usr_Name == null)
    		{
			    ...
			    org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
    			icConfigValuesHeader_usr_Name = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,label,"",converter);
			}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getConfigValuesHeader_usr_CurrentValue() {
    		if (icConfigValuesHeader_usr_CurrentValue == null)
    		{
			    ...
			    org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
    			icConfigValuesHeader_usr_CurrentValue = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,label,"",converter);
			}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getConfigValuesHeader_usr_Userdefined() {
    		if (icConfigValuesHeader_usr_Userdefined == null)
    		{
			    ...
			    org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
    			icConfigValuesHeader_usr_Userdefined = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,label,"",converter);
			}
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("DefineSystemCLISummaryDataContainer.caption"));
		}
	...
	{
    		        		List<DefineSystemCLISummaryConfigItemDataContainer> listconfigValues = getConfigValues();
        		printStream.println();
        		printStream.println(getAdapter().getBundle().getString("DefineSystemCLISummaryDataContainer.role.configValues") + " " + getAdapter().getBundle().getString("items.found", new Object[]{new Integer(listconfigValues.size())}));
        		for (int i = 0; i < listconfigValues.size(); i++) {
        			BaseDataContainer child = (BaseDataContainer)listconfigValues.get(i);
        			printStream.println();
        			printStream.println(getAdapter().getBundle().getString("item") + ": " + (i+1) + " " + getAdapter().getBundle().getString("of") + " " + listconfigValues.size());

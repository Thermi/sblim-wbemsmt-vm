...
public class CreateMigrationContainerPage2bImpl extends BaseDataContainer implements
    ...
    public CreateMigrationContainerPage2bImpl(AbstractBaseCimAdapter adapter)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_MigrationTargetHostname() {
        if (ic_usr_MigrationTargetHostname == null) {
            String label = getAdapter().getBundle().getString(
                    "CreateMigrationContainerPage2b.migrationTargetHostname");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_MigrationTargetHostname = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_MigrationTargetPort() {
        if (ic_usr_MigrationTargetPort == null) {
            String label = getAdapter().getBundle().getString(
                    "CreateMigrationContainerPage2b.migrationTargetPort");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
            ic_usr_MigrationTargetPort = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
                    this, label, null, converter);
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_MigrationTargetNamespace() {
        if (ic_usr_MigrationTargetNamespace == null) {
            String label = getAdapter().getBundle().getString(
                    "CreateMigrationContainerPage2b.migrationTargetNamespace");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_MigrationTargetNamespace = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
                    this, label, null, converter);
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_MigrationTargetUser() {
        if (ic_usr_MigrationTargetUser == null) {
            String label = getAdapter().getBundle().getString(
                    "CreateMigrationContainerPage2b.migrationTargetUser");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_MigrationTargetUser = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
                    this, label, null, converter);
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_MigrationTargetPassword() {
        if (ic_usr_MigrationTargetPassword == null) {
            String label = getAdapter().getBundle().getString(
                    "CreateMigrationContainerPage2b.migrationTargetPassword");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_MigrationTargetPassword = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
                    this, label, null, converter);
        }
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "CreateMigrationContainerPage2b.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            if (get_usr_MigrationTargetHostname().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_MigrationTargetHostname())
                        .getValue();
                printStream
                        .println(get_usr_MigrationTargetHostname().getLabelText() + ": " + value);
            }
            if (get_usr_MigrationTargetPort().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_MigrationTargetPort())
                        .getValue();
                printStream.println(get_usr_MigrationTargetPort().getLabelText() + ": " + value);
            }
            if (get_usr_MigrationTargetNamespace().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_MigrationTargetNamespace())
                        .getValue();
                printStream.println(get_usr_MigrationTargetNamespace().getLabelText() + ": "
                        + value);
            }
            if (get_usr_MigrationTargetUser().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_MigrationTargetUser())
                        .getValue();
                printStream.println(get_usr_MigrationTargetUser().getLabelText() + ": " + value);
            }
            if (get_usr_MigrationTargetPassword().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_MigrationTargetPassword())
                        .getValue();
                printStream
                        .println(get_usr_MigrationTargetPassword().getLabelText() + ": " + value);
            }
        }

...
public class SummaryDiskItemDataContainerImpl extends BaseDataContainer implements
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Path() {
        if (ic_usr_Path == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_Path = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "SummaryDiskItemDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            ...
            if (get_usr_Path().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_Path())
                        .getValue();

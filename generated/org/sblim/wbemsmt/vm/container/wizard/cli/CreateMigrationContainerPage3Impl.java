...
public class CreateMigrationContainerPage3Impl extends BaseDataContainer implements org.sblim.wbemsmt.vm.container.wizard.CreateMigrationContainerPage3
	{
			private org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf ic_usr_PostMigrateState;
    	
		
	public CreateMigrationContainerPage3Impl(AbstractBaseCimAdapter adapter) throws  WbemsmtException {
		super();
		setAdapter(adapter);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_PostMigrateState() {
    		...
    		{
				String label = getAdapter().getBundle().getString("CreateMigrationContainerPage3.postMigrateState");
				org.sblim.wbemsmt.tools.converter.StringArrayConverter converter = new org.sblim.wbemsmt.tools.converter.UnsignedInt16StringArrayConverter();
    			ic_usr_PostMigrateState = new org.sblim.wbemsmt.tools.input.test.LabeledTestStringArrayComponent(this,label,null,converter);
    		}
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("CreateMigrationContainerPage3.caption"));
		}

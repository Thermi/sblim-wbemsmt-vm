...
public class ProcessorDataContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.vm.container.wizard.ProcessorDataContainer {
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Amount() {
        if (ic_usr_Amount == null) {
            ...
            ic_usr_Amount = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Default() {
        if (ic_usr_Default == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_Default = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,
                    label, null, converter);
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Weight() {
        if (ic_usr_Weight == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_Weight = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,
                    label, null, converter);
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Limit() {
        if (ic_usr_Limit == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_Limit = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,
                    label, null, converter);
        }
        return ic_usr_Limit;
    }
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle()
                    .getString("ProcessorDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            if (get_usr_Amount().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_Amount())
                        .getValue();
            ...
            if (get_usr_Default().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_Default())
                        .getValue();
                printStream.println(get_usr_Default().getLabelText() + ": " + value);
            }
            if (get_usr_Weight().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_Weight())
                        .getValue();
                printStream.println(get_usr_Weight().getLabelText() + ": " + value);
            }
            if (get_usr_Limit().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_Limit())
                        .getValue();

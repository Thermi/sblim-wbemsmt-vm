...
public class CreateVMPage2DataContainerImpl extends BaseDataContainer implements
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_ReferencedSystem() {
        if (ic_ReferencedSystem == null) {
            String label = getAdapter().getBundle().getString(
                    "CreateVMPage2DataContainer.referencedSystem");
            org.sblim.wbemsmt.tools.converter.StringArrayConverter converter = new org.sblim.wbemsmt.tools.converter.UnsignedInt16StringArrayConverter();
            ic_ReferencedSystem = new org.sblim.wbemsmt.tools.input.test.LabeledTestStringArrayComponent(
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "CreateVMPage2DataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            if (get_ReferencedSystem().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_ReferencedSystem())
                        .getValue();

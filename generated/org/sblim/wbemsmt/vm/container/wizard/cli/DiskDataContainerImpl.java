...
public class DiskDataContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.vm.container.wizard.DiskDataContainer
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getDisksHeader_usr_Field1() {
    		if (icDisksHeader_usr_Field1 == null)
    		{
    			...
    			icDisksHeader_usr_Field1 = new org.sblim.wbemsmt.tools.input.test.LabeledTestGenericDataComponent(this,label,"",converter);
			}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getDisksHeader_usr_Field2() {
    		if (icDisksHeader_usr_Field2 == null)
    		{
			    ...
			    org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.cli.GenericFieldDataConverter();
    			icDisksHeader_usr_Field2 = new org.sblim.wbemsmt.tools.input.test.LabeledTestGenericDataComponent(this,label,"",converter);
			}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getDisksHeader_usr_Field3() {
    		if (icDisksHeader_usr_Field3 == null)
    		{
			    ...
			    org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.cli.GenericFieldDataConverter();
    			icDisksHeader_usr_Field3 = new org.sblim.wbemsmt.tools.input.test.LabeledTestGenericDataComponent(this,label,"",converter);
			}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getDisksHeader_usr_Field4() {
    		if (icDisksHeader_usr_Field4 == null)
    		{
			    ...
			    org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.cli.GenericFieldDataConverter();
    			icDisksHeader_usr_Field4 = new org.sblim.wbemsmt.tools.input.test.LabeledTestGenericDataComponent(this,label,"",converter);
			}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getDisksHeader_usr_Remove() {
    		if (icDisksHeader_usr_Remove == null)
    		{
    			...
    			icDisksHeader_usr_Remove = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,label,"",converter);
			}
	...
	{
    		        		List<DiskItemDataContainer> listdisks = getDisks();
        		printStream.println();
        		printStream.println(getAdapter().getBundle().getString("DiskDataContainer.role.disks") + " " + getAdapter().getBundle().getString("items.found", new Object[]{new Integer(listdisks.size())}));

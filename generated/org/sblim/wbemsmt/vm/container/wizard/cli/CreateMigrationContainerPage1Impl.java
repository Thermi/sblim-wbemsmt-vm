...
public class CreateMigrationContainerPage1Impl extends BaseDataContainer implements org.sblim.wbemsmt.vm.container.wizard.CreateMigrationContainerPage1
	{
			private org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf ic_usr_PresetOrUserdefined;
    	
		
	public CreateMigrationContainerPage1Impl(AbstractBaseCimAdapter adapter) throws  WbemsmtException {
		super();
		setAdapter(adapter);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_PresetOrUserdefined() {
    		...
    		{
				String label = getAdapter().getBundle().getString("CreateMigrationContainerPage1.presetOrUserdefined");
				org.sblim.wbemsmt.tools.converter.StringArrayConverter converter = new org.sblim.wbemsmt.tools.converter.UnsignedInt16StringArrayConverter();
    			ic_usr_PresetOrUserdefined = new org.sblim.wbemsmt.tools.input.test.LabeledTestStringArrayComponent(this,label,null,converter);
    		}
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("CreateMigrationContainerPage1.caption"));
		}
		...
		if (showInstance(listOptions))
		{
   			...
   			{
        				Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf)get_usr_PresetOrUserdefined()).getValue();

...
public class ChangeVMSettingsSummaryDataContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.vm.container.wizard.ChangeVMSettingsSummaryDataContainer
	...
	public ChangeVMSettingsSummaryDataContainerImpl(AbstractBaseCimAdapter adapter) throws  WbemsmtException {
		super();
		setAdapter(adapter);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_System() {
    		...
    		{
				String label = getAdapter().getBundle().getString("ChangeVMSettingsSummaryDataContainer.system");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
    			ic_usr_System = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,label,null,converter);
    		}
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Hostsystem() {
    		...
    		{
				String label = getAdapter().getBundle().getString("ChangeVMSettingsSummaryDataContainer.hostsystem");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Processor() {
    		...
    		{
				String label = getAdapter().getBundle().getString("ChangeVMSettingsSummaryDataContainer.Processor");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Memory() {
    		if (ic_Memory == null)
    		{
				String label = getAdapter().getBundle().getString("ChangeVMSettingsSummaryDataContainer.Memory");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("ChangeVMSettingsSummaryDataContainer.caption"));
		}
		...
		{
			   			   			if (get_usr_System().isVisible())
   			{
        				Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf)get_usr_System()).getValue();
        				printStream.println(get_usr_System().getLabelText() + ": " + value);
   			}
	...
	public void traceChilds(java.io.PrintWriter printStream, String listOptions, boolean title)
	{
        		...
        		printStream.println();
        		printStream.println(getAdapter().getBundle().getString("ChangeVMSettingsSummaryDataContainer.role.configItems") + " " + getAdapter().getBundle().getString("items.found", new Object[]{new Integer(listconfigItems.size())}));
        		...
        		printStream.println();
        		printStream.println(getAdapter().getBundle().getString("ChangeVMSettingsSummaryDataContainer.role.disks") + " " + getAdapter().getBundle().getString("items.found", new Object[]{new Integer(listdisks.size())}));
        		...
        		printStream.println();
        		printStream.println(getAdapter().getBundle().getString("ChangeVMSettingsSummaryDataContainer.role.networks") + " " + getAdapter().getBundle().getString("items.found", new Object[]{new Integer(listnetworks.size())}));

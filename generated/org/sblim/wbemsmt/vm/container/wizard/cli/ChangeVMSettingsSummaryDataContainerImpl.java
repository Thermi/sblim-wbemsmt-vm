...
public class ChangeVMSettingsSummaryDataContainerImpl extends BaseDataContainer implements
    ...
    public ChangeVMSettingsSummaryDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_System() {
        if (ic_usr_System == null) {
            String label = getAdapter().getBundle().getString(
                    "ChangeVMSettingsSummaryDataContainer.system");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_System = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Hostsystem() {
        if (ic_usr_Hostsystem == null) {
            String label = getAdapter().getBundle().getString(
                    "ChangeVMSettingsSummaryDataContainer.hostsystem");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Processor() {
        if (ic_Processor == null) {
            String label = getAdapter().getBundle().getString(
                    "ChangeVMSettingsSummaryDataContainer.Processor");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Memory() {
        if (ic_Memory == null) {
            String label = getAdapter().getBundle().getString(
                    "ChangeVMSettingsSummaryDataContainer.Memory");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "ChangeVMSettingsSummaryDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            if (get_usr_System().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_System())
                        .getValue();
    ...
    public void traceChilds(java.io.PrintWriter printStream, String listOptions, boolean title) {
        ...
        printStream.println();
        printStream.println(getAdapter().getBundle().getString(
                "ChangeVMSettingsSummaryDataContainer.role.configItems")
                + " "
        ...
        printStream.println();
        printStream.println(getAdapter().getBundle().getString(
                "ChangeVMSettingsSummaryDataContainer.role.disks")
                + " "
                + getAdapter().getBundle().getString("items.found",
        ...
        printStream.println();
        printStream.println(getAdapter().getBundle().getString(
                "ChangeVMSettingsSummaryDataContainer.role.networks")
                + " "
                + getAdapter().getBundle().getString("items.found",

...
public class CreateMigrationContainerSummaryImpl extends BaseDataContainer implements
    ...
    public CreateMigrationContainerSummaryImpl(AbstractBaseCimAdapter adapter)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Container() {
        if (ic_usr_Container == null) {
            String label = getAdapter().getBundle().getString(
                    "CreateMigrationContainerSummary.container");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_Container = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Targetsystem() {
        if (ic_usr_Targetsystem == null) {
            String label = getAdapter().getBundle().getString(
                    "CreateMigrationContainerSummary.targetsystem");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_Targetsystem = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
                    this, label, null, converter);
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_PostMigrateState() {
        if (ic_usr_PostMigrateState == null) {
            String label = getAdapter().getBundle().getString(
                    "CreateMigrationContainerSummary.postMigrateState");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_PostMigrateState = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
                    this, label, null, converter);
        }
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "CreateMigrationContainerSummary.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            if (get_usr_Container().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_Container())
                        .getValue();
                printStream.println(get_usr_Container().getLabelText() + ": " + value);
            }
            if (get_usr_Targetsystem().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_Targetsystem())
                        .getValue();

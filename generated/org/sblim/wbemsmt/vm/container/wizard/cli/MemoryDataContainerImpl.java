...
public class MemoryDataContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.vm.container.wizard.MemoryDataContainer {
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Size() {
        if (ic_usr_Size == null) {
            ...
            ic_usr_Size = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        ...
        if (showInstance(listOptions)) {
            if (get_usr_Size().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_Size())
                        .getValue();

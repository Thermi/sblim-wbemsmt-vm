...
public class CreateMigrationContainerPage3Impl extends
    ...
    public CreateMigrationContainerPage3Impl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "CreateMigrationContainerPage3.caption",
                "CreateMigrationContainerPage3.subTitle", false);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_PostMigrateState() {
        if (ic_usr_PostMigrateState == null) {
            ...
            ic_usr_PostMigrateState = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFRadioButtonComponent(
    ...
    public void reload() {
        ...
        if (ic_usr_PostMigrateState != null) {
            ic_usr_PostMigrateState.setLabelText(bundle
                    .getString("CreateMigrationContainerPage3.postMigrateState"));
        }
    }

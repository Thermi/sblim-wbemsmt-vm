...
public class NetworkDataContainerImpl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel
        implements org.sblim.wbemsmt.vm.container.wizard.NetworkDataContainer,
    ...
    public NetworkDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "NetworkDataContainer.caption",
                "NetworkDataContainer.subTitle", false);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_Networks() {
        if (ic_usr_Networks == null) {
            ...
            ic_usr_Networks = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFComboBoxComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Add() {
        if (ic_usr_Add == null) {
            ...
            String binding = bindingPrefix + "_usr_Add.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Add = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(parent, label,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Remove() {
        if (ic_usr_Remove == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Remove = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(parent, label,
                    binding, converter, readOnly);
            ;
        }
    ...
    public MultiLinePanel getNetworksPanel() {
        if (networksPanel == null) {
            networksPanel = new NetworksPanel(adapter,
    ...
    private void addNetworks(
            org.sblim.wbemsmt.vm.container.wizard.jsf.NetworkItemDataContainer_AsNetworks_InNetworkDataContainerImpl child) {
    ...
    public java.util.List getNetworksForUI() {
        ...
        while (result.size() < MIN_TABLE_LENGTH) {
            try {
                org.sblim.wbemsmt.vm.container.wizard.jsf.NetworkItemDataContainer_AsNetworks_InNetworkDataContainerImpl item = new org.sblim.wbemsmt.vm.container.wizard.jsf.NetworkItemDataContainer_AsNetworks_InNetworkDataContainerImpl(
    ...
    private String[] getNetworksFieldNames() {
        return new String[] { "_usr_Field1", "_usr_Field2", "_usr_Field3", "_usr_Field4",
                "_usr_Remove", };
    }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getNetworksHeader_usr_Field1() {
        if (icNetworksHeader_usr_Field1 == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icNetworksHeader_usr_Field1 = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icNetworksHeader_usr_Field1)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getNetworksHeader_usr_Field2() {
        if (icNetworksHeader_usr_Field2 == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icNetworksHeader_usr_Field2 = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icNetworksHeader_usr_Field2)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
        ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icNetworksHeader_usr_Field2)
                .setHeader(true);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getNetworksHeader_usr_Field3() {
        if (icNetworksHeader_usr_Field3 == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icNetworksHeader_usr_Field3 = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icNetworksHeader_usr_Field3)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
        ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icNetworksHeader_usr_Field3)
                .setHeader(true);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getNetworksHeader_usr_Field4() {
        if (icNetworksHeader_usr_Field4 == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icNetworksHeader_usr_Field4 = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icNetworksHeader_usr_Field4)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
        ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icNetworksHeader_usr_Field4)
                .setHeader(true);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getNetworksHeader_usr_Remove() {
        if (icNetworksHeader_usr_Remove == null) {
            ...
            String binding = bindingPrefix + "networksHeader_usr_Remove.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icNetworksHeader_usr_Remove = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent) icNetworksHeader_usr_Remove)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
        ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent) icNetworksHeader_usr_Remove)
                .setHeader(true);
    ...
    public void countAndCreateChildren() throws WbemsmtException {
        ...
        try {
            int count = adapter.count("networks",
                    org.sblim.wbemsmt.vm.container.wizard.NetworkItemDataContainer.class, this);
            if (count != networksCount) {
                networksCount = count;
                clearNetworks();
                for (int i = 0; i < count; i++) {
                    addNetworks(new org.sblim.wbemsmt.vm.container.wizard.jsf.NetworkItemDataContainer_AsNetworks_InNetworkDataContainerImpl(
                            (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter) adapter, bindingPrefix,
                            i));
                }
            }

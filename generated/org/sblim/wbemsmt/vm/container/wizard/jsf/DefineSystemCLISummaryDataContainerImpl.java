...
public class DefineSystemCLISummaryDataContainerImpl extends
    ...
    public DefineSystemCLISummaryDataContainerImpl(
            org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter, String bindingPrefix)
            throws WbemsmtException {

        super(adapter, bindingPrefix, "DefineSystemCLISummaryDataContainer.caption",
                "DefineSystemCLISummaryDataContainer.subTitle", false);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Memory() {
        if (ic_usr_Memory == null) {
            ...
            ic_usr_Memory = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Processor() {
        if (ic_usr_Processor == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Processor = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_StartAfterCreation() {
        if (ic_usr_StartAfterCreation == null) {
            String label = bundle
                    .getString("DefineSystemCLISummaryDataContainer.startAfterCreation");
            String binding = bindingPrefix + "_usr_StartAfterCreation.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_StartAfterCreation = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public MultiLinePanel getConfigValuesPanel() {
        if (configValuesPanel == null) {
            configValuesPanel = new ConfigValuesPanel(
                    adapter,
                    bindingPrefix, // the prefix for binding values
                    "#{" + bindingPrefix + "configValuesPanel", // binding for Title
    ...
    static class ConfigValuesPanel extends MultiLinePanel {
        public ConfigValuesPanel(AbstractBaseCimAdapter adapter, String bindingPrefix,
                String bindigForTitle, String keyForTitle, int cols) {
            super(adapter, bindingPrefix, bindigForTitle, keyForTitle, "configValues", cols);
        }
    ...
    private void addConfigValues(
            org.sblim.wbemsmt.vm.container.wizard.jsf.DefineSystemCLISummaryConfigItemDataContainer_AsConfigValues_InDefineSystemCLISummaryDataContainerImpl child) {
     ...
     */
    public java.util.List getConfigValuesForUI() {
        ...
        while (result.size() < MIN_TABLE_LENGTH) {
            try {
                org.sblim.wbemsmt.vm.container.wizard.jsf.DefineSystemCLISummaryConfigItemDataContainer_AsConfigValues_InDefineSystemCLISummaryDataContainerImpl item = new org.sblim.wbemsmt.vm.container.wizard.jsf.DefineSystemCLISummaryConfigItemDataContainer_AsConfigValues_InDefineSystemCLISummaryDataContainerImpl(
    ...
    public String getConfigValuesFooterClass() {
        return "multiLineRowHeader center "
                + (icConfigValues.size() == 0 || getConfigValuesPanel().isHavingCustomFooter() ? "visible "
                        : "hidden ");
    }
    ...
    private void addConfigValuesHeader() {
        getConfigValuesPanel().setHeader(getConfigValuesHeaderComponents(),
                getConfigValuesFieldNames());
    }
    ...
    private String[] getConfigValuesFieldNames() {
        return new String[] { "_usr_Name", "_usr_CurrentValue", "_usr_Userdefined", };
    }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getConfigValuesHeader_usr_Name() {
        if (icConfigValuesHeader_usr_Name == null) {
            ...
            String binding = bindingPrefix + "configValuesHeader_usr_Name.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icConfigValuesHeader_usr_Name = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) icConfigValuesHeader_usr_Name)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getConfigValuesHeader_usr_CurrentValue() {
        if (icConfigValuesHeader_usr_CurrentValue == null) {
            String label = bundle
                    .getString("DefineSystemCLISummaryConfigItemDataContainer.currentValue");
            String binding = bindingPrefix + "configValuesHeader_usr_CurrentValue.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icConfigValuesHeader_usr_CurrentValue = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) icConfigValuesHeader_usr_CurrentValue)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
        ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) icConfigValuesHeader_usr_CurrentValue)
                .setHeader(true);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getConfigValuesHeader_usr_Userdefined() {
        if (icConfigValuesHeader_usr_Userdefined == null) {
            String label = bundle
                    .getString("DefineSystemCLISummaryConfigItemDataContainer.userdefined");
            String binding = bindingPrefix + "configValuesHeader_usr_Userdefined.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icConfigValuesHeader_usr_Userdefined = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent) icConfigValuesHeader_usr_Userdefined)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
        ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent) icConfigValuesHeader_usr_Userdefined)
                .setHeader(true);
    ...
    public void reload() {
        super.reload();
        if (ic_usr_Memory != null) {
            ic_usr_Memory.setLabelText(bundle
                    .getString("DefineSystemCLISummaryDataContainer.memory"));
        }
        if (ic_usr_Processor != null) {
            ic_usr_Processor.setLabelText(bundle
                    .getString("DefineSystemCLISummaryDataContainer.processor"));
        }
        if (ic_usr_StartAfterCreation != null) {
        ...
        try {
            ...
            if (count != configValuesCount) {
                ...
                for (int i = 0; i < count; i++) {
                    addConfigValues(new org.sblim.wbemsmt.vm.container.wizard.jsf.DefineSystemCLISummaryConfigItemDataContainer_AsConfigValues_InDefineSystemCLISummaryDataContainerImpl(
                            (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter) adapter, bindingPrefix,
                            i));
                }
            }

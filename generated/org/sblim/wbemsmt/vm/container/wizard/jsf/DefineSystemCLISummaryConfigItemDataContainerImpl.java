...
public class DefineSystemCLISummaryConfigItemDataContainerImpl extends
    ...
    public DefineSystemCLISummaryConfigItemDataContainerImpl(
            org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter, String bindingPrefix)
            throws WbemsmtException {

        super(adapter, bindingPrefix, "DefineSystemCLISummaryConfigItemDataContainer.caption",
                false);
        ...
        setFooter(getPanelForCustomLayout(),
                "DefineSystemCLISummaryConfigItemDataContainer.footerText");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_CurrentValue() {
        if (ic_usr_CurrentValue == null) {
            ...
            String binding = bindingPrefix + "_usr_CurrentValue.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Userdefined() {
        if (ic_usr_Userdefined == null) {
            ...
            String binding = bindingPrefix + "_usr_Userdefined.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;

...
public class CreateVMPage3DataContainerImpl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel implements org.sblim.wbemsmt.vm.container.wizard.CreateVMPage3DataContainer
	{
	...
	public CreateVMPage3DataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "CreateVMPage3DataContainer.caption","CreateVMPage3DataContainer.subTitle",false);
	...
	public void reload()
	{
		super.reload();
	    		if (ic_usr_StartContainer != null)
    		{
				ic_usr_StartContainer.setLabelText(bundle.getString("CreateVMPage3DataContainer.startContainer"));
    		}
		}

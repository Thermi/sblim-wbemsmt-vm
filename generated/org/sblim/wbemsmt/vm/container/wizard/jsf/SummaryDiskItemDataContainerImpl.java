...
public class SummaryDiskItemDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.vm.container.wizard.SummaryDiskItemDataContainer
	{
	...
	public SummaryDiskItemDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "SummaryDiskItemDataContainer.caption",false);
        	        		...
        	        		addComponent((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputComponent)get_usr_Path());
		...
		setFooter(getPanelForCustomLayout(),"SummaryDiskItemDataContainer.footerText");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Path() {
    		if (ic_usr_Path == null)
    		{
				...
				String binding = expressionPrefix + "_usr_Path.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;

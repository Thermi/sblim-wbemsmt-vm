...
public class CreateMigrationContainerPage2bImpl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel implements org.sblim.wbemsmt.vm.container.wizard.CreateMigrationContainerPage2b
	{
	...
	public CreateMigrationContainerPage2bImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "CreateMigrationContainerPage2b.caption","CreateMigrationContainerPage2b.subTitle",false);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_MigrationTargetHostname() {
    		...
    		{
				String label = bundle.getString("CreateMigrationContainerPage2b.migrationTargetHostname");
				String binding = expressionPrefix + "_usr_MigrationTargetHostname.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
    			ic_usr_MigrationTargetHostname = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(parent,label,binding,converter, readOnly);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_MigrationTargetPort() {
    		if (ic_usr_MigrationTargetPort == null)
    		{
				...
				String binding = expressionPrefix + "_usr_MigrationTargetPort.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
				boolean readOnly = false;
    			ic_usr_MigrationTargetPort = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(parent,label,binding,converter, readOnly);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_MigrationTargetNamespace() {
    		...
    		{
				String label = bundle.getString("CreateMigrationContainerPage2b.migrationTargetNamespace");
				String binding = expressionPrefix + "_usr_MigrationTargetNamespace.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
    			ic_usr_MigrationTargetNamespace = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(parent,label,binding,converter, readOnly);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_MigrationTargetUser() {
    		if (ic_usr_MigrationTargetUser == null)
    		{
				...
				String binding = expressionPrefix + "_usr_MigrationTargetUser.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
    			ic_usr_MigrationTargetUser = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(parent,label,binding,converter, readOnly);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_MigrationTargetPassword() {
    		...
    		{
				String label = bundle.getString("CreateMigrationContainerPage2b.migrationTargetPassword");
				String binding = expressionPrefix + "_usr_MigrationTargetPassword.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
    			ic_usr_MigrationTargetPassword = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFPasswordFieldComponent(parent,label,binding,converter, readOnly);
	...
	public void reload()
	{
		super.reload();
	    		if (ic_usr_MigrationTargetHostname != null)
    		{
				ic_usr_MigrationTargetHostname.setLabelText(bundle.getString("CreateMigrationContainerPage2b.migrationTargetHostname"));
    		}
	    		if (ic_usr_MigrationTargetPort != null)
    		{
				ic_usr_MigrationTargetPort.setLabelText(bundle.getString("CreateMigrationContainerPage2b.migrationTargetPort"));
    		}
	    		if (ic_usr_MigrationTargetNamespace != null)
    		{
				ic_usr_MigrationTargetNamespace.setLabelText(bundle.getString("CreateMigrationContainerPage2b.migrationTargetNamespace"));
    		}
	    		if (ic_usr_MigrationTargetUser != null)
    		{
				ic_usr_MigrationTargetUser.setLabelText(bundle.getString("CreateMigrationContainerPage2b.migrationTargetUser"));
    		}
	    		if (ic_usr_MigrationTargetPassword != null)
    		{
				ic_usr_MigrationTargetPassword.setLabelText(bundle.getString("CreateMigrationContainerPage2b.migrationTargetPassword"));
    		}
		}

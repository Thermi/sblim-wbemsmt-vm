...
public class CreateVMPage2DataContainerImpl extends
        org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel implements
        org.sblim.wbemsmt.vm.container.wizard.CreateVMPage2DataContainer {
    private org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf ic_ReferencedSystem;

    public CreateVMPage2DataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "CreateVMPage2DataContainer.caption",
                "CreateVMPage2DataContainer.subTitle", false);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_ReferencedSystem() {
        if (ic_ReferencedSystem == null) {
            ...
            String binding = bindingPrefix + "_ReferencedSystem.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
            boolean readOnly = false;
            ic_ReferencedSystem = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFComboBoxComponent(
    ...
    public void reload() {
        super.reload();
        if (ic_ReferencedSystem != null) {
            ic_ReferencedSystem.setLabelText(bundle
                    .getString("CreateVMPage2DataContainer.referencedSystem"));
        }
    }

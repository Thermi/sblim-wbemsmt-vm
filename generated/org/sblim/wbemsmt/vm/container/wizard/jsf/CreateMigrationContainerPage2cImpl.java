...
public class CreateMigrationContainerPage2cImpl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel implements org.sblim.wbemsmt.vm.container.wizard.CreateMigrationContainerPage2c
	{
	...
	public CreateMigrationContainerPage2cImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "CreateMigrationContainerPage2c.caption","CreateMigrationContainerPage2c.subTitle",false);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_TargetHost() {
    		if (ic_usr_TargetHost == null)
    		{
				...
				String binding = expressionPrefix + "_usr_TargetHost.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
    			ic_usr_TargetHost = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(parent,label,binding,converter, readOnly);
				;
    		}
	...
	public void reload()
	{
		super.reload();
	    		if (ic_usr_TargetHost != null)
    		{
				ic_usr_TargetHost.setLabelText(bundle.getString("CreateMigrationContainerPage2c.targetHost"));
    		}
		}

...
public class NetworkItemDataContainer_AsNetworks_InNetworkDataContainerImpl extends
    ...
    public NetworkItemDataContainer_AsNetworks_InNetworkDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Remove() {
        if (ic_usr_Remove == null) {
            ...
            String binding = bindingPrefix + "networks[" + index + "]._usr_Remove.item";
            logger.fine("Using binding " + binding);
            DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;

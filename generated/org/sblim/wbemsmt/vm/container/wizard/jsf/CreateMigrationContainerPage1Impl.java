...
public class CreateMigrationContainerPage1Impl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel implements org.sblim.wbemsmt.vm.container.wizard.CreateMigrationContainerPage1
	{
	...
	public CreateMigrationContainerPage1Impl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "CreateMigrationContainerPage1.caption","CreateMigrationContainerPage1.subTitle",false);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_PresetOrUserdefined() {
    		if (ic_usr_PresetOrUserdefined == null)
    		{
				...
				String binding = expressionPrefix + "_usr_PresetOrUserdefined.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
				boolean readOnly = false;
    			ic_usr_PresetOrUserdefined = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFRadioButtonComponent(parent,label,binding,converter, readOnly);
	...
	public void reload()
	{
		super.reload();
	    		if (ic_usr_PresetOrUserdefined != null)
    		{
				ic_usr_PresetOrUserdefined.setLabelText(bundle.getString("CreateMigrationContainerPage1.presetOrUserdefined"));
    		}
		}

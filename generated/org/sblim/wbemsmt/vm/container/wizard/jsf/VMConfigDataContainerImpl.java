...
public class VMConfigDataContainerImpl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel
        implements org.sblim.wbemsmt.vm.container.wizard.VMConfigDataContainer,
    ...
    public VMConfigDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,
        ...
        super(adapter, bindingPrefix, "VMConfigDataContainer.caption",
                "VMConfigDataContainer.subTitle", false);
    ...
    private void addItems(
            org.sblim.wbemsmt.vm.container.wizard.jsf.ConfigItemDataContainer_AsItems_InVMConfigDataContainerImpl child) {
    ...
    public java.util.List getItemsForUI() {
        ...
        while (result.size() < MIN_TABLE_LENGTH) {
            try {
                org.sblim.wbemsmt.vm.container.wizard.jsf.ConfigItemDataContainer_AsItems_InVMConfigDataContainerImpl item = new org.sblim.wbemsmt.vm.container.wizard.jsf.ConfigItemDataContainer_AsItems_InVMConfigDataContainerImpl(
    ...
    private String[] getItemsFieldNames() {
        return new String[] { "_usr_Name", "_usr_CurrentValue", "_usr_Info", };
    }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_usr_CurrentValue() {
        if (icItemsHeader_usr_CurrentValue == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icItemsHeader_usr_CurrentValue = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icItemsHeader_usr_CurrentValue)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
        ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icItemsHeader_usr_CurrentValue)
                .setHeader(true);
    ...
    public void countAndCreateChildren() throws WbemsmtException {
        ...
        try {
            int count = adapter.count("items",
                    org.sblim.wbemsmt.vm.container.wizard.ConfigItemDataContainer.class, this);
            if (count != itemsCount) {
                itemsCount = count;
                clearItems();
                for (int i = 0; i < count; i++) {
                    addItems(new org.sblim.wbemsmt.vm.container.wizard.jsf.ConfigItemDataContainer_AsItems_InVMConfigDataContainerImpl(
                            (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter) adapter, bindingPrefix,
                            i));
                }
            }

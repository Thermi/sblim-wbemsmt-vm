...
public class CreateMigrationContainerSummaryImpl extends
        org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel implements
        org.sblim.wbemsmt.vm.container.wizard.CreateMigrationContainerSummary {
    ...
    public CreateMigrationContainerSummaryImpl(
            org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter, String bindingPrefix)
            throws WbemsmtException {

        super(adapter, bindingPrefix, "CreateMigrationContainerSummary.caption",
                "CreateMigrationContainerSummary.subTitle", false);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Container() {
        if (ic_usr_Container == null) {
            ...
            String binding = bindingPrefix + "_usr_Container.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Container = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Targetsystem() {
        if (ic_usr_Targetsystem == null) {
            ...
            String binding = bindingPrefix + "_usr_Targetsystem.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Targetsystem = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_PostMigrateState() {
        if (ic_usr_PostMigrateState == null) {
            ...
            String binding = bindingPrefix + "_usr_PostMigrateState.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_PostMigrateState = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public void reload() {
        super.reload();
        if (ic_usr_Container != null) {
            ic_usr_Container.setLabelText(bundle
                    .getString("CreateMigrationContainerSummary.container"));
        }
        if (ic_usr_Targetsystem != null) {
            ic_usr_Targetsystem.setLabelText(bundle
                    .getString("CreateMigrationContainerSummary.targetsystem"));
        }
        if (ic_usr_PostMigrateState != null) {
            ic_usr_PostMigrateState.setLabelText(bundle
                    .getString("CreateMigrationContainerSummary.postMigrateState"));
        }
    }

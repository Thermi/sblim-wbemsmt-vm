...
public class CreateMigrationContainerPage2aImpl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel implements org.sblim.wbemsmt.vm.container.wizard.CreateMigrationContainerPage2a
	{
	...
	public CreateMigrationContainerPage2aImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "CreateMigrationContainerPage2a.caption","CreateMigrationContainerPage2a.subTitle",false);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_CimClientPreset() {
    		if (ic_usr_CimClientPreset == null)
    		{
				...
				String binding = expressionPrefix + "_usr_CimClientPreset.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
				boolean readOnly = false;
    			ic_usr_CimClientPreset = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFComboBoxComponent(parent,label,binding,converter, readOnly);
				;
    		}
	...
	public void reload()
	{
		super.reload();
	    		if (ic_usr_CimClientPreset != null)
    		{
				ic_usr_CimClientPreset.setLabelText(bundle.getString("CreateMigrationContainerPage2a.cimClientPreset"));
    		}
		}

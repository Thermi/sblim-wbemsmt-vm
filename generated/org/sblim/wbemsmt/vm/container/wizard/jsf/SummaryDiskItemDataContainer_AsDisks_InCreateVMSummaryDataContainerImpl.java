/** 
  * SummaryDiskItemDataContainer_AsDisks_InCreateVMSummaryDataContainerImpl.java
  *
  * 
...
public class SummaryDiskItemDataContainer_AsDisks_InCreateVMSummaryDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.MultiLineBasePanel2 implements org.sblim.wbemsmt.vm.container.wizard.SummaryDiskItemDataContainer {
	...
	public SummaryDiskItemDataContainer_AsDisks_InCreateVMSummaryDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,String expressionPrefix,int index) throws WbemsmtException {
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_FromPool() {
    		if (ic_usr_FromPool == null)
    		{
				...
				String binding = expressionPrefix + "disks["+ index +"]._usr_FromPool.item";
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Path() {
    		if (ic_usr_Path == null)
    		{
				...
				String binding = expressionPrefix + "disks["+ index +"]._usr_Path.item";
				logger.fine("Using binding " + binding);
				DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
    			ic_usr_Path = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,label,binding,converter, readOnly);
				;
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent)ic_usr_Path).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );
    		}
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Field1() {
    		if (ic_usr_Field1 == null)
    		{
				...
				String binding = expressionPrefix + "disks["+ index +"]._usr_Field1.item";
				logger.fine("Using binding " + binding);
				DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Field2() {
    		if (ic_usr_Field2 == null)
    		{
				...
				String binding = expressionPrefix + "disks["+ index +"]._usr_Field2.item";
				logger.fine("Using binding " + binding);
				DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Field3() {
    		if (ic_usr_Field3 == null)
    		{
				...
				String binding = expressionPrefix + "disks["+ index +"]._usr_Field3.item";
				logger.fine("Using binding " + binding);
				DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Field4() {
    		if (ic_usr_Field4 == null)
    		{
				...
				String binding = expressionPrefix + "disks["+ index +"]._usr_Field4.item";
				logger.fine("Using binding " + binding);
				DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
	...
	{
	    		       SummaryDiskItemDataContainer_AsDisks_InCreateVMSummaryDataContainerImpl source = (SummaryDiskItemDataContainer_AsDisks_InCreateVMSummaryDataContainerImpl)sourceContainer;

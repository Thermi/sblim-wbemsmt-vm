...
public class MemoryDataContainerImpl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel
        implements org.sblim.wbemsmt.vm.container.wizard.MemoryDataContainer {
    ...
    public MemoryDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "MemoryDataContainer.caption",
                "MemoryDataContainer.subTitle", false);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Size() {
        if (ic_usr_Size == null) {
            ...
            String binding = bindingPrefix + "_usr_Size.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Size = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(

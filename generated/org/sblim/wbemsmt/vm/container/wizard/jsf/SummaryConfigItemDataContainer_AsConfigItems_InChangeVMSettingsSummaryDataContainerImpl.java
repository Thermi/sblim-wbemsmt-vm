...
public class SummaryConfigItemDataContainer_AsConfigItems_InChangeVMSettingsSummaryDataContainerImpl
    ...
    public SummaryConfigItemDataContainer_AsConfigItems_InChangeVMSettingsSummaryDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Name() {
        if (ic_usr_Name == null) {
            ...
            String binding = bindingPrefix + "configItems[" + index + "]._usr_Name.item";
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_CurrentValue() {
        if (ic_usr_CurrentValue == null) {
            ...
            String binding = bindingPrefix + "configItems[" + index + "]._usr_CurrentValue.item";
            logger.fine("Using binding " + binding);
            DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
    ...
    public void reload() {
        ...
        if (ic_usr_CurrentValue != null) {
            ic_usr_CurrentValue.setLabelText(bundle
                    .getString("SummaryConfigItemDataContainer.currentValue"));
        }
    }

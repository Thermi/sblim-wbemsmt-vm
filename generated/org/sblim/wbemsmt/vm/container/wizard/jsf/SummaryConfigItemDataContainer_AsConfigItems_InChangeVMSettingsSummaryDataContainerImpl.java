/** 
  * SummaryConfigItemDataContainer_AsConfigItems_InChangeVMSettingsSummaryDataContainerImpl.java
  *
  * 
...
public class SummaryConfigItemDataContainer_AsConfigItems_InChangeVMSettingsSummaryDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.MultiLineBasePanel2 implements org.sblim.wbemsmt.vm.container.wizard.SummaryConfigItemDataContainer {
	...
	public SummaryConfigItemDataContainer_AsConfigItems_InChangeVMSettingsSummaryDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,String expressionPrefix,int index) throws WbemsmtException {
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Name() {
    		if (ic_usr_Name == null)
    		{
				...
				String binding = expressionPrefix + "configItems["+ index +"]._usr_Name.item";
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_CurrentValue() {
    		if (ic_usr_CurrentValue == null)
    		{
				...
				String binding = expressionPrefix + "configItems["+ index +"]._usr_CurrentValue.item";
				logger.fine("Using binding " + binding);
				DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
	...
	{
	    		       SummaryConfigItemDataContainer_AsConfigItems_InChangeVMSettingsSummaryDataContainerImpl source = (SummaryConfigItemDataContainer_AsConfigItems_InChangeVMSettingsSummaryDataContainerImpl)sourceContainer;

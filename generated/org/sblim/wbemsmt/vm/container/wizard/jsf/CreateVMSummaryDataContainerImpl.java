...
public class CreateVMSummaryDataContainerImpl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel implements org.sblim.wbemsmt.vm.container.wizard.CreateVMSummaryDataContainer
	...
	public CreateVMSummaryDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "CreateVMSummaryDataContainer.caption","CreateVMSummaryDataContainer.subTitle",false);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_ReferencedSystem() {
    		if (ic_usr_ReferencedSystem == null)
    		{
    			...
    			ic_usr_ReferencedSystem = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,label,binding,converter, readOnly);
				;
    		}
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_StartContainer() {
    		if (ic_usr_StartContainer == null)
    		{
				...
				String binding = expressionPrefix + "_usr_StartContainer.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = true;
    			ic_usr_StartContainer = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent(parent,label,binding,converter, readOnly);
				;
    		}
	...
	private void addConfigItems(org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryConfigItemDataContainer_AsConfigItems_InCreateVMSummaryDataContainerImpl child) {
	...
	*/
	public java.util.List<SummaryConfigItemDataContainer> getConfigItemsForUI()
	{
		...
		{
			try {
				org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryConfigItemDataContainer_AsConfigItems_InCreateVMSummaryDataContainerImpl item = new org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryConfigItemDataContainer_AsConfigItems_InCreateVMSummaryDataContainerImpl((org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter)adapter,expressionPrefix, result.size());
	...
	private void addDisks(org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryDiskItemDataContainer_AsDisks_InCreateVMSummaryDataContainerImpl child) {
	...
	*/
	public java.util.List<SummaryDiskItemDataContainer> getDisksForUI()
	{
		...
		{
			try {
				org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryDiskItemDataContainer_AsDisks_InCreateVMSummaryDataContainerImpl item = new org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryDiskItemDataContainer_AsDisks_InCreateVMSummaryDataContainerImpl((org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter)adapter,expressionPrefix, result.size());
				DataContainerUtil.setVisibilityOfFields(item,false);
				result.add(item);
			} catch (WbemsmtException e) {
				e.printStackTrace();
	...
	private void addNetworks(org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryNetworkItemDataContainer_AsNetworks_InCreateVMSummaryDataContainerImpl child) {
	...
	*/
	public java.util.List<SummaryNetworkItemDataContainer> getNetworksForUI()
	{
		...
		{
			try {
				org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryNetworkItemDataContainer_AsNetworks_InCreateVMSummaryDataContainerImpl item = new org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryNetworkItemDataContainer_AsNetworks_InCreateVMSummaryDataContainerImpl((org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter)adapter,expressionPrefix, result.size());
				DataContainerUtil.setVisibilityOfFields(item,false);
				result.add(item);
			} catch (WbemsmtException e) {
				e.printStackTrace();
	...
	public void reload()
	{
		super.reload();
	    		if (ic_usr_ReferencedSystem != null)
    		{
				ic_usr_ReferencedSystem.setLabelText(bundle.getString("CreateVMSummaryDataContainer.referencedSystem"));
    		}
	    		if (ic_usr_Hostsystem != null)
    		{
				ic_usr_Hostsystem.setLabelText(bundle.getString("CreateVMSummaryDataContainer.hostsystem"));
    		}
	    		if (ic_Processor != null)
    		{
	    		...
	    		if (ic_Memory != null)
    		{
	    		...
	    		if (ic_usr_StartContainer != null)
    		{
				ic_usr_StartContainer.setLabelText(bundle.getString("CreateVMSummaryDataContainer.startContainer"));
    		}
		}
	...
	public void countAndCreateChildren() throws WbemsmtException {
    			...
    			try
		{
	        ...
	        if (count != configItemsCount)
	        {
			   ...
			   for (int i=0; i < count ; i++) {
	    			addConfigItems(new org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryConfigItemDataContainer_AsConfigItems_InCreateVMSummaryDataContainerImpl((org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter)adapter,expressionPrefix, i));
			   }
	        }
    			...
    			try
		{
	        ...
	        if (count != disksCount)
	        {
	           ...
	           clearDisks();
			   for (int i=0; i < count ; i++) {
	    			addDisks(new org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryDiskItemDataContainer_AsDisks_InCreateVMSummaryDataContainerImpl((org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter)adapter,expressionPrefix, i));
			   }
	        }
    			...
    			try
		{
	        ...
	        if (count != networksCount)
	        {
	           ...
	           clearNetworks();
			   for (int i=0; i < count ; i++) {
	    			addNetworks(new org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryNetworkItemDataContainer_AsNetworks_InCreateVMSummaryDataContainerImpl((org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter)adapter,expressionPrefix, i));
			   }
	        }

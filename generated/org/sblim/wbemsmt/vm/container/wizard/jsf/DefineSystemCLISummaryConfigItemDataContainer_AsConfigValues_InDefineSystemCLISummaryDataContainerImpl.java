...
public class DefineSystemCLISummaryConfigItemDataContainer_AsConfigValues_InDefineSystemCLISummaryDataContainerImpl
        extends org.sblim.wbemsmt.tools.jsf.MultiLineBasePanel2 implements
        org.sblim.wbemsmt.vm.container.wizard.DefineSystemCLISummaryConfigItemDataContainer {
    ...
    public DefineSystemCLISummaryConfigItemDataContainer_AsConfigValues_InDefineSystemCLISummaryDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Name() {
        if (ic_usr_Name == null) {
            ...
            String binding = bindingPrefix + "configValues[" + index + "]._usr_Name.item";
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_CurrentValue() {
        if (ic_usr_CurrentValue == null) {
            ...
            String binding = bindingPrefix + "configValues[" + index + "]._usr_CurrentValue.item";
            logger.fine("Using binding " + binding);
            DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Userdefined() {
        if (ic_usr_Userdefined == null) {
            ...
            String binding = bindingPrefix + "configValues[" + index + "]._usr_Userdefined.item";
            logger.fine("Using binding " + binding);
            DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Userdefined = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent) ic_usr_Userdefined)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
    ...
    public void reload() {
        ...
        if (ic_usr_Name != null) {
            ic_usr_Name.setLabelText(bundle
                    .getString("DefineSystemCLISummaryConfigItemDataContainer.name"));
        }
        if (ic_usr_CurrentValue != null) {
        ...
        if (ic_usr_Userdefined != null) {
            ic_usr_Userdefined.setLabelText(bundle
                    .getString("DefineSystemCLISummaryConfigItemDataContainer.userdefined"));
        }
    }

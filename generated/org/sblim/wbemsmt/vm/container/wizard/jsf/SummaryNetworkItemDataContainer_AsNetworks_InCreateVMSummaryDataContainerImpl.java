/** 
 * SummaryNetworkItemDataContainer_AsNetworks_InCreateVMSummaryDataContainerImpl.java
 *
 * 
 * 
...
public class SummaryNetworkItemDataContainer_AsNetworks_InCreateVMSummaryDataContainerImpl extends
    ...
    public SummaryNetworkItemDataContainer_AsNetworks_InCreateVMSummaryDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_FromPool() {
        if (ic_usr_FromPool == null) {
            ...
            String binding = bindingPrefix + "networks[" + index + "]._usr_FromPool.item";
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Mac() {
        if (ic_usr_Mac == null) {
            ...
            String binding = bindingPrefix + "networks[" + index + "]._usr_Mac.item";
            logger.fine("Using binding " + binding);
            DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Mac = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,
                    label, binding, converter, readOnly);
            ;
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) ic_usr_Mac)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Field1() {
        if (ic_usr_Field1 == null) {
            ...
            String binding = bindingPrefix + "networks[" + index + "]._usr_Field1.item";
            logger.fine("Using binding " + binding);
            DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Field2() {
        if (ic_usr_Field2 == null) {
            ...
            String binding = bindingPrefix + "networks[" + index + "]._usr_Field2.item";
            logger.fine("Using binding " + binding);
            DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Field3() {
        if (ic_usr_Field3 == null) {
            ...
            String binding = bindingPrefix + "networks[" + index + "]._usr_Field3.item";
            logger.fine("Using binding " + binding);
            DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Field4() {
        if (ic_usr_Field4 == null) {
            ...
            String binding = bindingPrefix + "networks[" + index + "]._usr_Field4.item";
            logger.fine("Using binding " + binding);
            DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
    ...
    public void reload() {
        super.reload();
        if (ic_usr_FromPool != null) {
            ic_usr_FromPool.setLabelText(bundle
                    .getString("SummaryNetworkItemDataContainer.fromPool"));
        }
        if (ic_usr_Mac != null) {
    ...
    public void copyFrom(DataContainer sourceContainer) throws WbemsmtException {
        SummaryNetworkItemDataContainer_AsNetworks_InCreateVMSummaryDataContainerImpl source = (SummaryNetworkItemDataContainer_AsNetworks_InCreateVMSummaryDataContainerImpl) sourceContainer;

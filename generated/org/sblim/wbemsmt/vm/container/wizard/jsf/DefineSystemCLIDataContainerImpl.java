...
public class DefineSystemCLIDataContainerImpl extends
    ...
    public DefineSystemCLIDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "DefineSystemCLIDataContainer.caption",
                "DefineSystemCLIDataContainer.subTitle", false);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_ReferencedSystem() {
        if (ic_usr_ReferencedSystem == null) {
            ...
            ic_usr_ReferencedSystem = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFListComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Memory() {
        if (ic_usr_Memory == null) {
            ...
            String binding = bindingPrefix + "_usr_Memory.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Memory = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Processor() {
        if (ic_usr_Processor == null) {
            ...
            String binding = bindingPrefix + "_usr_Processor.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Processor = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_Networks() {
        if (ic_usr_Networks == null) {
            ...
            String binding = bindingPrefix + "_usr_Networks.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
            boolean readOnly = false;
            ic_usr_Networks = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFListComponent(parent,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_Disks() {
        if (ic_usr_Disks == null) {
            ...
            String binding = bindingPrefix + "_usr_Disks.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
            boolean readOnly = false;
            ic_usr_Disks = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFListComponent(parent,
                    label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddDisk() {
        if (ic_usr_AddDisk == null) {
            ...
            String binding = bindingPrefix + "_usr_AddDisk.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_AddDisk = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(parent,
                    label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_RemoveDisk() {
        if (ic_usr_RemoveDisk == null) {
            ...
            String binding = bindingPrefix + "_usr_RemoveDisk.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_RemoveDisk = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(parent,
                    label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_DiskConfigKey() {
        if (ic_usr_DiskConfigKey == null) {
            ...
            String binding = bindingPrefix + "_usr_DiskConfigKey.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_DiskConfigKey = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_DiskConfigValue() {
        if (ic_usr_DiskConfigValue == null) {
            ...
            String binding = bindingPrefix + "_usr_DiskConfigValue.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_DiskConfigValue = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_DiskSelector() {
        if (ic_usr_DiskSelector == null) {
            ...
            String binding = bindingPrefix + "_usr_DiskSelector.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
            boolean readOnly = false;
            ic_usr_DiskSelector = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFListComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddNetwork() {
        if (ic_usr_AddNetwork == null) {
            ...
            String binding = bindingPrefix + "_usr_AddNetwork.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_AddNetwork = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(parent,
                    label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_RemoveNetwork() {
        if (ic_usr_RemoveNetwork == null) {
            ...
            String binding = bindingPrefix + "_usr_RemoveNetwork.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_RemoveNetwork = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(parent,
                    label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_NetworkConfigKey() {
        if (ic_usr_NetworkConfigKey == null) {
            ...
            String binding = bindingPrefix + "_usr_NetworkConfigKey.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_NetworkConfigKey = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_NetworkConfigValue() {
        if (ic_usr_NetworkConfigValue == null) {
            ...
            String binding = bindingPrefix + "_usr_NetworkConfigValue.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_NetworkConfigValue = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_NetworkSelector() {
        if (ic_usr_NetworkSelector == null) {
            ...
            String binding = bindingPrefix + "_usr_NetworkSelector.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
            boolean readOnly = false;
            ic_usr_NetworkSelector = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFListComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_ConfigValue() {
        if (ic_usr_ConfigValue == null) {
            ...
            String binding = bindingPrefix + "_usr_ConfigValue.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_ConfigValue = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_ConfigKey() {
        if (ic_usr_ConfigKey == null) {
            ...
            String binding = bindingPrefix + "_usr_ConfigKey.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_ConfigKey = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Execute() {
        if (ic_usr_Execute == null) {
            ...
            String binding = bindingPrefix + "_usr_Execute.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Execute = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(parent,
                    label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_StartAfterCreation() {
        if (ic_usr_StartAfterCreation == null) {
            ...
            String binding = bindingPrefix + "_usr_StartAfterCreation.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_StartAfterCreation = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_ListOnly() {
        if (ic_usr_ListOnly == null) {
            ...
            String binding = bindingPrefix + "_usr_ListOnly.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_ListOnly = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(parent,
                    label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Sessionkey() {
        if (ic_usr_Sessionkey == null) {
            ...
            String binding = bindingPrefix + "_usr_Sessionkey.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Sessionkey = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_VirtualSystemType() {
        if (ic_usr_VirtualSystemType == null) {
            ...
            String binding = bindingPrefix + "_usr_VirtualSystemType.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
            boolean readOnly = false;
            ic_usr_VirtualSystemType = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFListComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_DeleteSession() {
        if (ic_usr_DeleteSession == null) {
            ...
            String binding = bindingPrefix + "_usr_DeleteSession.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_DeleteSession = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_CleanupSession() {
        if (ic_usr_CleanupSession == null) {
            ...
            String binding = bindingPrefix + "_usr_CleanupSession.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_CleanupSession = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public void reload() {
        ...
        if (ic_usr_ReferencedSystem != null) {
            ic_usr_ReferencedSystem.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.referencedSystem"));
        }
        if (ic_usr_Memory != null) {
            ic_usr_Memory.setLabelText(bundle.getString("DefineSystemCLIDataContainer.memory"));
        }
        if (ic_usr_Processor != null) {
            ic_usr_Processor.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.processor"));
        }
        if (ic_usr_Networks != null) {
        ...
        if (ic_usr_RemoveDisk != null) {
            ic_usr_RemoveDisk.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.removeDisk"));
        }
        if (ic_usr_DiskConfigKey != null) {
            ic_usr_DiskConfigKey.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.diskConfigKey"));
        }
        if (ic_usr_DiskConfigValue != null) {
            ic_usr_DiskConfigValue.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.diskConfigValue"));
        }
        if (ic_usr_DiskSelector != null) {
            ic_usr_DiskSelector.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.diskSelector"));
        }
        if (ic_usr_AddNetwork != null) {
            ic_usr_AddNetwork.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.addNetwork"));
        }
        if (ic_usr_RemoveNetwork != null) {
            ic_usr_RemoveNetwork.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.removeNetwork"));
        }
        if (ic_usr_NetworkConfigKey != null) {
            ic_usr_NetworkConfigKey.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.networkConfigKey"));
        }
        if (ic_usr_NetworkConfigValue != null) {
            ic_usr_NetworkConfigValue.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.networkConfigValue"));
        }
        if (ic_usr_NetworkSelector != null) {
            ic_usr_NetworkSelector.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.networkSelector"));
        }
        if (ic_usr_ConfigValue != null) {
            ic_usr_ConfigValue.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.configValue"));
        }
        if (ic_usr_ConfigKey != null) {
            ic_usr_ConfigKey.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.configKey"));
        }
        if (ic_usr_Execute != null) {
            ic_usr_Execute.setLabelText(bundle.getString("DefineSystemCLIDataContainer.execute"));
        }
        if (ic_usr_StartAfterCreation != null) {
            ic_usr_StartAfterCreation.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.startAfterCreation"));
        }
        if (ic_usr_ListOnly != null) {
            ic_usr_ListOnly.setLabelText(bundle.getString("DefineSystemCLIDataContainer.listOnly"));
        }
        if (ic_usr_Sessionkey != null) {
            ic_usr_Sessionkey.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.sessionkey"));
        }
        if (ic_usr_VirtualSystemType != null) {
            ic_usr_VirtualSystemType.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.virtualSystemType"));
        }
        if (ic_usr_DeleteSession != null) {
            ic_usr_DeleteSession.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.deleteSession"));
        }
        if (ic_usr_CleanupSession != null) {
            ic_usr_CleanupSession.setLabelText(bundle
                    .getString("DefineSystemCLIDataContainer.cleanupSession"));
        }
    }

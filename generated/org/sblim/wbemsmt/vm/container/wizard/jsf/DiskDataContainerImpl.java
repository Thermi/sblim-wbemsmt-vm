...
public class DiskDataContainerImpl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel
        implements org.sblim.wbemsmt.vm.container.wizard.DiskDataContainer,
    ...
    public DiskDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "DiskDataContainer.caption", "DiskDataContainer.subTitle",
                false);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_Disks() {
        if (ic_usr_Disks == null) {
            ...
            ic_usr_Disks = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFComboBoxComponent(
    ...
    private void addDisks(
            org.sblim.wbemsmt.vm.container.wizard.jsf.DiskItemDataContainer_AsDisks_InDiskDataContainerImpl child) {
    ...
    public java.util.List getDisksForUI() {
        ...
        while (result.size() < MIN_TABLE_LENGTH) {
            try {
                org.sblim.wbemsmt.vm.container.wizard.jsf.DiskItemDataContainer_AsDisks_InDiskDataContainerImpl item = new org.sblim.wbemsmt.vm.container.wizard.jsf.DiskItemDataContainer_AsDisks_InDiskDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getDisksHeader_usr_Field1() {
        if (icDisksHeader_usr_Field1 == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icDisksHeader_usr_Field1 = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icDisksHeader_usr_Field1)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getDisksHeader_usr_Field2() {
        if (icDisksHeader_usr_Field2 == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icDisksHeader_usr_Field2 = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icDisksHeader_usr_Field2)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
        ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icDisksHeader_usr_Field2)
                .setHeader(true);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getDisksHeader_usr_Field3() {
        if (icDisksHeader_usr_Field3 == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icDisksHeader_usr_Field3 = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icDisksHeader_usr_Field3)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
        ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icDisksHeader_usr_Field3)
                .setHeader(true);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getDisksHeader_usr_Field4() {
        if (icDisksHeader_usr_Field4 == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icDisksHeader_usr_Field4 = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icDisksHeader_usr_Field4)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
        ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFGenericComponent) icDisksHeader_usr_Field4)
                .setHeader(true);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getDisksHeader_usr_Remove() {
        if (icDisksHeader_usr_Remove == null) {
            ...
            String binding = bindingPrefix + "disksHeader_usr_Remove.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icDisksHeader_usr_Remove = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent) icDisksHeader_usr_Remove)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
        ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent) icDisksHeader_usr_Remove)
                .setHeader(true);
    ...
    public void countAndCreateChildren() throws WbemsmtException {
        ...
        try {
            int count = adapter.count("disks",
                    org.sblim.wbemsmt.vm.container.wizard.DiskItemDataContainer.class, this);
            if (count != disksCount) {
                disksCount = count;
                clearDisks();
                for (int i = 0; i < count; i++) {
                    addDisks(new org.sblim.wbemsmt.vm.container.wizard.jsf.DiskItemDataContainer_AsDisks_InDiskDataContainerImpl(
                            (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter) adapter, bindingPrefix,
                            i));
                }
            }

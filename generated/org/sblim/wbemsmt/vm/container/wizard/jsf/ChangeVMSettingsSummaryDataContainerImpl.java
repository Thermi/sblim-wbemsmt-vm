...
public class ChangeVMSettingsSummaryDataContainerImpl extends
        org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel implements
        org.sblim.wbemsmt.vm.container.wizard.ChangeVMSettingsSummaryDataContainer,
    ...
    public ChangeVMSettingsSummaryDataContainerImpl(
            org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter, String bindingPrefix)
            throws WbemsmtException {

        super(adapter, bindingPrefix, "ChangeVMSettingsSummaryDataContainer.caption",
                "ChangeVMSettingsSummaryDataContainer.subTitle", false);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_System() {
        if (ic_usr_System == null) {
            ...
            String binding = bindingPrefix + "_usr_System.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = true;
            ic_usr_System = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,
    ...
    private void addConfigItems(
            org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryConfigItemDataContainer_AsConfigItems_InChangeVMSettingsSummaryDataContainerImpl child) {
    ...
    public java.util.List getConfigItemsForUI() {
        ...
        while (result.size() < MIN_TABLE_LENGTH) {
            try {
                org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryConfigItemDataContainer_AsConfigItems_InChangeVMSettingsSummaryDataContainerImpl item = new org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryConfigItemDataContainer_AsConfigItems_InChangeVMSettingsSummaryDataContainerImpl(
    ...
    private void addDisks(
            org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryDiskItemDataContainer_AsDisks_InChangeVMSettingsSummaryDataContainerImpl child) {
    ...
    public java.util.List getDisksForUI() {
        ...
        while (result.size() < MIN_TABLE_LENGTH) {
            try {
                org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryDiskItemDataContainer_AsDisks_InChangeVMSettingsSummaryDataContainerImpl item = new org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryDiskItemDataContainer_AsDisks_InChangeVMSettingsSummaryDataContainerImpl(
                        (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter) adapter, bindingPrefix,
                        result.size());
                DataContainerUtil.setVisibilityOfFields(item, false);
                result.add(item);
    ...
    private void addNetworks(
            org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryNetworkItemDataContainer_AsNetworks_InChangeVMSettingsSummaryDataContainerImpl child) {
    ...
    public java.util.List getNetworksForUI() {
        ...
        while (result.size() < MIN_TABLE_LENGTH) {
            try {
                org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryNetworkItemDataContainer_AsNetworks_InChangeVMSettingsSummaryDataContainerImpl item = new org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryNetworkItemDataContainer_AsNetworks_InChangeVMSettingsSummaryDataContainerImpl(
                        (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter) adapter, bindingPrefix,
                        result.size());
                DataContainerUtil.setVisibilityOfFields(item, false);
                result.add(item);
    ...
    public void reload() {
        super.reload();
        if (ic_usr_System != null) {
            ic_usr_System.setLabelText(bundle
                    .getString("ChangeVMSettingsSummaryDataContainer.system"));
        }
        if (ic_usr_Hostsystem != null) {
            ic_usr_Hostsystem.setLabelText(bundle
                    .getString("ChangeVMSettingsSummaryDataContainer.hostsystem"));
        }
        if (ic_Processor != null) {
            ic_Processor.setLabelText(bundle
                    .getString("ChangeVMSettingsSummaryDataContainer.Processor"));
        }
        if (ic_Memory != null) {
    ...
    public void countAndCreateChildren() throws WbemsmtException {
        ...
        try {
            ...
            if (count != configItemsCount) {
                ...
                for (int i = 0; i < count; i++) {
                    addConfigItems(new org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryConfigItemDataContainer_AsConfigItems_InChangeVMSettingsSummaryDataContainerImpl(
                            (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter) adapter, bindingPrefix,
                            i));
                }
            }
        ...
        try {
            ...
            if (count != disksCount) {
                ...
                clearDisks();
                for (int i = 0; i < count; i++) {
                    addDisks(new org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryDiskItemDataContainer_AsDisks_InChangeVMSettingsSummaryDataContainerImpl(
                            (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter) adapter, bindingPrefix,
                            i));
                }
            }
        ...
        try {
            ...
            if (count != networksCount) {
                ...
                clearNetworks();
                for (int i = 0; i < count; i++) {
                    addNetworks(new org.sblim.wbemsmt.vm.container.wizard.jsf.SummaryNetworkItemDataContainer_AsNetworks_InChangeVMSettingsSummaryDataContainerImpl(
                            (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter) adapter, bindingPrefix,
                            i));
                }
            }

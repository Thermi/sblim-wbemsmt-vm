...
public class NetworkVMInfoDataContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.vm.container.edit.NetworkVMInfoDataContainer
	...
	public NetworkVMInfoDataContainerImpl(AbstractBaseCimAdapter adapter) throws  WbemsmtException {
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_Address() {
    		...
    		{
    			String label = getAdapter().getBundle().getString("NetworkVMInfoItemDataContainer.Address");
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_usr_Info() {
    		...
    		{
    			String label = getAdapter().getBundle().getString("NetworkVMInfoItemDataContainer.Info");
			    org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("NetworkVMInfoDataContainer.caption"));
		}
	...
	{
    		        		List<NetworkVMInfoItemDataContainer> listitems = getItems();
        		printStream.println();
        		printStream.println(getAdapter().getBundle().getString("NetworkVMInfoDataContainer.role.items") + " " + getAdapter().getBundle().getString("items.found", new Object[]{new Integer(listitems.size())}));

...
public class PossibleOperationsItemDataContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.vm.container.edit.PossibleOperationsItemDataContainer
	{
	...
	public PossibleOperationsItemDataContainerImpl(AbstractBaseCimAdapter adapter) throws  WbemsmtException {
		super();
		setAdapter(adapter);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Operation() {
    		if (ic_usr_Operation == null)
    		{
    			...
    			ic_usr_Operation = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,label,null,converter);
    		}
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Supported() {
    		if (ic_usr_Supported == null)
    		{
    			...
    			ic_usr_Supported = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,label,null,converter);
    		}
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Type() {
    		if (ic_usr_Type == null)
    		{
				...
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
    			ic_usr_Type = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,label,null,converter);
    		}
    		return ic_usr_Type;
    	}
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("PossibleOperationsItemDataContainer.caption"));
		}
		...
		if (showInstance(listOptions))
		{
   			...
   			{
        				Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf)get_usr_Operation()).getValue();

...
public class VMOverviewDataContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.vm.container.edit.VMOverviewDataContainer,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_ContainerName() {
        if (icItemsHeader_ContainerName == null) {
            ...
            icItemsHeader_ContainerName = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_usr_State() {
        if (icItemsHeader_usr_State == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            icItemsHeader_usr_State = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
                    this, label, "", converter);
        }
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "VMOverviewDataContainer.caption"));
        }
    ...
    public void traceChilds(java.io.PrintWriter printStream, String listOptions, boolean title) {
        ...
        printStream.println(getAdapter().getBundle()
                .getString("VMOverviewDataContainer.role.items")
                + " "

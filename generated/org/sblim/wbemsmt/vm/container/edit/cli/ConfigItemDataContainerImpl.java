...
public class ConfigItemDataContainerImpl extends BaseDataContainer implements
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_NextValue() {
        if (ic_usr_NextValue == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_NextValue = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
                    this, label, null, converter);
        }
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "ConfigItemDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            ...
            if (get_usr_NextValue().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_NextValue())
                        .getValue();

...
public class VMOverviewItemDataContainerImpl extends BaseDataContainer implements
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_ContainerName() {
        if (ic_ContainerName == null) {
            String label = getAdapter().getBundle().getString(
                    "VMOverviewItemDataContainer.ContainerName");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_ContainerName = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_State() {
        if (ic_usr_State == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_State = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "VMOverviewItemDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            if (get_ContainerName().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_ContainerName())
                        .getValue();
                printStream.println(get_ContainerName().getLabelText() + ": " + value);
            }
            if (get_usr_State().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_State())
                        .getValue();

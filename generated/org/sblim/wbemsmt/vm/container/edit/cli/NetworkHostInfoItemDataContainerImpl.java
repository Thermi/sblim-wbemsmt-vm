...
public class NetworkHostInfoItemDataContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.vm.container.edit.NetworkHostInfoItemDataContainer {
    ...
    public NetworkHostInfoItemDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Pool() {
        if (ic_usr_Pool == null) {
            ...
            ic_usr_Pool = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Network() {
        if (ic_usr_Network == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_Network = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,
                    label, null, converter);
        }
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "NetworkHostInfoItemDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            if (get_usr_Pool().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_Pool())
                        .getValue();
                printStream.println(get_usr_Pool().getLabelText() + ": " + value);
            }
            if (get_usr_Network().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_Network())
                        .getValue();

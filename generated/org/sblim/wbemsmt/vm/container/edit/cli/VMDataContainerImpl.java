...
public class VMDataContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.vm.container.edit.VMDataContainer {
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_VmID() {
        if (ic_VmID == null) {
            ...
            ic_VmID = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this, label,
                    null, converter);
        }
        return ic_VmID;
    }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_VmName() {
        if (ic_VmName == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_VmName = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_EnabledState() {
        if (ic_EnabledState == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_EnabledState = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_RequestedState() {
        if (ic_RequestedState == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_RequestedState = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
                    this, label, null, converter);
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Info() {
        if (ic_Info == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_Info = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this, label,
                    null, converter);
        }
        return ic_Info;
    }
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        ...
        if (showInstance(listOptions)) {
            if (get_VmID().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_VmID())
                        .getValue();
                printStream.println(get_VmID().getLabelText() + ": " + value);
            }
            if (get_VmName().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_VmName())
                        .getValue();
                printStream.println(get_VmName().getLabelText() + ": " + value);
            }
            if (get_EnabledState().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_EnabledState())
                        .getValue();
                printStream.println(get_EnabledState().getLabelText() + ": " + value);
            }
            if (get_RequestedState().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_RequestedState())
                        .getValue();
                printStream.println(get_RequestedState().getLabelText() + ": " + value);
            }
            if (get_Info().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_Info())
                        .getValue();

...
public class MemoryVMInfoDataContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.vm.container.edit.MemoryVMInfoDataContainer
	...
	public MemoryVMInfoDataContainerImpl(AbstractBaseCimAdapter adapter) throws  WbemsmtException {
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_usr_Current() {
    		...
    		{
    			String label = getAdapter().getBundle().getString("MemoryVMInfoItemDataContainer.current");
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_usr_DefaultValue() {
    		...
    		{
    			String label = getAdapter().getBundle().getString("MemoryVMInfoItemDataContainer.defaultValue");
			    org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("MemoryVMInfoDataContainer.caption"));
		}
	...
	{
    		        		List<MemoryVMInfoItemDataContainer> listitems = getItems();
        		printStream.println();
        		printStream.println(getAdapter().getBundle().getString("MemoryVMInfoDataContainer.role.items") + " " + getAdapter().getBundle().getString("items.found", new Object[]{new Integer(listitems.size())}));

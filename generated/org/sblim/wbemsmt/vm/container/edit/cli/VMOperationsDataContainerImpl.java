...
public class VMOperationsDataContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.vm.container.edit.VMOperationsDataContainer
	{
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_Action() {
    		if (ic_usr_Action == null)
    		{
    			...
    			ic_usr_Action = new org.sblim.wbemsmt.tools.input.test.LabeledTestStringArrayComponent(this,label,null,converter);
    		}
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("VMOperationsDataContainer.caption"));
		}
		...
		if (showInstance(listOptions))
		{
   			...
   			{
        				Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf)get_usr_Action()).getValue();

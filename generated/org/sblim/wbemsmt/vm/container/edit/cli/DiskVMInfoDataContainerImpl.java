...
public class DiskVMInfoDataContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.vm.container.edit.DiskVMInfoDataContainer,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_InstanceID() {
        if (icItemsHeader_InstanceID == null) {
            ...
            icItemsHeader_InstanceID = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DiskVMInfoDataContainer.caption"));
        }
    ...
    public void traceChilds(java.io.PrintWriter printStream, String listOptions, boolean title) {
        ...
        printStream.println(getAdapter().getBundle()
                .getString("DiskVMInfoDataContainer.role.items")
                + " "

...
public class HostSystemInfoItemDataContainerImpl extends BaseDataContainer implements
    ...
    public HostSystemInfoItemDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_VMName() {
        if (ic_usr_VMName == null) {
            String label = getAdapter().getBundle().getString(
                    "HostSystemInfoItemDataContainer.VMName");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_usr_VMName = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Info() {
        if (ic_usr_Info == null) {
            String label = getAdapter().getBundle().getString(
                    "HostSystemInfoItemDataContainer.Info");
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "HostSystemInfoItemDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            if (get_usr_VMName().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_VMName())
                        .getValue();

...
public class WelcomeDataContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.vm.container.edit.WelcomeDataContainer
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Picture() {
    		if (ic_usr_Picture == null)
    		{
    			...
    			ic_usr_Picture = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,label,null,converter);
    		}
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_CreateLink() {
    		if (ic_usr_CreateLink == null)
    		{
				...
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.cli.NotSupportedConverter();
    			ic_usr_CreateLink = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,label,null,converter);
    		}
	...
	{
    		        		List<WelcomeItemDataContainer> listitems = getItems();
        		printStream.println();
        		printStream.println(getAdapter().getBundle().getString("WelcomeDataContainer.role.items") + " " + getAdapter().getBundle().getString("items.found", new Object[]{new Integer(listitems.size())}));

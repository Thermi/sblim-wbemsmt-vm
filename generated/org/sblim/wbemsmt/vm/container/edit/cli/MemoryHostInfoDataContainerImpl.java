...
public class MemoryHostInfoDataContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.vm.container.edit.MemoryHostInfoDataContainer
	...
	public MemoryHostInfoDataContainerImpl(AbstractBaseCimAdapter adapter) throws  WbemsmtException {
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_usr_Min() {
    		...
    		{
    			String label = getAdapter().getBundle().getString("MemoryHostInfoItemDataContainer.min");
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_usr_Max() {
    		...
    		{
    			String label = getAdapter().getBundle().getString("MemoryHostInfoItemDataContainer.max");
			    org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_usr_DefaultValue() {
    		...
    		{
    			String label = getAdapter().getBundle().getString("MemoryHostInfoItemDataContainer.defaultValue");
			    org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("MemoryHostInfoDataContainer.caption"));
		}
	...
	{
    		        		List<MemoryHostInfoItemDataContainer> listitems = getItems();
        		printStream.println();
        		printStream.println(getAdapter().getBundle().getString("MemoryHostInfoDataContainer.role.items") + " " + getAdapter().getBundle().getString("items.found", new Object[]{new Integer(listitems.size())}));

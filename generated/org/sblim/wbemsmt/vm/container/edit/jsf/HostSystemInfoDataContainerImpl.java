...
public class HostSystemInfoDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.vm.container.edit.HostSystemInfoDataContainer
			, org.sblim.wbemsmt.vm.container.edit.HostSystemInfoItemDataContainerHeader		
	{
				
				private java.util.List<HostSystemInfoItemDataContainer> icItems = new java.util.ArrayList<HostSystemInfoItemDataContainer>();
	...
	public HostSystemInfoDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "HostSystemInfoDataContainer.caption",false);
	...
	private void addItems(org.sblim.wbemsmt.vm.container.edit.jsf.HostSystemInfoItemDataContainer_AsItems_InHostSystemInfoDataContainerImpl child) {
	...
	*/
	public java.util.List<HostSystemInfoItemDataContainer> getItemsForUI()
	{
				
		List<HostSystemInfoItemDataContainer> result = new ArrayList<HostSystemInfoItemDataContainer>();
		result.addAll(icItems);
		
		while (result.size() < MIN_TABLE_LENGTH)
		{
			try {
				org.sblim.wbemsmt.vm.container.edit.jsf.HostSystemInfoItemDataContainer_AsItems_InHostSystemInfoDataContainerImpl item = new org.sblim.wbemsmt.vm.container.edit.jsf.HostSystemInfoItemDataContainer_AsItems_InHostSystemInfoDataContainerImpl((org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter)adapter,expressionPrefix, result.size());
	...
	public void countAndCreateChildren() throws WbemsmtException {
    			...
    			try
		{
			int count = adapter.count("items",org.sblim.wbemsmt.vm.container.edit.HostSystemInfoItemDataContainer.class, this);
	        if (count != itemsCount)
	        {
	           itemsCount = count;
	           clearItems();
			   for (int i=0; i < count ; i++) {
	    			addItems(new org.sblim.wbemsmt.vm.container.edit.jsf.HostSystemInfoItemDataContainer_AsItems_InHostSystemInfoDataContainerImpl((org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter)adapter,expressionPrefix, i));
			   }
	        }
	...
	public void copyFrom(DataContainer sourceContainer) throws WbemsmtException
	{
    	    		   ...
    	    		   List<HostSystemInfoItemDataContainer> targetListForItems = getItems();
    		   List<HostSystemInfoItemDataContainer> sourceListForItems = source.getItems();

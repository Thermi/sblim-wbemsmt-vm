...
public class PossibleOperationsItemDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.vm.container.edit.PossibleOperationsItemDataContainer
	{
	...
	public PossibleOperationsItemDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "PossibleOperationsItemDataContainer.caption",false);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Operation() {
    		if (ic_usr_Operation == null)
    		{
				...
				String binding = expressionPrefix + "_usr_Operation.item";
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Supported() {
    		if (ic_usr_Supported == null)
    		{
				...
				String binding = expressionPrefix + "_usr_Supported.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;

...
public class MemoryHostInfoDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.vm.container.edit.MemoryHostInfoDataContainer,
    ...
    public MemoryHostInfoDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "MemoryHostInfoDataContainer.caption", false);
    ...
    private void addItems(
            org.sblim.wbemsmt.vm.container.edit.jsf.MemoryHostInfoItemDataContainer_AsItems_InMemoryHostInfoDataContainerImpl child) {
    ...
    public java.util.List getItemsForUI() {
        ...
        while (result.size() < MIN_TABLE_LENGTH) {
            try {
                org.sblim.wbemsmt.vm.container.edit.jsf.MemoryHostInfoItemDataContainer_AsItems_InMemoryHostInfoDataContainerImpl item = new org.sblim.wbemsmt.vm.container.edit.jsf.MemoryHostInfoItemDataContainer_AsItems_InMemoryHostInfoDataContainerImpl(
    ...
    public void countAndCreateChildren() throws WbemsmtException {
        ...
        try {
            int count = adapter
                    .count(
                            "items",
                            org.sblim.wbemsmt.vm.container.edit.MemoryHostInfoItemDataContainer.class,
                            this);
            if (count != itemsCount) {
                itemsCount = count;
                clearItems();
                for (int i = 0; i < count; i++) {
                    addItems(new org.sblim.wbemsmt.vm.container.edit.jsf.MemoryHostInfoItemDataContainer_AsItems_InMemoryHostInfoDataContainerImpl(
                            (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter) adapter, bindingPrefix,
                            i));
                }
            }

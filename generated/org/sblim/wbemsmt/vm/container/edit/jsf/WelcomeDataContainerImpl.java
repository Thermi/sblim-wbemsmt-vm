...
public class WelcomeDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.vm.container.edit.WelcomeDataContainer
			, org.sblim.wbemsmt.vm.container.edit.WelcomeItemDataContainerHeader		
	{
    		...
    		private org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf ic_usr_CreateLink;
				...
				private java.util.List<WelcomeItemDataContainer> icItems = new java.util.ArrayList<WelcomeItemDataContainer>();
	...
	public WelcomeDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "WelcomeDataContainer.caption",true);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Picture() {
    		if (ic_usr_Picture == null)
    		{
				...
				String binding = expressionPrefix + "_usr_Picture.item";
    			...
    			ic_usr_Picture = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFPictureComponent(parent,label,binding,converter, readOnly);
				;
    		}
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Welcometext() {
    		if (ic_usr_Welcometext == null)
    		{
				...
				boolean readOnly = false;
    			ic_usr_Welcometext = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFMemoComponent(parent,label,binding,converter, readOnly);
				;
    		}
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_CreateLink() {
    		if (ic_usr_CreateLink == null)
    		{
				...
				String binding = expressionPrefix + "_usr_CreateLink.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.jsf.LinkDataConverter();
				boolean readOnly = false;
    			ic_usr_CreateLink = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLinkComponent(parent,label,binding,converter, readOnly);
				;
    		}
	...
	private void addItems(org.sblim.wbemsmt.vm.container.edit.jsf.WelcomeItemDataContainer_AsItems_InWelcomeDataContainerImpl child) {
	...
	*/
	public java.util.List<WelcomeItemDataContainer> getItemsForUI()
	{
					//the container is dynamic so udpate the access time
			adapter.updateAccesTime(this);
			super.checkForUpdateControls();
				
		List<WelcomeItemDataContainer> result = new ArrayList<WelcomeItemDataContainer>();
		result.addAll(icItems);
		
		while (result.size() < MIN_TABLE_LENGTH)
		{
			try {
				org.sblim.wbemsmt.vm.container.edit.jsf.WelcomeItemDataContainer_AsItems_InWelcomeDataContainerImpl item = new org.sblim.wbemsmt.vm.container.edit.jsf.WelcomeItemDataContainer_AsItems_InWelcomeDataContainerImpl((org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter)adapter,expressionPrefix, result.size());
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_usr_VMName() {
    		if (icItemsHeader_usr_VMName == null)
    		{
				...
				String binding = expressionPrefix + "itemsHeader_usr_VMName.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
    			icItemsHeader_usr_VMName = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,label,binding,converter, readOnly);
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent)icItemsHeader_usr_VMName).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent)icItemsHeader_usr_VMName).setHeader(true);
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_usr_Info() {
    		if (icItemsHeader_usr_Info == null)
    		{
				...
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.jsf.MemoDataConverter();
				boolean readOnly = false;
    			icItemsHeader_usr_Info = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFMemoComponent(parent,label,binding,converter, readOnly);
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFMemoComponent)icItemsHeader_usr_Info).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFMemoComponent)icItemsHeader_usr_Info).setHeader(true);
	...
	public void countAndCreateChildren() throws WbemsmtException {
    			...
    			try
		{
			int count = adapter.count("items",org.sblim.wbemsmt.vm.container.edit.WelcomeItemDataContainer.class, this);
	        if (count != itemsCount)
	        {
	           itemsCount = count;
	           clearItems();
			   for (int i=0; i < count ; i++) {
	    			addItems(new org.sblim.wbemsmt.vm.container.edit.jsf.WelcomeItemDataContainer_AsItems_InWelcomeDataContainerImpl((org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter)adapter,expressionPrefix, i));
			   }
	        }
	...
	public void copyFrom(DataContainer sourceContainer) throws WbemsmtException
	{
    	    		   ...
    	    		   List<WelcomeItemDataContainer> targetListForItems = getItems();
    		   List<WelcomeItemDataContainer> sourceListForItems = source.getItems();

...
public class VMDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements
    ...
    public VMDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "VMDataContainer.caption", false);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_VmID() {
        if (ic_VmID == null) {
            ...
            String binding = bindingPrefix + "_VmID.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = true;
            ic_VmID = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent, label,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_VmName() {
        if (ic_VmName == null) {
            ...
            String binding = bindingPrefix + "_VmName.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_VmName = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_EnabledState() {
        if (ic_EnabledState == null) {
            ...
            String binding = bindingPrefix + "_EnabledState.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_EnabledState = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_RequestedState() {
        if (ic_RequestedState == null) {
            ...
            String binding = bindingPrefix + "_RequestedState.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_RequestedState = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Info() {
        if (ic_Info == null) {
            ...
            String binding = bindingPrefix + "_Info.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_Info = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent, label,
                    binding, converter, readOnly);
            ;
        }

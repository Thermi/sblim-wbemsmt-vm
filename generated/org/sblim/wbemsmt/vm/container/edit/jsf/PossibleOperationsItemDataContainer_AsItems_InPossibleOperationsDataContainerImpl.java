...
public class PossibleOperationsItemDataContainer_AsItems_InPossibleOperationsDataContainerImpl
    ...
    public PossibleOperationsItemDataContainer_AsItems_InPossibleOperationsDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Operation() {
        if (ic_usr_Operation == null) {
            ...
            String binding = bindingPrefix + "items[" + index + "]._usr_Operation.item";
            ...
            ;
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) ic_usr_Operation)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Supported() {
        if (ic_usr_Supported == null) {
            ...
            String binding = bindingPrefix + "items[" + index + "]._usr_Supported.item";
            logger.fine("Using binding " + binding);
            DataContainer parent = this;
            ...
            ic_usr_Supported = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFPictureComponent(
                    parent, label, binding, converter, readOnly);
            ;
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFPictureComponent) ic_usr_Supported)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Type() {
        if (ic_usr_Type == null) {
            ...
            String binding = bindingPrefix + "items[" + index + "]._usr_Type.item";
            logger.fine("Using binding " + binding);
            DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ...
            ;
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) ic_usr_Type)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
    ...
    public LabeledJSFInputComponent[] getComponents() {
        return new LabeledJSFInputComponent[] { (LabeledJSFInputComponent) get_usr_Operation(),

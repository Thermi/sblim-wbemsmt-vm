...
public class VMOverviewItemDataContainer_AsItems_InVMOverviewDataContainerImpl extends
        org.sblim.wbemsmt.tools.jsf.MultiLineBasePanel2 implements
        org.sblim.wbemsmt.vm.container.edit.VMOverviewItemDataContainer {
    ...
    public VMOverviewItemDataContainer_AsItems_InVMOverviewDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_ContainerName() {
        if (ic_ContainerName == null) {
            ...
            String binding = bindingPrefix + "items[" + index + "]._ContainerName.item";
            logger.fine("Using binding " + binding);
            DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_ContainerName = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
                    parent, label, binding, converter, readOnly);
            ;
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) ic_ContainerName)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_State() {
        if (ic_usr_State == null) {
            ...
            String binding = bindingPrefix + "items[" + index + "]._usr_State.item";
            logger.fine("Using binding " + binding);
            DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_State = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,
                    label, binding, converter, readOnly);
            ;
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) ic_usr_State)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
    ...
    public LabeledJSFInputComponent[] getComponents() {
        return new LabeledJSFInputComponent[] { (LabeledJSFInputComponent) get_ContainerName(),
    ...
    public void reload() {
        super.reload();
        if (ic_ContainerName != null) {
            ic_ContainerName.setLabelText(bundle
                    .getString("VMOverviewItemDataContainer.ContainerName"));
        }
        if (ic_usr_State != null) {

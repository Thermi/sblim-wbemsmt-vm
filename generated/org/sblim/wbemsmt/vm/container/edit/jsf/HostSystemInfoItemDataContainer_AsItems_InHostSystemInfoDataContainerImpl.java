/** 
 * HostSystemInfoItemDataContainer_AsItems_InHostSystemInfoDataContainerImpl.java
 *
 * 
 * 
...
public class HostSystemInfoItemDataContainer_AsItems_InHostSystemInfoDataContainerImpl extends
        org.sblim.wbemsmt.tools.jsf.MultiLineBasePanel2 implements
        org.sblim.wbemsmt.vm.container.edit.HostSystemInfoItemDataContainer {
    ...
    public HostSystemInfoItemDataContainer_AsItems_InHostSystemInfoDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_VMName() {
        if (ic_usr_VMName == null) {
            ...
            String binding = bindingPrefix + "items[" + index + "]._usr_VMName.item";
            ...
            ;
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) ic_usr_VMName)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Info() {
        if (ic_usr_Info == null) {
            ...
            ic_usr_Info = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFMemoComponent(parent,
                    label, binding, converter, readOnly);
            ;
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFMemoComponent) ic_usr_Info)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
    ...
    public LabeledJSFInputComponent[] getComponents() {
        return new LabeledJSFInputComponent[] { (LabeledJSFInputComponent) get_usr_VMName(),
    ...
    public void copyFrom(DataContainer sourceContainer) throws WbemsmtException {
        HostSystemInfoItemDataContainer_AsItems_InHostSystemInfoDataContainerImpl source = (HostSystemInfoItemDataContainer_AsItems_InHostSystemInfoDataContainerImpl) sourceContainer;

...
public class NetworkHostInfoItemDataContainer_AsItems_InNetworkHostInfoDataContainerImpl extends
    ...
    public NetworkHostInfoItemDataContainer_AsItems_InNetworkHostInfoDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Network() {
        if (ic_usr_Network == null) {
            ...
            String binding = bindingPrefix + "items[" + index + "]._usr_Network.item";
            logger.fine("Using binding " + binding);
            DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Network = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,
                    label, binding, converter, readOnly);
            ;
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) ic_usr_Network)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
    ...
    public void reload() {
        ...
        if (ic_usr_Network != null) {
            ic_usr_Network.setLabelText(bundle
                    .getString("NetworkHostInfoItemDataContainer.network"));
        }
    }

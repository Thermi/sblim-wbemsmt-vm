...
public class VMOverviewDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.vm.container.edit.VMOverviewDataContainer,
    ...
    public VMOverviewDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "VMOverviewDataContainer.caption", true);
    ...
    private void addItems(
            org.sblim.wbemsmt.vm.container.edit.jsf.VMOverviewItemDataContainer_AsItems_InVMOverviewDataContainerImpl child) {
    ...
    public java.util.List getItemsForUI() {
        ...
        while (result.size() < MIN_TABLE_LENGTH) {
            try {
                org.sblim.wbemsmt.vm.container.edit.jsf.VMOverviewItemDataContainer_AsItems_InVMOverviewDataContainerImpl item = new org.sblim.wbemsmt.vm.container.edit.jsf.VMOverviewItemDataContainer_AsItems_InVMOverviewDataContainerImpl(
    ...
    private String[] getItemsFieldNames() {
        return new String[] { "_ContainerName", "_usr_State", };
    }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_ContainerName() {
        if (icItemsHeader_ContainerName == null) {
            ...
            String binding = bindingPrefix + "itemsHeader_ContainerName.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icItemsHeader_ContainerName = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) icItemsHeader_ContainerName)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_usr_State() {
        if (icItemsHeader_usr_State == null) {
            ...
            String binding = bindingPrefix + "itemsHeader_usr_State.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            icItemsHeader_usr_State = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) icItemsHeader_usr_State)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
        ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) icItemsHeader_usr_State)
                .setHeader(true);
    ...
    public void countAndCreateChildren() throws WbemsmtException {
        ...
        try {
            int count = adapter.count("items",
                    org.sblim.wbemsmt.vm.container.edit.VMOverviewItemDataContainer.class, this);
            if (count != itemsCount) {
                itemsCount = count;
                clearItems();
                for (int i = 0; i < count; i++) {
                    addItems(new org.sblim.wbemsmt.vm.container.edit.jsf.VMOverviewItemDataContainer_AsItems_InVMOverviewDataContainerImpl(
                            (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter) adapter, bindingPrefix,
                            i));
                }
            }

...
public class ProcessorHostInfoDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.vm.container.edit.ProcessorHostInfoDataContainer
	...
	public ProcessorHostInfoDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "ProcessorHostInfoDataContainer.caption",false);
	...
	private void addItems(org.sblim.wbemsmt.vm.container.edit.jsf.ProcessorHostInfoItemDataContainer_AsItems_InProcessorHostInfoDataContainerImpl child) {
	...
	*/
	public java.util.List<ProcessorHostInfoItemDataContainer> getItemsForUI()
	{
				
		List<ProcessorHostInfoItemDataContainer> result = new ArrayList<ProcessorHostInfoItemDataContainer>();
		result.addAll(icItems);
		
		while (result.size() < MIN_TABLE_LENGTH)
		{
			try {
				org.sblim.wbemsmt.vm.container.edit.jsf.ProcessorHostInfoItemDataContainer_AsItems_InProcessorHostInfoDataContainerImpl item = new org.sblim.wbemsmt.vm.container.edit.jsf.ProcessorHostInfoItemDataContainer_AsItems_InProcessorHostInfoDataContainerImpl((org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter)adapter,expressionPrefix, result.size());
	...
	public void countAndCreateChildren() throws WbemsmtException {
    			...
    			try
		{
			int count = adapter.count("items",org.sblim.wbemsmt.vm.container.edit.ProcessorHostInfoItemDataContainer.class, this);
	        if (count != itemsCount)
	        {
	           itemsCount = count;
	           clearItems();
			   for (int i=0; i < count ; i++) {
	    			addItems(new org.sblim.wbemsmt.vm.container.edit.jsf.ProcessorHostInfoItemDataContainer_AsItems_InProcessorHostInfoDataContainerImpl((org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter)adapter,expressionPrefix, i));
			   }
	        }

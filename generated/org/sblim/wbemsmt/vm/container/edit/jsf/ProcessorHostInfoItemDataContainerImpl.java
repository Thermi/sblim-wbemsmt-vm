/** 
  * ProcessorHostInfoItemDataContainerImpl.java
  *
  * 
...
public class ProcessorHostInfoItemDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.vm.container.edit.ProcessorHostInfoItemDataContainer
	{
	...
	public ProcessorHostInfoItemDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "ProcessorHostInfoItemDataContainer.caption",false);
		...
		setFooter(getPanelForCustomLayout(),"ProcessorHostInfoItemDataContainer.footerText");
	...
	public void reload()
	{
		super.reload();
	    		...
	    		if (ic_usr_Max != null)
    		{
	    		...
	    		if (ic_usr_DefaultValue != null)
    		{
				ic_usr_DefaultValue.setLabelText(bundle.getString("ProcessorHostInfoItemDataContainer.defaultValue"));
    		}
		}
	...
	{
	    		       ProcessorHostInfoItemDataContainerImpl source = (ProcessorHostInfoItemDataContainerImpl)sourceContainer;

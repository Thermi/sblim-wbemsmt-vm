...
public class NetworkVMInfoDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.vm.container.edit.NetworkVMInfoDataContainer,
    ...
    public NetworkVMInfoDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "NetworkVMInfoDataContainer.caption", false);
    ...
    private void addItems(
            org.sblim.wbemsmt.vm.container.edit.jsf.NetworkVMInfoItemDataContainer_AsItems_InNetworkVMInfoDataContainerImpl child) {
    ...
    public java.util.List getItemsForUI() {
        ...
        while (result.size() < MIN_TABLE_LENGTH) {
            try {
                org.sblim.wbemsmt.vm.container.edit.jsf.NetworkVMInfoItemDataContainer_AsItems_InNetworkVMInfoDataContainerImpl item = new org.sblim.wbemsmt.vm.container.edit.jsf.NetworkVMInfoItemDataContainer_AsItems_InNetworkVMInfoDataContainerImpl(
    ...
    private String[] getItemsFieldNames() {
        return new String[] { "_Address", "_usr_Info", };
    }
    ...
    public void countAndCreateChildren() throws WbemsmtException {
        ...
        try {
            int count = adapter.count("items",
                    org.sblim.wbemsmt.vm.container.edit.NetworkVMInfoItemDataContainer.class, this);
            if (count != itemsCount) {
                itemsCount = count;
                clearItems();
                for (int i = 0; i < count; i++) {
                    addItems(new org.sblim.wbemsmt.vm.container.edit.jsf.NetworkVMInfoItemDataContainer_AsItems_InNetworkVMInfoDataContainerImpl(
                            (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter) adapter, bindingPrefix,
                            i));
                }
            }

...
public class MemoryHostInfoItemDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.vm.container.edit.MemoryHostInfoItemDataContainer {
    ...
    public MemoryHostInfoItemDataContainerImpl(
            org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter, String bindingPrefix)
            throws WbemsmtException {

        super(adapter, bindingPrefix, "MemoryHostInfoItemDataContainer.caption", false);
    ...
    public void reload() {
        ...
        if (ic_usr_DefaultValue != null) {
            ic_usr_DefaultValue.setLabelText(bundle
                    .getString("MemoryHostInfoItemDataContainer.defaultValue"));
        }
    }

...
public class NetworkHostInfoDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.vm.container.edit.NetworkHostInfoDataContainer
	...
	public NetworkHostInfoDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "NetworkHostInfoDataContainer.caption",false);
	...
	private void addItems(org.sblim.wbemsmt.vm.container.edit.jsf.NetworkHostInfoItemDataContainer_AsItems_InNetworkHostInfoDataContainerImpl child) {
	...
	*/
	public java.util.List<NetworkHostInfoItemDataContainer> getItemsForUI()
	{
				
		List<NetworkHostInfoItemDataContainer> result = new ArrayList<NetworkHostInfoItemDataContainer>();
		result.addAll(icItems);
		
		while (result.size() < MIN_TABLE_LENGTH)
		{
			try {
				org.sblim.wbemsmt.vm.container.edit.jsf.NetworkHostInfoItemDataContainer_AsItems_InNetworkHostInfoDataContainerImpl item = new org.sblim.wbemsmt.vm.container.edit.jsf.NetworkHostInfoItemDataContainer_AsItems_InNetworkHostInfoDataContainerImpl((org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter)adapter,expressionPrefix, result.size());
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_usr_Network() {
    		if (icItemsHeader_usr_Network == null)
    		{
				...
				String binding = expressionPrefix + "itemsHeader_usr_Network.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
    			icItemsHeader_usr_Network = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,label,binding,converter, readOnly);
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent)icItemsHeader_usr_Network).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent)icItemsHeader_usr_Network).setHeader(true);
	...
	public void countAndCreateChildren() throws WbemsmtException {
    			...
    			try
		{
			int count = adapter.count("items",org.sblim.wbemsmt.vm.container.edit.NetworkHostInfoItemDataContainer.class, this);
	        if (count != itemsCount)
	        {
	           itemsCount = count;
	           clearItems();
			   for (int i=0; i < count ; i++) {
	    			addItems(new org.sblim.wbemsmt.vm.container.edit.jsf.NetworkHostInfoItemDataContainer_AsItems_InNetworkHostInfoDataContainerImpl((org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter)adapter,expressionPrefix, i));
			   }
	        }

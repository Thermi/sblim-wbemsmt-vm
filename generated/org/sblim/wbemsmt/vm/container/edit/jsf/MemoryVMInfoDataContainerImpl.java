...
public class MemoryVMInfoDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.vm.container.edit.MemoryVMInfoDataContainer,
    ...
    public MemoryVMInfoDataContainerImpl(org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "MemoryVMInfoDataContainer.caption", false);
    ...
    private void addItems(
            org.sblim.wbemsmt.vm.container.edit.jsf.MemoryVMInfoItemDataContainer_AsItems_InMemoryVMInfoDataContainerImpl child) {
    ...
    public java.util.List getItemsForUI() {
        ...
        while (result.size() < MIN_TABLE_LENGTH) {
            try {
                org.sblim.wbemsmt.vm.container.edit.jsf.MemoryVMInfoItemDataContainer_AsItems_InMemoryVMInfoDataContainerImpl item = new org.sblim.wbemsmt.vm.container.edit.jsf.MemoryVMInfoItemDataContainer_AsItems_InMemoryVMInfoDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getItemsHeader_usr_Current() {
        if (icItemsHeader_usr_Current == null) {
            ...
            icItemsHeader_usr_Current = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent) icItemsHeader_usr_Current)
    ...
    public void countAndCreateChildren() throws WbemsmtException {
        ...
        try {
            int count = adapter.count("items",
                    org.sblim.wbemsmt.vm.container.edit.MemoryVMInfoItemDataContainer.class, this);
            if (count != itemsCount) {
                itemsCount = count;
                clearItems();
                for (int i = 0; i < count; i++) {
                    addItems(new org.sblim.wbemsmt.vm.container.edit.jsf.MemoryVMInfoItemDataContainer_AsItems_InMemoryVMInfoDataContainerImpl(
                            (org.sblim.wbemsmt.vm.bl.adapter.VMCimAdapter) adapter, bindingPrefix,
                            i));
                }
            }
